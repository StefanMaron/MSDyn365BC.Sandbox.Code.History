codeunit 131300 "Library - ERM"
{
    ...
    begin
        ...
        NoSeriesLine.Validate("Line No.",
          LibraryUtility.GetNewRecNo(NoSeriesLine, NoSeriesLine.FieldNo("Line No.")));
        if StartingNo = '' then
    ...
    begin
        ...
        CreateNoSeriesLine(
          ...
          CopyStr(LibraryUtility.GenerateRandomCode(NoSeriesLine.FieldNo("Starting No."), DATABASE::"No. Series Line"), 1, 20),
          '');
        exit(NoSeries.Code);
    end;
    ...
    begin
        ...
        CreateNoSeriesLine(
          NoSeriesLine, NoSeries.Code,
          LibraryUtility.GenerateRandomCode(NoSeriesLine.FieldNo("Starting No."), DATABASE::"No. Series Line"), '');
        exit(NoSeries.Code);
    end;
    ...
    procedure FindOperationType(NoSeriesType: Enum "No. Series Type"): Code[10]
    var
        NoSeries: Record "No. Series";
    begin
    ...
    procedure GetDefaultOperationType(AccountNo: Code[20]; TableNo: Integer): Code[20]
    var
    ...
    begin
        ...
        if GenPostingType = GenPostingType::Sale then
            VATPostingSetup."Sales Prepayments Account" := GLAccount."No."
        else
            VATPostingSetup."Purch. Prepayments Account" := GLAccount."No.";
    ...
    procedure CreatePaymentLines(var PaymentLines: Record "Payment Lines"; SalesPurchase: Option; Type: Enum "Payment Lines Document Type"; "Code": Code[20]; JnlTemplateName: Code[10]; JnlLineNo: Integer)
    var
        RecRef: RecordRef;
    begin
        PaymentLines.Init();
    ...
    procedure GetNonDuePaymentLineCode(): Code[20]
    var
        PaymentLines: Record "Payment Lines";
        DateFormular_0D: DateFormula;
    begin
