...
codeunit 135061 "Dynamics 2D QR Code Test"
{
    ...
    begin
        ...
        TempBarcodeEncodeSettings2D."Module Size" := 1;

        // [WHEN] The string is converted
        TempBlob := IBarcodeImageProvider2D.EncodeImage(GetMaxAlphaNumericString(false), Enum::"Barcode Symbology 2D"::"QR-Code", TempBarcodeEncodeSettings2D);
    ...
    begin
        ...
        // [WHEN] The string is converted
        asserterror IBarcodeImageProvider2D.EncodeImage(GetMaxAlphaNumericString(true), Enum::"Barcode Symbology 2D"::"QR-Code", TempBarcodeEncodeSettings2D);
