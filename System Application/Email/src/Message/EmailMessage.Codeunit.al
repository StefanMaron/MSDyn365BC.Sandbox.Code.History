...
codeunit 8904 "Email Message"
{
    ...
    /// <param name="ContentId">The Content ID of the file attachment.</param>
    /// <param name="AttachmentInStream">The instream of the attachment.</param>
    /// <param name="MessageAlreadyRetrieved">Specifies that the email message has already been retrieved into the email inbox.</param>
    procedure AddAttachment(AttachmentName: Text[250]; ContentType: Text[250]; InLine: Boolean; ContentId: Text[40]; AttachmentInStream: InStream; MessageAlreadyRetrieved: Boolean)
    begin
        EmailMessageImpl.AddAttachment(AttachmentName, ContentType, AttachmentInStream, InLine, ContentId, MessageAlreadyRetrieved);
    end;
