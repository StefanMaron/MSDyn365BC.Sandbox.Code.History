codeunit 134421 "Report Selections Tests"
{
    ...
    var
        ReportSelections: Record "Report Selections";
    begin
        Assert.AreEqual(ReportSelections.Usage::"WHT Certificate", 54, 'Wrong Usage option value.');
        Assert.AreEqual(ReportSelections.Usage::"P.TaxInvoice", 55, 'Wrong Usage option value.');
        Assert.AreEqual(ReportSelections.Usage::"S.TaxInvoice", 56, 'Wrong Usage option value.');
        Assert.AreEqual(ReportSelections.Usage::"P.TaxCreditMemo", 57, 'Wrong Usage option value.');
        Assert.AreEqual(ReportSelections.Usage::"S.TaxCreditMemo", 58, 'Wrong Usage option value.');
    end;
