codeunit 134421 "Report Selections Tests"
{
    ...
    var
        ReportSelections: Record "Report Selections";
    begin
        Assert.AreEqual(ReportSelections.Usage::"P.AutoInvoice", 100, 'Wrong Usage option value.');
        Assert.AreEqual(ReportSelections.Usage::"P.AutoCr.Memo", 101, 'Wrong Usage option value.');
    end;
