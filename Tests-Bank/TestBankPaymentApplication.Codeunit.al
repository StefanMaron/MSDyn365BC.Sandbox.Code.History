codeunit 134263 "Test Bank Payment Application"
{
    ...
    var
        ...
        GenJournalBatch: Record "Gen. Journal Batch";
        GLEntry: Record "G/L Entry";
        OrigPurchSetup: Record "Purchases & Payables Setup";
  ...
  90);
        ...
        // Restore global setup so this test cannot leak committed state into other tests sharing the company
        RestorePurchasesPayablesSetupForTest(OrigPurchSetup);
    end;
    ...
    local procedure RestorePurchasesPayablesSetupForTest(OrigPurchSetup: Record "Purchases & Payables Setup")
    var
        PurchasesPayablesSetup: Record "Purchases & Payables Setup";
    begin
        PurchasesPayablesSetup.Get();
        PurchasesPayablesSetup.Validate("Allow Multiple Posting Groups", OrigPurchSetup."Allow Multiple Posting Groups");
        PurchasesPayablesSetup.Validate("Check Multiple Posting Groups", OrigPurchSetup."Check Multiple Posting Groups");
        PurchasesPayablesSetup.Modify(true);
        Commit();
    end;
