codeunit 134386 "ERM Sales Documents II"
{
    ...
    begin
        ...
        Assert.ExpectedError(
              StrSubstNo(
                VATIdentifierErr, VATPostingSetup[1].FieldCaption("VAT Identifier"), VATPostingSetup[1]."VAT Identifier",
                VATPostingSetup[1].FieldCaption("VAT %"), VATPostingSetup[1]."VAT %", VATPostingSetup[1].TableCaption(),
                VATPostingSetup[1].FieldCaption("VAT Bus. Posting Group"), VATPostingSetup[1]."VAT Bus. Posting Group",
                VATPostingSetup[1].FieldCaption("VAT Prod. Posting Group"), VATPostingSetup[1]."VAT Prod. Posting Group"));
    end;
