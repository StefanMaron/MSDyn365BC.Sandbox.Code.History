codeunit 134158 "Test Price Calc. Setup"
{
    ...
    begin
        ...
        Assert.AreEqual('7020-OnAfterSetPrice;7020-OnAfterGetAssetTypeHandler;Manual-0;7021-OnAfterSetFilterByFilterPageBuilder;Manual-0;', PriceCalculationMgt.FindActiveSubscriptions(), 'unbound');
    end;
