...
#pragma warning restore AA0210
    ...
    [Test]
    [Scope('OnPrem')]
    procedure ContactEmailDisplayedOnNewPurchaseInvoice()
    var
    ...
    begin
        // [FEATURE] [AI test]
        // [SCENARIO 625599] Contact email is displayed on a new Purchase Invoice created from Vendor Card when Vendor "V" has a primary Contact "CO" with email
        Initialize();
        ...
        PurchInvoice.FILTER.SetFilter("No.", PurchaseHeader."No.");
