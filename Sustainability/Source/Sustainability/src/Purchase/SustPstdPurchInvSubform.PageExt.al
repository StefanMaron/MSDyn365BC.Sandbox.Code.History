    ...
    layout
    {
        ...
        addafter("Line Amount")
        {
            ...
            field("Fuel/Electricity"; Rec."Fuel/Electricity")
            {
                Visible = SustainabilityFormulasFieldVisible;
                ApplicationArea = Basic, Suite;
                ToolTip = 'Specifies the fuel or electricity of the purchase invoice line.';
            }
            field(Distance; Rec.Distance)
            {
                Visible = SustainabilityFormulasFieldVisible;
                ApplicationArea = Basic, Suite;
                ToolTip = 'Specifies the distance of the purchase invoice line.';
            }
            field("Custom Amount"; Rec."Custom Amount")
            {
                Visible = SustainabilityFormulasFieldVisible;
                ApplicationArea = Basic, Suite;
                ToolTip = 'Specifies the custom amount of the purchase invoice line.';
            }
            field("Installation Multiplier"; Rec."Installation Multiplier")
            {
                Visible = SustainabilityFormulasFieldVisible;
                ApplicationArea = Basic, Suite;
                ToolTip = 'Specifies the installation multiplier of the purchase invoice line.';
            }
            field("Time Factor"; Rec."Time Factor")
            {
                Visible = SustainabilityFormulasFieldVisible;
                ApplicationArea = Basic, Suite;
                ToolTip = 'Specifies the time factor of the purchase invoice line.';
            }
