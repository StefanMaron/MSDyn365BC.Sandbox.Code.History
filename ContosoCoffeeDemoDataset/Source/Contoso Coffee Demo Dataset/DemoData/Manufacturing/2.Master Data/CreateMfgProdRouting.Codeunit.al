...
codeunit 4772 "Create Mfg Prod. Routing"
{
    ...
    var
        ...
        ExternalProcessingTok: Label 'External Processing', MaxLength = 50;
    ...
    begin
        ...
        ContosoManufacturing.InsertRoutingLine(SPSCM1009SUBF(), '', OperationNo10(), '', "Capacity Type Routing"::"Work Center", MfgCapacity.WorkCenter600(), UnitAssemblyTok, 0, 25, 40, 0, RoutingLink500(), ContosoUtilities.AdjustPrice(45.32), MfgStandardTask.FullSubcontractedProduction());  //Currency
    ...
    begin
        ...
        ContosoManufacturing.InsertRoutingLink(RoutingLink500(), ExternalProcessingTok);
    end;
    ...
    procedure RoutingLink500(): Code[10]
    begin
        exit('500');
    end;
