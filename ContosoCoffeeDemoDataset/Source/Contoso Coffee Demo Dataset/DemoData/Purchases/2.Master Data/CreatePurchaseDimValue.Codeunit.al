...
codeunit 5663 "Create Purchase Dim. Value"
{
    ...
    begin
        ...
        ContosoDimension.InsertDefaultDimensionValue(Database::Vendor, CreateVendor.ExportFabrikam(), CreateDimension.DepartmentDimension(), CreateDimensionValue.PurchasingDepartment(), Enum::"Default Dimension Value Posting Type"::" ");
        ...
        ContosoDimension.InsertDefaultDimensionValue(Database::Vendor, CreateVendor.DomesticFirstUp(), CreateDimension.DepartmentDimension(), CreateDimensionValue.PurchasingDepartment(), Enum::"Default Dimension Value Posting Type"::" ");
        ...
        ContosoDimension.InsertDefaultDimensionValue(Database::Vendor, CreateVendor.EUGraphicDesign(), CreateDimension.DepartmentDimension(), CreateDimensionValue.PurchasingDepartment(), Enum::"Default Dimension Value Posting Type"::" ");
        ...
        ContosoDimension.InsertDefaultDimensionValue(Database::Vendor, CreateVendor.DomesticWorldImporter(), CreateDimension.DepartmentDimension(), CreateDimensionValue.PurchasingDepartment(), Enum::"Default Dimension Value Posting Type"::" ");
        ...
        ContosoDimension.InsertDefaultDimensionValue(Database::Vendor, CreateVendor.DomesticNodPublisher(), CreateDimension.DepartmentDimension(), CreateDimensionValue.PurchasingDepartment(), Enum::"Default Dimension Value Posting Type"::" ");
    end;
}
