codeunit 144521 "GovTalkMessage Management Test"
{
    ...
    begin
        ...
        Assert.AreEqual(CompanyInformation.FieldNo("Country/Region Code"), ErrorMessage."Field Number", '');
        ErrorMessage.Next();
        Assert.AreEqual(CompanyInformation.FieldNo("Branch Number"), ErrorMessage."Field Number", '');
    ...
    begin
        ...
        // [WHEN] GovTalk Message is submitted
        CODEUNIT.Run(CODEUNIT::"EC Sales List Submit", VATReportHeader);
    ...
    begin
        ...
        GovTalkSetup.Id := LibraryUtility.GenerateRandomCodeWithLength(GovTalkSetup.FieldNo(Id), DATABASE::"GovTalk Setup", 10);
    ...
    begin
        ...
        Clear(CompanyInformation."Branch Number");
