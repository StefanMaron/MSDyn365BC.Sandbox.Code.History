...
codeunit 139649 "E-Doc. Attachment Tests"
{
    ...
    begin
        ...
        LibraryEDocument.SetupStandardSalesScenario(Customer, EDocumentService, Enum::"E-Document Format"::Mock, Enum::"Service Integration"::Mock);

        LibraryEDocument.CreateSalesHeaderWithItem(Customer, SalesHeader, DocumentType);
