codeunit 134806 "RED Test Unit for SalesPurDoc2"
{
    ...
    begin
        ...
        Initialize();
        PostingDate := SetDateDay(1, CalcDate('<- 1M>', AllowPostedDocumentDeletionDate));
        LibrarySales.SetAllowDocumentDeletionBeforeDate(PostingDate + 1);
    ...
    begin
        ...
        // [GIVEN] User has assigned a default deferral code to an Item
        CreateItemWithDefaultDeferralCode(
            DeferralTemplateCode, ItemNo, CalcMethod::"Straight-Line",
            StartDate::"Posting Date", LibraryRandom.RandIntInRange(2, 5));
    ...
    local procedure VerifyRoundedDeferralGLEntries(DocumentNo: Code[20]; PostingDate: Date; LineGLAccountNo: Code[20]; DeferralGLAccountNo: Code[20]; DocDescription: Text[100]; LineDescription: Text[100]; PeriodDescription: Text[100]; PeriodAmount: Decimal; LineAmount: Decimal; TotalDefAmount: Decimal; Sign: Integer)
    var
    ...
    begin
        ...
        VerifyGLEntryByDescription(GLEntry, LineGLAccountNo, DocDescription, -Sign * LineAmount);
