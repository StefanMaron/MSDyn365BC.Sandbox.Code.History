...
#pragma warning restore AA0100
                ...
                field("ESR Reference No."; Rec."ESR Reference No.")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies the Einzahlungsschein mit Referenznummer (ESR) invoice data for the customer who made the payment that is represented by the journal line.';
                    Visible = false;
                }
