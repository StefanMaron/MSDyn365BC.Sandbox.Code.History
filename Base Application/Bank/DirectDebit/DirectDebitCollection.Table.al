...
#pragma warning restore AS0099
    ...
    [Scope('OnPrem')]
    procedure SetErrorLink(var GenJnlLine: Record "Gen. Journal Line")
    begin
        if "Domiciliation Batch Name" <> '' then begin
            GenJnlLine."Journal Template Name" := Identifier;
            GenJnlLine."Journal Batch Name" := "Domiciliation Batch Name";
            exit;
        end;
