    ...
    layout
    {
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor''s enterprise number.';
                }
            }
            group(Payments)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies to place a check mark in the check box, if you want the outstanding ledger entries of this vendor to be included.';
                }
