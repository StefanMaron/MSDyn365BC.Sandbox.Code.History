    ...
    layout
    {
        area(content)
        {
            ...
            group("Invoice Details")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the percentage that was used for discounting the VAT when a payment was posted. If the entry was posted from an order, invoice or credit memo, the code is copied from the VAT Base Discount % field on the sales or purchase header.';
                }
