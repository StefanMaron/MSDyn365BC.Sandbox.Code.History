...
page 51 "Purchase Invoice"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Caption = 'ESR/ISR';
                field("ESR/ISR Coding Line"; Rec."ESR/ISR Coding Line")
                {
                    ApplicationArea = Advanced;
                    ToolTip = 'Specifies a coding line of the ESR document if you use a document reader.';
                }
                field("Reference No."; Rec."Reference No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the reference number of the vendor invoice.';
                }
                field(Checksum; Rec.Checksum)
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the checksum that is calculated over the entire coding line. It refers to the reference number, amount, and ESR member number.';
                }
                field("Bank Code"; Rec."Bank Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the bank.';
                }
                field("ESR Amount"; Rec."ESR Amount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the amount from the ESR deposit slip.';
                }
            }
        }
        area(factboxes)
