...
#pragma warning restore AA0470
    ...
    begin
        ...
        if GLSetup."Enable WHT" then
            PostWHT(PurchHeader, TotalAmount);
...
#pragma warning restore AA0005
    ...
    begin
        ...
        TotalPurchLine."VAT Base (ACY)" += PurchLine."VAT Base (ACY)";
        TotalPurchLine."VAT Difference (ACY)" += PurchLine."VAT Difference (ACY)";
        TotalPurchLine."Amount Including VAT (ACY)" += PurchLine."Amount Including VAT (ACY)";
        TotalPurchLine."Amount (ACY)" += PurchLine."Amount (ACY)";
    ...
    local procedure PostWHT(var PurchHeader: Record "Purchase Header"; TotalInvAmount: Decimal)
    var
        GenJnlLine: Record "Gen. Journal Line";
