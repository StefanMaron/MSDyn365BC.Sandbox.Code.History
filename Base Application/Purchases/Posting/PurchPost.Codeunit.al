...
codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        with PurchHeader do begin
            ...
            if Invoice and ("Document Type" in ["Document Type"::Invoice, "Document Type"::Order]) then
...
#pragma warning restore AA0005
    ...
    procedure CheckTrackingSpecification(PurchHeader: Record "Purchase Header"; var TempItemPurchLine: Record "Purchase Line" temporary)
    var
