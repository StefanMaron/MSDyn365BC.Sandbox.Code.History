                ...
                group(Options)
                {
                    ...
                    group(Text)
                    {
                        ...
                        field("Text[1]"; Text[1])
                        {
                            ...
                            ShowCaption = false;
                            ToolTip = 'Specifies the text that you want to include on the cover sheet.';
                        }
                        field("Text[2]"; Text[2])
                        {
                            ApplicationArea = RelationshipMgmt;
                    ...
                    group(Remarks)
                    {
                        ...
                        field("Marks[1]"; Marks[1])
                        {
                            ...
                            ToolTip = 'Specifies that the cover sheet is agreed with the contact.';
