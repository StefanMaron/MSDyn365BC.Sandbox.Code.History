...
{
    Caption = 'File SEPA CT pain.001.001.09 Payments';
    ProcessingOnly = true;
    UseRequestPage = true;
...
#pragma warning restore AL0254
    ...
    begin
        FeatureTelemetry.LogUptake('0000N27', SEPACTExportFile.FeatureName(), Enum::"Feature Uptake Status"::Used);
        FeatureTelemetry.LogUsage('0000N28', SEPACTExportFile.FeatureName(), 'Report (BE) File SEPA 001.001.09 Pmts');
