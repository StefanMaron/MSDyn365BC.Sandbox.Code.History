...
table 225 "Post Code"
{
    ...
    fields
    {
        ...
        field(10700; "County Code"; Code[10])
        {
            Caption = 'County Code';
            TableRelation = Area;
            ...
            begin
                if Area.Get("County Code") then
                    County := CopyStr(Area.Text, 1, MaxStrLen(County));
            end;
        }
    }
    ...
    begin
        ...
        for i := StrLen(Code) downto 1 do begin
            ...
            if Area.Find('-') then begin
                Validate("County Code", Area.Code);
                exit;
            end;
        end;
    end;
