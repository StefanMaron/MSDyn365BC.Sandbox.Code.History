...
#pragma warning restore AA0074
    ...
    local procedure CheckElectronicPaymentFields(GenJnlLine: Record "Gen. Journal Line"; BankAccountNo: Code[20])
    var
    ...
    begin
        ...
        then begin
            GenJnlLine.TestField("Check Exported", true, ErrorInfo.Create());
