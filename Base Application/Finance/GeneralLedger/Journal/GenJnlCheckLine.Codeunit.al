...
#pragma warning restore AA0074
    ...
    begin
        ...
        SourceCodeSetup.Get();
        if SourceCodeSetup."Close Income Statement" = GenJnlLine."Source Code" then
            CheckPostingPeriod(false);
        if SourceCodeSetup."Inventory Post Cost" <> GenJnlLine."Source Code" then
    ...
    [Scope('OnPrem')]
    procedure CheckPostingPeriod(CheckPeriod: Boolean)
    var
