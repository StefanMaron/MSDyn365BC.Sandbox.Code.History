    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                PrintAccountDetails := PrintDetailsOnAllAccounts or "Print Details";
            end;
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PrintDetailsOnAllAccounts; PrintDetailsOnAllAccounts)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Print Details for all G/L Accs.';
                        ToolTip = 'Specifies if you want the report to show detailed entries regardless of the Print Details setting for the G/L account.';
                    }
                }
            }
        }
...
#pragma warning restore AA0074
        ...
        PrintDetailsOnAllAccounts: Boolean;
