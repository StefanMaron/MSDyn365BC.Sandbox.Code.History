...
#pragma warning restore AA0074
    ...
    begin
        ...
        if not SkipCheck then begin
            ...
            if GlobalGLEntry.Find('-') then begin
                CheckReverseDocumentType(GlobalGLEntry."Entry No.", GlobalGLEntry."Document Type");
                CheckGLEntry();
                repeat
    ...
    begin
        ...
        GLEntry2.SetRange("Entry No.", GLRegister."From Entry No.", GLRegister."To Entry No.");
    ...
    begin
        if DocumentType in [DocumentType::Invoice, DocumentType::"Credit Memo"] then
            Error(Text1130000, EntryNo, DocumentType);
    end;
