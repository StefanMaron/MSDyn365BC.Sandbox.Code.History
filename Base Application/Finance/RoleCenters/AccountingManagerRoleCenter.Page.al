    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Cust. - Balance to Date")
            {
                ...
                ToolTip = 'View open customer ledger entries in LCY and in the posting currency. All entries due on the status date will be grouped and printed for each customer.';
            }
