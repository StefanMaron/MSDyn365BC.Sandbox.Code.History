...
page 9001 "Accounting Manager Role Center"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            {
                ApplicationArea = FixedAssets;
                Caption = 'Fixed Asset - Book Value 03';
                Image = "Report";
                RunObject = Report "Fixed Asset - Book Value 03";
                ToolTip = 'View detailed information about acquisition costs, depreciation, appreciation, write-downs, and book values for individual assets, and for groups of assets. Amounts are calculated for each of these categories at the beginning of a period, during that period, and at the end of that period.';
            }
            action("Fixed Assets - List AT")
            {
                ApplicationArea = FixedAssets;
                Caption = 'Fixed Assets - List AT';
                Image = "Report";
