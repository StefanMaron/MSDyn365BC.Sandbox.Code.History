    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Trial Balance/Previous Period")
            {
                ...
                ToolTip = 'View a detailed trial balance for selected general ledger accounts. The report calculates the year to date balance using the specified period for the current year and last year.';
            }
