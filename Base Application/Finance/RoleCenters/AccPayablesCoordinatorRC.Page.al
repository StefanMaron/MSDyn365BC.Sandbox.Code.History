    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Vendor - Address List")
            {
                ...
                ToolTip = 'View the address for each of your vendors.';
            }
            action("Vendor - Balance")
            {
                ...
                ToolTip = 'View the balance, for selected vendors, with a total for each vendor posting group, in local currency. The report is useful at the close of an accounting period or fiscal year.';
            }
            ...
            action("Vendor - Open Entries")
            {
                ...
                ToolTip = 'View all the open vendor ledger entries.';
            }
