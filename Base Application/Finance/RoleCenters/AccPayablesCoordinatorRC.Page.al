    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Vendor Payments List")
            {
                ...
                ToolTip = 'View a list of the payments in a user-defined period. There are three predefined layouts available to display the amount, remaining amount, currency exchange rate, and posting information.';
            }
