...
codeunit 1752 "Data Class. Eval. Data Country"
{
    ...
    begin
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Place of Receiver");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Data Export");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Data Export Record Definition");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Data Export Record Source");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Data Export Record Field");
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"VAT Currency Adjustment Buffer");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"ESR Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"DTA Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"LSV Setup");
