...
#pragma warning restore AA0470
    ...
    begin
        ...
        SetCrMemoDefaultReasonCode(SalesHeader);
    ...
    begin
        ...
        SalesReceivablesSetup.Get();
        SalesHeader.Validate("Reason Code", SalesReceivablesSetup."Default Cancel Reason Code");
        SalesHeader.Modify();
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetDefaultCancelReasonCode(var SalesHeader: Record "Sales Header")
    begin
    end;
