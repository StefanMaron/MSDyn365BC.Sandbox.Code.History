...
#pragma warning restore AS0086
        ...
        field(5752; "Completely Shipped"; Boolean)
        {
            CalcFormula = min("Sales Line"."Completely Shipped" where("Document Type" = field("Document Type"),
                                                                       "Document No." = field("No."),
                                                                       Type = filter(<> " " & <> Title & <> "Begin-Total" & <> "End-Total" & <> "New Page"),
        ...
        field(3010803; "Expected Order Inflow"; DateFormula)
        {
            Caption = 'Expected Order Inflow';
        }
        field(3010804; "Followup Date"; Date)
        {
            Caption = 'Followup Date';
        }
        field(3010805; "Decision Date"; Date)
        {
        ...
        field(3010809; "Filed User ID"; Code[50])
        {
