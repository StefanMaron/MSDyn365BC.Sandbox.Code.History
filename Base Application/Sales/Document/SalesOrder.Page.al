        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action(RecalculateLines)
                {
                    ...
                    trigger OnAction()
                    begin
                        QuoteManagement.ReCalc(Rec, true);
                    end;
                }
            ...
            group("&Print")
            {
                ...
                action("Picking List")
                {
                    ...
                    Image = Print;
                    ToolTip = 'Print the picking list for the sales order. Only items with a shipping quantity greater than 0 are included. The report shows location, bin, serial number, and total volume.';
