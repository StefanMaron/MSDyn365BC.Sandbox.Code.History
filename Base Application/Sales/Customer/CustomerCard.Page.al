    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Post Dated Checks (LCY)"; Rec."Post Dated Checks (LCY)")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the sum of all the open post-dated checks received from this customer.';
                    ...
                    begin
                        ...
                        PostDatedCheck.SetRange("Account No.", Rec."No.");
