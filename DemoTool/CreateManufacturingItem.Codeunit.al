codeunit 119040 "Create Manufacturing Item"
{
    ...
    begin
        ...
        InsertData('1160', XTyre, 0, 0, '01587796', 'ADG-4577', 100, 0, 0, 0, '');
    ...
    procedure InsertData("No.": Code[20]; Description: Text[30]; "Unit Price": Decimal; "Last Direct Cost": Decimal; "Vendor No.": Code[20]; "Vendor Item No.": Text[20]; "Minimum Qty. on Hand": Decimal; "Gross Weight": Decimal; "Net Weight": Decimal; "Unit Volume": Decimal; "Tariff No.": Code[10])
    begin
        Item.Init();
        Item.Validate("No.", "No.");
