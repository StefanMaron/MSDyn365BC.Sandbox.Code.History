        ...
        if GenPostingSetup.Find('-') then
            repeat
                case GenPostingSetup."Gen. Bus. Posting Group" of
                    '':
                        begin
                            GenPostingSetup.Validate("Sales Account", Adjust.Convert('996110'));
                            GenPostingSetup.Validate("Sales Credit Memo Account", Adjust.Convert('996110'));
                            GenPostingSetup.Validate("Sales Line Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Sales Inv. Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Purch. Account", Adjust.Convert('997110'));
                            GenPostingSetup.Validate("Purch. Credit Memo Account", Adjust.Convert('997110'));
                    ...
                    DemoDataSetup.EUCode:
                        begin
                            ...
                            GenPostingSetup.Validate("Sales Line Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Sales Inv. Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Purch. Account", Adjust.Convert('997120'));
                            GenPostingSetup.Validate("Purch. Credit Memo Account", Adjust.Convert('997120'));
                            GenPostingSetup.Validate("Purch. Line Disc. Account", Adjust.Convert('997140'));
                            GenPostingSetup.Validate("Purch. Inv. Disc. Account", Adjust.Convert('997140'));
                        end;
                    DemoDataSetup.ExportCode:
                        begin
                            ...
                            GenPostingSetup.Validate("Sales Line Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Sales Inv. Disc. Account", Adjust.Convert('996910'));
                            GenPostingSetup.Validate("Purch. Account", Adjust.Convert('997130'));
                            GenPostingSetup.Validate("Purch. Credit Memo Account", Adjust.Convert('997130'));
                            GenPostingSetup.Validate("Purch. Line Disc. Account", Adjust.Convert('997140'));
                            GenPostingSetup.Validate("Purch. Inv. Disc. Account", Adjust.Convert('997140'));
                        end;
                    XCUSTDOM, XCUSTFOR, XVENDDOM, XVENDFOR:
                        begin
                            GenPostingSetup.Validate("Sales Account", Adjust.Convert('996110'));
                            GenPostingSetup.Validate("Sales Credit Memo Account", Adjust.Convert('996110'));
                            GenPostingSetup.Validate("Sales Line Disc. Account", Adjust.Convert('996910'));
