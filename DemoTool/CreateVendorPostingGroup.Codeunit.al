    ...
    begin
        with DemoDataSetup do begin
            ...
            if "Data Type" = "Data Type"::Extended then begin
                ...
                InsertData(EUCode, XVendorsInEUTxt, CreateGLAccount.AccountsPayableDomestic(), '', CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.InterestIncome(), CreateGLAccount.InterestIncome());
                InsertData(ForeignCode, XForeignVendorsTxt, CreateGLAccount.AccountsPayableDomestic(), '', CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.PayableInvoiceRounding(), CreateGLAccount.InterestIncome(), CreateGLAccount.InterestIncome());
            end;
        end;
    end;
