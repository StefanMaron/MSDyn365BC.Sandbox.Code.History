codeunit 101995 "Create RapidStart Package"
{
    ...
    begin
        if CreateConfigPackageHelper.GetDataType() = DemoDataSetup."Data Type"::Evaluation then begin
            ...
            SkipValidateField(Loc.FieldNo("T.A.N. No."));
            SkipValidateField(Loc.FieldNo("T.C.A.N. No."));
            SkipValidateField(Loc.FieldNo("State Code"));
            SkipValidateField(loc.FieldNo("GST Registration No."));
            ...
            SkipValidateField(BankAccount.FieldNo("State Code"));
            SkipValidateField(BankAccount.FieldNo("GST Registration No."));
            SkipValidateField(BankAccount.FieldNo("GST Registration Status"));
        ...
        SkipValidateField(CompanyInfo.FieldNo("State Code"));
        SkipValidateField(CompanyInfo.FieldNo("GST Registration No."));
        SkipValidateField(CompanyInfo.FieldNo("T.A.N. No."));
        ...
        CreateTable(Database::"Posting No. Series");
        ...
        CreateTable(Database::"Fixed Asset Block");
        CreateTable(Database::"Fixed Asset Shift");
    ...
    local procedure IncludeField(FieldID: Integer; SkipValidation: Boolean)
    begin
        CreateConfigPackageHelper.IncludeField(FieldID, true);
        if SkipValidation then
            SkipValidateField(FieldID);
    end;
    ...
    begin
        ...
        IncludeField(GenJournalLine.FieldNo("GST Group Code"), true);
        IncludeField(GenJournalLine.FieldNo("HSN/SAC Code"), true);
        IncludeField(GenJournalLine.FieldNo("GST on Advance Payment"), true);
        IncludeField(GenJournalLine.FieldNo("Location Code"), true);
        IncludeField(GenJournalLine.FieldNo("Location State Code"), true);
        IncludeField(GenJournalLine.FieldNo("GST Bill-to/BuyFrom State Code"), true);
        IncludeField(GenJournalLine.FieldNo("Vendor GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("Customer GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("Location GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("T.A.N. No."), true);
        IncludeField(GenJournalLine.FieldNo("T.C.A.N. No."), true);
        IncludeField(GenJournalLine.FieldNo("TCS Nature of Collection"), true);
        IncludeField(GenJournalLine.FieldNo("TDS Section Code"), true);
        IncludeField(GenJournalLine.FieldNo("Nature of Remittance"), true);
        IncludeField(GenJournalLine.FieldNo("Act Applicable"), true);
        IncludeField(GenJournalLine.FieldNo("External Document No."), true);
        IncludeField(GenJournalLine.FieldNo("Vendor GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("Customer GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("Location GST Reg. No."), true);
        IncludeField(GenJournalLine.FieldNo("TDS Certificate Receivable"), true);
        IncludeField(GenJournalLine.FieldNo("Currency Code"), true);
    ...
    begin
        ...
        IncludeField(GLAcc.FieldNo("GST Group Code"), true);
        IncludeField(GLAcc.FieldNo("HSN/SAC Code"), true);
        IncludeField(GLAcc.FieldNo("GST Credit"), true);
        IncludeField(GLAcc.FieldNo(Exempted), true);
    end;
    ...
    begin
        ...
        IncludeField(Cust.FieldNo("State Code"), true);
        IncludeField(Cust.FieldNo("Location Code"), true);
        IncludeField(Cust.FieldNo("Assessee Code"), true);
        IncludeField(Cust.FieldNo("P.A.N. No."), true);
        IncludeField(Cust.FieldNo("P.A.N. Status"), true);
        IncludeField(Cust.FieldNo("P.A.N. Reference No."), true);
        IncludeField(Cust.FieldNo("GST Registration No."), true);
        IncludeField(Cust.FieldNo("GST Registration Type"), true);
        IncludeField(Cust.FieldNo("GST Customer Type"), true);
        IncludeField(Cust.FieldNo("E-Commerce Operator"), true);
    end;
    ...
    begin
        ...
        IncludeField(Vend.FieldNo("State Code"), true);
        IncludeField(Vend.FieldNo("Location Code"), true);
        IncludeField(Vend.FieldNo("Assessee Code"), true);
        IncludeField(Vend.FieldNo("P.A.N. No."), true);
        IncludeField(Vend.FieldNo("P.A.N. Status"), true);
        IncludeField(Vend.FieldNo("P.A.N. Reference No."), true);
        IncludeField(Vend.FieldNo("GST Vendor Type"), true);
        IncludeField(Vend.FieldNo("GST Registration No."), true);
        IncludeField(Vend.FieldNo("Associated Enterprises"), true);
    end;
    ...
    begin
        ...
        IncludeField(Item.FieldNo("GST Group Code"), true);
        IncludeField(Item.FieldNo("HSN/SAC Code"), true);
        IncludeField(Item.FieldNo("GST Credit"), true);
        IncludeField(Item.FieldNo(Exempted), true);
        IncludeField(Item.FieldNo("Price Exclusive of Tax"), true);
    end;
    ...
    begin
        ...
        IncludeField(PurchHeader.FieldNo("Bill of Entry No."), true);
        IncludeField(PurchHeader.FieldNo("Bill of Entry Date"), true);
        IncludeField(PurchHeader.FieldNo("Bill of Entry Value"), true);
        IncludeField(PurchHeader.FieldNo("Buy-from Country/Region Code"), true);
        IncludeField(PurchHeader.FieldNo("Currency Code"), true);
        IncludeField(PurchHeader.FieldNo("Currency Factor"), true);
        IncludeField(PurchHeader.FieldNo("Vendor Cr. Memo No."), true);
    end;
    ...
    begin
        ...
        IncludeField(PurchLine.FieldNo("GST Credit"), true);
        IncludeField(PurchLine.FieldNo("GST Assessable Value"), true);
        IncludeField(PurchLine.FieldNo("Custom Duty Amount"), true);
        IncludeField(PurchLine.FieldNo("GST Group Code"), true);
        IncludeField(PurchLine.FieldNo("HSN/SAC Code"), true);
        IncludeField(PurchLine.FieldNo("TDS Section Code"), true);
        IncludeField(PurchLine.FieldNo("Nature of Remittance"), true);
        IncludeField(PurchLine.FieldNo("Act Applicable"), true);
    end;
    ...
    begin
        ...
        IncludeField(SalesHeader.FieldNo("GST Without Payment of Duty"), true);
        IncludeField(SalesHeader.FieldNo("TDS Certificate Receivable"), true);
    end;
    ...
    begin
        ...
        IncludeField(SalesLine.FieldNo("TCS Nature of Collection"), true);
    end;
    ...
    begin
        ...
        IncludeField(ShiptoAddress.FieldNo(State), true);
    end;
