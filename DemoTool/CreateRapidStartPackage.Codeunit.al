codeunit 101995 "Create RapidStart Package"
{
    ...
    begin
        ...
        ExcludeField(InventorySetup.FieldNo("Def.Tmpl. for Phys.Pos.Adj CZL"));
        ExcludeField(InventorySetup.FieldNo("Def.Tmpl. for Phys.Neg.Adj CZL"));
    ...
    begin
        ...
        IncludeField(GenJournalLine.FieldNo("Currency Code"));
    end;
