codeunit 101995 "Create RapidStart Package"
{
    ...
    begin
        if CreateConfigPackageHelper.GetDataType() = DemoDataSetup."Data Type"::Evaluation then begin
            ...
            CreateTableChild(DATABASE::"Item Unit of Measure", DATABASE::"Unit of Measure");
    ...
    begin
        ...
        IncludeField(PurchHeader.FieldNo("Journal Templ. Name"));
    end;
    ...
    begin
        ...
        IncludeField(SalesHeader.FieldNo("Journal Templ. Name"));
    end;
