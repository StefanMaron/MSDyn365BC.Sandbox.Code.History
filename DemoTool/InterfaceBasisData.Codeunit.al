codeunit 110000 "Interface Basis Data"
{
    ...
    var
        ...
        JobNo: Code[20];
        AllocatedCH1101: Decimal;
        BalanceCH1101: Decimal;
        AllocatedCH2001: Decimal;
        BalanceCH2001: Decimal;
    ...
    begin
        ...
        RunCodeunit(CODEUNIT::"Create CH Acc. Schedule");
        ...
        RunCodeunit(CODEUNIT::"Enhance CH Master Data");
    ...
    var
        ...
        LineAmount: Decimal;
    begin
        BalanceCH1101 := CalcBalance(CA.Convert('1101'));
        ...
        case true of
            ...
            CustomerPostingGroup."Receivables Account" = CA.Convert('1101'):
                begin
                    if GenJournalLine.Quantity > 0 then
                        LineAmount := Round(BalanceCH1101 / 100 * GenJournalLine.Quantity)
                    else
                        LineAmount := BalanceCH1101 - AllocatedCH1101;
                    AllocatedCH1101 := AllocatedCH1101 + LineAmount;
                end;
    ...
    var
        ...
        LineAmount: Decimal;
    begin
        BalanceCH2001 := CalcBalance(CA.Convert('2001'));
        ...
        case true of
            ...
            VendorPostingGroup."Payables Account" = CA.Convert('2001'):
                begin
                    if GenJournalLine.Quantity > 0 then
                        LineAmount := Round(BalanceCH2001 / 100 * GenJournalLine.Quantity)
                    else
                        LineAmount := BalanceCH2001 - AllocatedCH2001;
                    AllocatedCH2001 := AllocatedCH2001 + LineAmount;
                end;
