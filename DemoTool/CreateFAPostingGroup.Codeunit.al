codeunit 101803 "Create FA Posting Group"
{
    ...
    begin
        InsertData(XOfficeEquipment, GetGLAccNo.OfficeEquip(), GetGLAccNo.AccumDeprOperEquip(), GetGLAccNo.OfficeEquip(), GetGLAccNo.AccumDeprOperEquip(), GetGLAccNo.GainsandLosse(), GetGLAccNo.GainsandLosse(), GetGLAccNo.RepairsandMaintenance(), GetGLAccNo.DepreciationEquipment(), GetGLAccNo.OfficeEquip());
        InsertData(XBuilding, GetGLAccNo.LandandBuilding(), GetGLAccNo.AccumDepreciationBuildings(), GetGLAccNo.LandandBuilding(), GetGLAccNo.AccumDepreciationBuildings(), GetGLAccNo.GainsandLosse(), GetGLAccNo.GainsandLosse(), GetGLAccNo.RepairsandMaintenance(), GetGLAccNo.DepreciationBuildings(), GetGLAccNo.LandandBuilding());
