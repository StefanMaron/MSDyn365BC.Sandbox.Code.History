codeunit 101098 "Create General Ledger Setup"
{
    ...
    begin
        ...
        "Create No. Series".InitBaseSeries(
          "General Ledger Setup"."Bank Account Nos.", XBANK, XBANK, XB10, XxB990, '', '', 10, "No. Series"."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);//IT
        "General Ledger Setup"."EMU Currency" := DemoDataSetup."LCY an EMU Currency";
        "General Ledger Setup".Validate("Minimum VAT Payable", 25);
        "General Ledger Setup".Validate("Settlement Round. Factor", 0.01);
        "General Ledger Setup".Validate("Last Settlement Date", 20051201D);
    ...
    begin
        ...
        "Create No. Series".InitBaseSeries(
          "General Ledger Setup"."Bank Account Nos.", XBANK, XBANK, XB10, 'B990', '', '', 10, "No. Series"."No. Series Type"::Normal, '', 0, '', false, Enum::"No. Series Implementation"::Sequence);
        "General Ledger Setup"."EMU Currency" := DemoDataSetup."LCY an EMU Currency";
