codeunit 101098 "Create General Ledger Setup"
{
    ...
    begin
        ...
        "General Ledger Setup"."Local Address Format" := "General Ledger Setup"."Local Address Format"::"City+County+Post Code (no comma)";
        "General Ledger Setup"."Show Amounts" := "General Ledger Setup"."Show Amounts"::"Amount Only";
        "General Ledger Setup"."Post Dated Journal Template" := XPOSTDATED;
        "General Ledger Setup"."Post Dated Journal Batch" := XDEFAULT;
        "General Ledger Setup"."Address Validation" := "General Ledger Setup"."Address Validation"::"Post Code & City";
        "General Ledger Setup"."Enable GST (Australia)" := true;
        "General Ledger Setup"."Adjustment Mandatory" := true;
        "General Ledger Setup"."BAS GST Division Factor" := 11;
        "General Ledger Setup"."Enable WHT" := true;
        "General Ledger Setup"."Min. WHT Calc only on Inv. Amt" := true;
        "General Ledger Setup"."GST Report" := true;
        "General Ledger Setup"."Full GST on Prepayment" := true;
