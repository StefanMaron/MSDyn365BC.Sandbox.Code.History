codeunit 101098 "Create General Ledger Setup"
{
    ...
    begin
        ...
        with "General Ledger Setup" do begin
            ...
            "Create No. Series".InitBaseSeries(
              "Bank Account Nos.", XBANK, XBANK, XB10, XxB990, '', '', 10, "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);//IT
            "EMU Currency" := DemoDataSetup."LCY an EMU Currency";
            Validate("Minimum VAT Payable", 25);
            Validate("Settlement Round. Factor", 0.01);
            Validate("Last Settlement Date", 20051201D);
    ...
    begin
        ...
        with "General Ledger Setup" do begin
            ...
            "Create No. Series".InitBaseSeries(
              "Bank Account Nos.", XBANK, XBANK, XB10, 'B990', '', '', 10, "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);
            "EMU Currency" := DemoDataSetup."LCY an EMU Currency";
