codeunit 101098 "Create General Ledger Setup"
{
    ...
    begin
        ...
        "General Ledger Setup"."Local Address Format" := "General Ledger Setup"."Local Address Format"::"Post Code+City+County";
        ...
        "General Ledger Setup".Validate("VAT in Use", true);
