...
codeunit 122100 "Create O365 Sales Init. Setup"
{
    ...
    begin
        ...
        with O365SalesInitialSetup do begin
            ...
            Validate("Default Payment Method Code", XCHECK);
            ...
            if DemoDataSetup."Company Type" = DemoDataSetup."Company Type"::VAT then begin
                Validate("Default VAT Bus. Posting Group", DemoDataSetup.DomesticCode);
                Validate("Normal VAT Prod. Posting Gr.", DemoDataSetup.GoodsVATCode);
                Validate("Reduced VAT Prod. Posting Gr.", DemoDataSetup.ServicesVATCode);
                Validate("Zero VAT Prod. Posting Gr.", DemoDataSetup.NoVATCode);
            end;
