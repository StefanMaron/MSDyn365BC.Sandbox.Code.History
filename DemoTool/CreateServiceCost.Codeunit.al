codeunit 117006 "Create Service Cost"
{
    ...
    begin
        ...
        with ServiceCost do begin
            // InsertData(XSTART,XStartspaceFee,'6810',20,1,XPCS,"Cost Type"::Other,'',2);
            // InsertData(XTR_EAST,XTravelspaceFee,'6810',2,1,XPCS,"Cost Type"::Travel,XE,0.2);
            // InsertData(XTR_MID,XTravelspaceFee,'6810',1,1,XPCS,"Cost Type"::Travel,XM,0.1);
            // InsertData(XTR_NORTH,XTravelspaceFee,'6810',3,1,XPCS,"Cost Type"::Travel,XN,0.3);
            // InsertData(XTR_SE,XTravelspaceFee,'6810',4,1,XPCS,"Cost Type"::Travel,XSE,0.4);
            // InsertData(XTR_SOUTH,XTravelspaceFee,'6810',5,1,XPCS,"Cost Type"::Travel,XS,0.5);
            // InsertData(XTR_WEST,XTravelspaceFee,'6810',6,1,XPCS,"Cost Type"::Travel,XW,0.6);
            InsertData(XSTART, XStartspaceFee, Adjust.Convert('6810'), 20, 1, XPCS, "Cost Type"::Other, '', 2);
            InsertData(XTR_EAST, XTravelspaceFee, Adjust.Convert('6810'), 2, 1, XPCS, "Cost Type"::Travel, XE, 0.2);
            InsertData(XTR_MID, XTravelspaceFee, Adjust.Convert('6810'), 1, 1, XPCS, "Cost Type"::Travel, XM, 0.1);
            InsertData(XTR_NORTH, XTravelspaceFee, Adjust.Convert('6810'), 3, 1, XPCS, "Cost Type"::Travel, XN, 0.3);
            InsertData(XTR_SE, XTravelspaceFee, Adjust.Convert('6810'), 4, 1, XPCS, "Cost Type"::Travel, XSE, 0.4);
            InsertData(XTR_SOUTH, XTravelspaceFee, Adjust.Convert('6810'), 5, 1, XPCS, "Cost Type"::Travel, XS, 0.5);
            InsertData(XTR_WEST, XTravelspaceFee, Adjust.Convert('6810'), 6, 1, XPCS, "Cost Type"::Travel, XW, 0.6);
        end;
    end;
