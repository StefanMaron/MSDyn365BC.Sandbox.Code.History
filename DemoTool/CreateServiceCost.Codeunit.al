codeunit 117006 "Create Service Cost"
{
    ...
    begin
        ...
        if Code = 'START' then
            ServiceCost."Default Unit Price" := 10 *
              Round(
                "Default Unit Price" * DemoDataSetup."Local Currency Factor", DemoDataSetup."Local Precision Factor")
        else
            ServiceCost."Default Unit Price" := 100 *
              Round(
                "Default Unit Price" * DemoDataSetup."Local Currency Factor", DemoDataSetup."Local Precision Factor");
