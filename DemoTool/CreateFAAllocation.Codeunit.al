codeunit 101810 "Create FA Allocation"
{
    ...
    begin
        ...
        "Line No." := 0;
        InsertData(XTELEPHONE, 10, '995411', XADM, 30);
        InsertData(XTELEPHONE, 10, '995411', XPROD, 20);
        InsertData(XTELEPHONE, 10, '995411', XSALES, 50);
        "Line No." := 0;
        InsertData(XTELEPHONE, 11, '995411', XADM, 30);
        InsertData(XTELEPHONE, 11, '995411', XPROD, 20);
        InsertData(XTELEPHONE, 11, '995411', XSALES, 50);
        // NAVCZ
    end;
