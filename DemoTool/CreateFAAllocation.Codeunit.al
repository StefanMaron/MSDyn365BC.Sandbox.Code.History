codeunit 101810 "Create FA Allocation"
{
    ...
    begin
        ...
        InsertData(XTELEPHONE, 8, '675200', XADM, 30);
        InsertData(XTELEPHONE, 8, '675200', XPROD, 20);
        InsertData(XTELEPHONE, 8, '675200', XSALES, 50);
        InsertData(XTELEPHONE, 9, '775200', XADM, 30);
        InsertData(XTELEPHONE, 9, '775200', XPROD, 20);
        InsertData(XTELEPHONE, 9, '775200', XSALES, 50);
    end;
