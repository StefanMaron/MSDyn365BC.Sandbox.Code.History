codeunit 101600 "Create Employee"
{
    ...
    begin
        InsertContact(XEH, '6743', '', '0476/50.71.83', '02/704.31.84', '', 'Ester Henderson');
        InsertContact(XJO, '1415', '', '0476/50.71.77', '02/704.31.97', '', 'Jim Olive');
        InsertContact(XOF, '4564', '', '0476/50.71.76', '02/704.31.76', '', 'Otis Falls');
        InsertContact(XLT, '3545', '', '0476/50.71.78', '02/704.31.79', '', 'Lina Townsend');
        InsertContact(XRB, '6571', '', '0476/50.71.82', '02/704.31.91', '', 'Robin Bettencourt');
        InsertContact(XMH, '4456', '', '0476/50.71.80', '02/704.31.85', '', 'Marty Horst');
        InsertContact(XTD, '4653', '', '0478/55.59.84', '02/704.31.96', '', 'Terry Dodds');
    end;
