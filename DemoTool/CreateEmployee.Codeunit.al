codeunit 101600 "Create Employee"
{
    ...
    begin
        InsertGeneral(
          XEH, XEster, '', XHenderson, XEHENDERSON, X677FifthAvenue, 'US-NY 10022',
          XManagingDirector, Employee.Gender::Female);
        InsertGeneral(
          XJO, XJim, '', XOlive, XJOLIVE, X125WestchesterAvenue, 'US-NY 10601',
          XSalesManager, Employee.Gender::Male);
        InsertGeneral(
          XOF, XOtis, '', XFalls, XOFALLS, X160WaltWhitmanRoad, 'US-NY 11746',
          XProductionManager, Employee.Gender::Male);
        InsertGeneral(
          XLT, XLina, '', XTownsend, XLTOWNSEND, X10ColumbusCircle, 'US-NY 10019',
          XDesigner, Employee.Gender::Female);
        InsertGeneral(
          XRB, XRobin, '', XBettencourt, XRBETTENCOURT, X400CommonsWay, 'US-NJ 8807',
          XSecretary, Employee.Gender::"Non-binary");
        InsertGeneral(
          XMH, XMarty, '', XHorst, XMHORST, X10344DestinyUSADrive, 'US-NY 13204',
          XProductionAssistant, Employee.Gender::Male);
        InsertGeneral(
          XTD, XTerry, '', XDodds, XTDODDS, X3710Route9South, 'US-NJ 7728',
          XProductionAssistant, Employee.Gender::Male);
    end;
