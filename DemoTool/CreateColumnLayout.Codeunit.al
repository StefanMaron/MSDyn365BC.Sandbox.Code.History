codeunit 101334 "Create Column Layout"
{
    ...
    begin
        ...
        // Modif Demo Finance (CM) : Ajout des colonnes de la présentation Compte de résultat
        InsertData(XPROFITANDLOSS, '1', XBalanceN, 1, 0, "Account Schedule Amount Type"::"Net Amount", '', '', false, "Column Layout Show"::Always, "Analysis Rounding Factor"::None);
        InsertData(XPROFITANDLOSS, '2', XBalanceN1, 1, 0, "Account Schedule Amount Type"::"Net Amount", '', '<-1Y>', false, "Column Layout Show"::Always, "Analysis Rounding Factor"::None);
    end;
    ...
    var
        ...
        XBalanceN: Label 'Balance N';
        XBalanceN1: Label 'Balance N-1';
