    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(
              ...
              XBlanemarkHifiShop, XOF, XLondon, XCUSTDOM, XCUSTHIGH, DomesticCode, 0, X1M8D, DomesticCode, X1POINT5DOM, XWHITE);
            InsertData(
              '61000', XFairwaySound, X159Fairway, CreatePostCode.Convert('GB-W2 8HG'), "Country/Region Code",
              XFairwaySound, XJO, XLondon, XCUSTDOM, XCUSTHIGH, DomesticCode, 0, X1M8D, DomesticCode, X1POINT5DOM, XWHITE);
            InsertData(
              '62000', XTheDeviceShop, X273BasinStreet, CreatePostCode.Convert('GB-N16 34Z'), "Country/Region Code",
              XTheDeviceShop, XJO, XLondon, XCUSTDOM, XCUSTHIGH, DomesticCode, 0, X14Days, DomesticCode, X1POINT5DOM, XWHITE);
        end;
