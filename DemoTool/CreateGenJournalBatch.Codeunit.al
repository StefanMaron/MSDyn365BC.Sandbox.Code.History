codeunit 101232 "Create Gen. Journal Batch"
{
    ...
    begin
        ...
        InsertData(
          XFINANCE, XGENERAL, XGENERAL,
          0, '', true, false);
        InsertData(
          XFINANCE, XBank, XBankpayments,
          "Gen. Journal Batch"."Bal. Account Type"::"Bank Account", XWWBOPERATING, true, false);
        InsertData(
          XFINANCE, XGIRO, XGiropayments,
          "Gen. Journal Batch"."Bal. Account Type"::"Bank Account", XGIRO, true, false);
        InsertData(
          XPERIODIC, XDEFAULT, XDefaultJournalBatch,
          0, '', true, false);
        InsertData(
          XGENERAL, XAPPLY, XApplyingJournalBatch,
          0, '', false, false);
    end;
    ...
    var
        ...
        XAPPLY: Label 'APPLY';
        XApplyingJournalBatch: Label 'Applying Journal Batch';
