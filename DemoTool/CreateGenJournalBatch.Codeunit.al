codeunit 101232 "Create Gen. Journal Batch"
{
    ...
    begin
        ...
        InsertData(XBANKPYMTVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XBANKPYMTVSourceCodeLbl, XUSERA, 'BNKPYV-P');
        InsertData(XBANKRCPTVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XBANKRCPTVSourceCodeLbl, XUSERA, 'BNKRCV-P');
        InsertData(XCASHPYMTVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XCASHPYMTVSourceCodeLbl, XUSERA, 'CSHPYV-P');
        InsertData(XCASHRCPTVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XCASHRCPTVSourceCodeLbl, XUSERA, 'CSHRCV-P');
        InsertData(XCONTRAVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XCONTRAVSourceCodeLbl, XUSERA, 'CNTRV-P');
        InsertData(XJOURNALVSourceCodeLbl, XUSERA, XDefaultJournal, 0, '', true, false);
        UpdatePostingNoSeries(XJOURNALVSourceCodeLbl, XUSERA, 'JRNLV-P');
    end;
    ...
    local procedure UpdatePostingNoSeries(TempalateName: Text[20]; BatchName: Code[20]; PostingNoSeries: Code[20])
    var
        GenJnlBatch: Record "Gen. Journal Batch";
    begin
        GenJnlBatch.Get(TempalateName, BatchName);
        GenJnlBatch."Posting No. Series" := PostingNoSeries;
        GenJnlBatch.Modify();
    end;
}
