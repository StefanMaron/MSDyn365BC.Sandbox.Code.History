codeunit 101232 "Create Gen. Journal Batch"
{
    ...
    begin
        ...
        InsertData(XGENERAL, XMONTHLY, XMonthlyJournalEntries, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", CreateGLAccount.PettyCash(), true, false);
        InsertData(XGENERAL, XDAILY, XDailyJournalEntries, 3, '', true, false);
        UpdateCopyToPostedGenJnlLines(XGENERAL, XMONTHLY, true);
        InsertData(XCASHRCPT, XGENERAL, XGENERAL, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", CreateGLAccount.PettyCash(), true, false);
        InsertData(XPAYMENT, XGENERAL, XGENERAL, "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", CreateGLAccount.PettyCash(), true, false);
        InsertData(XPAYMENT, XPmtRegTxt, XBankReconciliationTxt,
          "Gen. Journal Batch"."Bal. Account Type"::"Bank Account", '', true, true);
        InsertData(
          XPAYMENT, XCASH, XCashreceiptsandpayments,
          "Gen. Journal Batch"."Bal. Account Type"::"G/L Account", CreateGLAccount.PettyCash(), true, false);
        InsertData(XASSETS, XDEFAULT, XDefaultJournalBatch, 0, '', true, false);
    end;
