codeunit 119020 "Create Manufacturing Setup"
{
    ...
    begin
        with MfgSetup do begin
            ...
            "Create No. Series".InitBaseSeries("Work Center Nos.", XWORKCTR, XWorkCenters, XW10, XW99990, '', '', 10,
              "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);
            "Create No. Series".InitBaseSeries("Machine Center Nos.", XMACHCTR, XMachineCenters, XM10, XM99990, '', '', 10,
              "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);
            "Create No. Series".InitBaseSeries("Production BOM Nos.", XPRODBOM, XProductionBOMs, XP10, XP99990, '', '', 10,
              "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);
            "Create No. Series".InitBaseSeries("Routing Nos.", XROUTING, XRoutingslc, XR10, XR99990, '', '', 10,
              "No. Series"."No. Series Type"::Normal, '', 0, '', false, true);
