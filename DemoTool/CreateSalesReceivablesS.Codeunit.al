codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        with "Sales & Receivables Setup" do begin
            ...
            Validate("S. Invoice Template Name", XSALES);
            Validate("S. Cr. Memo Template Name", XSALESCR);
            Validate("S. Prep. Inv. Template Name", XSALES);
            Validate("S. Prep. Cr.Memo Template Name", XSALESCR);
            Validate("IC Sales Invoice Template Name", XICSALES);
            Validate("IC Sales Cr. Memo Templ. Name", XICSALESCR);
            Modify();
        end;
    end;
