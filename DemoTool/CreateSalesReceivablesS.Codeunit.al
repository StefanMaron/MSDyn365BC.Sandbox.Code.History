codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        with "Sales & Receivables Setup" do begin
            ...
            "Create No. Series".InitFinalSeries("Posted Tax Invoice Nos.", XSTAXINVplus, XPostedSalesTaxInvoice, 3);
            "Create No. Series".InitFinalSeries("Posted Tax Credit Memo Nos", XSTAXCRplus, XPostedSalesTaxCreditMemo, 3);
            "Post Dated Check Template" := XCASHRCPT;
    ...
    begin
        ...
        with "Sales & Receivables Setup" do begin
            ...
            "Posted Tax Invoice Nos." := XSTAXINVplus;
            "Posted Tax Credit Memo Nos" := XSTAXCRplus;
            Modify();
        end;
    end;
}
