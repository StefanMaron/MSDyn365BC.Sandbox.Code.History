codeunit 101311 "Create Sales & Receivables S."
{
    ...
    begin
        ...
        with "Sales & Receivables Setup" do begin
            ...
            "Create No. Series".InitFinalSeriesPrep("Posted Prepmt. Inv. Nos.", XPRESINVplus, XPostedSalesPrepmtInv, XPRESINV, 94, 3);
            ...
            "Create No. Series".InitFinalSeriesPrep("Posted Prepmt. Cr. Memo Nos.", XPRESCRPLUS, XPostedSalesPrepmtCrMemo, XPRESCR,
              94, 3);
