codeunit 101015 "Create G/L Account"
{
    ...
    begin
        ...
        InsertData('995720', XElectricityTaxLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        InsertData('995730', XNaturalGasTaxLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        InsertData('995740', XCoalTaxLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        InsertData('995750', XCO2TaxLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        InsertData('995760', XWaterTaxLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        InsertData('995780', XVATPayableLbl, 0, 1, 0, '', 0, '', '', '', '', true);
        ...
        InsertData('996290', XJobSalesAppRawMatLbl, 0, 0, 0, '', 0, '', '', '', '', false);
        ...
        InsertData('996490', XJobSalesAppResourcesLbl, 0, 0, 0, '', 0, '', '', '', '', false);
        ...
        InsertData('997280', XJobCostAppRawMaterialsLbl, 0, 0, 0, '', 0, '', '', '', '', false);
    ...
    var
        ...
        XElectricityTaxLbl: Label 'Electricity Tax';
        XNaturalGasTaxLbl: Label 'Natural Gas Tax';
        XCoalTaxLbl: Label 'Coal Tax';
        XCO2TaxLbl: Label 'CO2 Tax';
        XWaterTaxLbl: Label 'Water Tax';
        XVATPayableLbl: Label 'VAT Payable';
        ...
        XJobSalesAppRawMatLbl: Label 'Job Sales Applied, Raw Mat.';
        XJobSalesAppResourcesLbl: Label 'Job Sales Applied, Resources';
        ...
        XJobCostAppRawMaterialsLbl: Label 'Job Cost Applied, Raw Mat.';
    ...
    begin
        ...
        InsertData('60100', Format(GLAccountCategoryMgt.GetRentExpense(), 50), 0, 1, 0, '', 1, DemoDataSetup.DomesticCode(), DemoDataSetup.MiscCode(), '', '', true);
        InsertData('60700', XSalaries, 0, 1, 0, '', 1, DemoDataSetup.DomesticCode(), DemoDataSetup.MiscCode(), '', '', true);
    end;
