codeunit 101015 "Create G/L Account"
{
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData('60100', Format(GLAccountCategoryMgt.GetRentExpense, 50), 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('60700', XSalaries, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
        end;
    end;
    ...
    begin
        ...
        with DemoDataSetup do begin
            Get();
            InsertData('10100', XBankLCY, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('10300', XCash, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('10400', XAccountsReceivable, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('10700', XInventory, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('10800', Format(GLAccountCategoryMgt.GetEquipment, 50), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('10900', Format(GLAccountCategoryMgt.GetAccumDeprec, 50), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('20100', XAccountsPayable, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('30100', XCapitalStock, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('30200', XRetainedEarnings, 0, 0, 0, '', 0, '', '', '', '', true);
    ...
    begin
        case GLAccountCategory."Account Category" of
            GLAccountCategory."Account Category"::Assets:
                begin
                    UpdateGLAccounts(GLAccountCategory, '991000', '992999');
            ...
            GLAccountCategory."Account Category"::Liabilities:
                begin
                    ...
                    UpdateGLAccounts(GLAccountCategory, '20100', '20100');
                end;
