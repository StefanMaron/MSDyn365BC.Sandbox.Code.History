codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('021100', XBuildings, 0, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', false);
            InsertData('022100', XMachinesToolsEquipment, 0, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', false);
            InsertData('022300', XVehicles, 0, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', false);
            ...
            InsertData('041100', XAcquisitionOfIntangibleFixedAssets, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('042000', XAcquisitionOfTangibleFixedAssets, 3, 1, 0, '', 0, '', '', '', '', true);
            InsertData('042100', XAcquisitionOfBuildings, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('042200', XAcquisitionOfMachinery, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('042300', XAcquisitionOfVehicles, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('111100', XAcquisitionOfMaterial, 0, 1, 0, '', 1, DomesticCode(), RawMatCode(), '', '', false);
            ...
            InsertData('131050', XAcquisitionOfGoods, 0, 1, 0, '', 1, DomesticCode(), RetailCode(), '', '', false);
            InsertData('131450', XAcquisitionRetail, 0, 1, 0, '', 1, DomesticCode(), RetailCode(), '', '', false);
            InsertData('131455', XAcquisitionRetailInterim, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('131500', XAcquisitionRawMaterialDomestic, 0, 1, 0, '', 1, DomesticCode(), RawMatCode(), '', '', false);
            InsertData('131600', XAcquisitionRawMaterialEu, 0, 1, 0, '', 1, EUCode(), RawMatCode(), '', '', false);
            InsertData('131700', XAcquisitionRawMaterialExport, 0, 1, 0, '', 1, ExportCode(), RawMatCode(), '', '', false);
            ...
            case "Company Type" of
                ...
                "Company Type"::VAT:
                    begin
                        InsertData('343110', StrSubstNo(XInputVATPERCENT, SecondReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343115', StrSubstNo(XInputVATPERCENT, FirstReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343121', StrSubstNo(XInputVATPERCENT, BaseVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343510', StrSubstNo(XOutputVATPERCENT, SecondReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343515', StrSubstNo(XOutputVATPERCENT, FirstReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343521', StrSubstNo(XOutputVATPERCENT, BaseVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343610', StrSubstNo(XReverseChargeVATPERCENT, SecondReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343615', StrSubstNo(XReverseChargeVATPERCENT, FirstReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343621', StrSubstNo(XReverseChargeVATPERCENT, BaseVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343810', StrSubstNo(XAdvancesVATPERCENT, SecondReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343815', StrSubstNo(XAdvancesVATPERCENT, FirstReducedVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                        InsertData('343821', StrSubstNo(XAdvancesVATPERCENT, BaseVATText()), 0, 1, 0, '', 0, '', '', '', '', true);
                    end;
            end;
            ...
            InsertData('501100', XConsumableMaterial, 0, 0, 0, '', 1, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('501200', XFuel, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('501300', XComputersConsumableMaterial, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('501999', XConsumptionOfMaterialTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('502000', XElectricity, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('502100', XElectricity, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('502999', XElectricityTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('503000', XNonstorablesupplies, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('503100', XNonstorablesupplies, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('511100', XRepairsandMaintenance, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('512100', XTravelExpenses, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('512999', XServicesTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('513100', XRepresentationCosts, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), DomesticCode(), NoVatCode(), true);
            InsertData('518000', XOtherServices, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('518100', XCleaning, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518210', XPhoneCharge, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518220', XPostage, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518300', XAdvertisement, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518900', XOtherServices, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('538100', XOthertaxesandfees, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('538900', XOthernotaxtaxesandfees, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('544100', XContractualPenaltiesAndInterests, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('544300', XPaymentsTolerance, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('545100', XOtherPenaltiesAndInterests, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('546100', XReceivablewriteoff, 0, 0, 0, '', 0, '', '', '', '', false);
            InsertData('548100', XOtheroperatingexpenses, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('568100', XOtherfinancialexpenses, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('601020', XSalesProductsDomestic, 0, 0, 0, '', 2, DomesticCode(), RetailCode(), '', '', true);
            InsertData('601030', XSalesProductsEu, 0, 0, 0, '', 2, EUCode(), RetailCode(), '', '', true);
            InsertData('601040', XSalesProductsExport, 0, 0, 0, '', 2, ExportCode(), RetailCode(), '', '', true);
            InsertData('602110', XSalesServicesDomestic, 0, 0, 0, '', 2, DomesticCode(), RetailCode(), '', '', true);
            InsertData('602120', XSalesServicesEu, 0, 0, 0, '', 2, EUCode(), RetailCode(), '', '', true);
            InsertData('602130', XSalesServicesExport, 0, 0, 0, '', 2, ExportCode(), RetailCode(), '', '', true);
            InsertData('602500', XSalesJobs, 0, 0, 0, '', 2, DomesticCode(), ServicesCode(), '', '', true);
            InsertData('604000', XSalesGoods, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('604110', XSalesGoodsDomestic, 0, 0, 0, '', 2, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('604120', XSalesGoodsEu, 0, 0, 0, '', 2, EUCode(), RawMatCode(), '', '', true);
            InsertData('604130', XSalesGoodsExport, 0, 0, 0, '', 2, ExportCode(), RawMatCode(), '', '', true);
            InsertData('604900', XSalesGoodsOther, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            InsertData('604990', XSalesGoodsTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('640000', XOtherOperatingIncome, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('641100', XSalesFixedAssets, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            InsertData('642100', XSalesmaterial, 0, 0, 0, '', 2, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('644100', XContractualPenaltiesAndInterests, 0, 0, 0, '', 2, DomesticCode(), ServicesCode(), '', '', true);
            InsertData('644110', XDiscounts, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            InsertData('644200', XRounding, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            InsertData('644300', XPaymentsTolerance, 0, 0, 0, '', 0, '', '', '', '', false);
            InsertData('648100', XOtherOperatingIncome, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('668100', XOtherfinancialexpenses, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
    ...
    var
        ...
        XPurchaseDeviationOfMaterial: Label 'Purchase deviation of material';
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData('512100', XTravelExpenses, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('512999', XServicesTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('513100', XRepresentationCosts, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518000', XOtherServices, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('518100', XCleaning, 0, 0, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('518999', XOtherServicesTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('520000', XPersonalExpenses, 3, 0, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('602500', XSalesJobs, 0, 0, 0, '', 2, DomesticCode(), ServicesCode(), '', '', true);
            InsertData('604000', XSalesGoods, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('604210', XSalesGoodsDomestic, 0, 0, 0, '', 2, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('604220', XSalesGoodsEu, 0, 0, 0, '', 2, EUCode(), RawMatCode(), '', '', true);
            InsertData('604230', XSalesGoodsExport, 0, 0, 0, '', 2, ExportCode(), RawMatCode(), '', '', true);
            InsertData('604900', XSalesGoodsOther, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            InsertData('604990', XSalesGoodsTotal, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('640000', XOtherOperatingIncome, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('641100', XSalesFixedAssets, 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData('001000', XFixedAssets, 3, 1, 0, '', 0, '', '', '', '', false);
            InsertData('010000', XIntangibleFixedAssets, 3, 1, 0, '', 0, '', '', '', '', false);
            InsertData('013100', XSoftware, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('019999', XIntangibleFixedAssetsTotal, 4, 1, 0, '', 0, '', '', '', '', false);
            InsertData('020000', XTangibleFixedAssets, 3, 1, 0, '', 0, '', '', '', '', false);
            InsertData('021100', XBuildings, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('022100', XMachinesToolsEquipment, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('022300', XVehicles, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('029990', XTangibleFixedAssetsTotal, 4, 1, 0, '', 0, '', '', '', '', true);
            InsertData('041100', XAcquisitionOfIntangibleFixedAssets, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            InsertData('042000', XAcquisitionOfTangibleFixedAssets, 3, 1, 0, '', 0, '', '', '', '', true);
            InsertData('042100', XAcquisitionOfBuildings, 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData('110000', XFixedAssetsTotal, 4, 1, 0, '', 0, '', '', '', '', true);
            InsertData('111000', XAcquisitionOfMaterial, 3, 1, 0, '', 0, '', '', '', '', true);
            InsertData('111100', XAcquisitionOfMaterial, 0, 1, 0, '', 1, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('112050', XMaterialInStockInterim, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('112100', XMaterialInStock, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('119999', XAcquisitionOfMaterialTotal, 4, 1, 0, '', 0, '', '', '', '', true);
            InsertData('121000', XFinishedProducts, 3, 1, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('129990', XFinishedProductsTotal, 4, 1, 0, '', 0, '', '', '', '', true);
            InsertData('131000', XAcquisitionOfGoods, 3, 1, 0, '', 0, '', '', '', '', true);
            InsertData('131050', XAcquisitionOfGoods, 0, 1, 0, '', 1, DomesticCode(), RetailCode(), '', '', true);
            InsertData('131450', XAcquisitionRetail, 0, 1, 0, '', 1, DomesticCode(), RetailCode(), '', '', true);
            InsertData('131455', XAcquisitionRetailInterim, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('131500', XAcquisitionRawMaterialDomestic, 0, 1, 0, '', 1, DomesticCode(), RawMatCode(), '', '', true);
            InsertData('131600', XAcquisitionRawMaterialEu, 0, 1, 0, '', 1, EUCode(), RawMatCode(), '', '', true);
            InsertData('131700', XAcquisitionRawMaterialExport, 0, 1, 0, '', 1, ExportCode(), RawMatCode(), '', '', true);
            InsertData('131950', XAcquisitionRawMaterial, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('131955', XAcquisitionRawMaterialInterim, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('131990', XAcquisitionOfGoodsTotal, 4, 1, 0, '', 0, '', '', '', '', true);
            InsertData('132000', XGoodsInStock, 3, 1, 0, '', 0, '', '', '', '', false);
