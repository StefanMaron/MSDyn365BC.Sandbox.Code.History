codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('980076', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('991120', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('980126', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('991220', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('980256', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('991320', XInvestmentCurrentFY, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('983010', XTradeGoodsPurchase0PercentVAT, 0, 1, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            InsertData('983020', XTradeGoodsPurchase6PercentVAT, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('997110', XTradeGoodsPurchase21PercVAT, 0, 1, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('983040', XTrGdsPurchRevChrgVAT, 0, 1, 0, '', 1, '', '', '', '', true);
            InsertData('997120', XTradeGoodsPurchaseVATEU, 0, 1, 0, '', 1, EUCode, RetailCode, '', '', true);
            InsertData('997130', XTrGoodsPurchaseOutsideEU, 0, 1, 0, '', 1, ExportCode, RetailCode, '', '', true);
            InsertData('983070', XDiscTrGoodsAcctsPayable, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('983110', XSemiFinGoodsPurch0PercentVAT, 0, 1, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            InsertData('983120', XSemiFinGoodsPurch6PercentVAT, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('983130', XSemiFinGoodsPurch21PercentVAT, 0, 1, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('983140', XSFGdsPrchRevChrgVAT, 0, 1, 0, '', 1, '', '', '', '', true);
            InsertData('983150', XSemiFinGoodsPurchVATEU, 0, 1, 0, '', 1, EUCode, RetailCode, '', '', true);
            InsertData('983160', XSFGoodsPurchaseOutsideEU, 0, 1, 0, '', 1, ExportCode, RetailCode, '', '', true);
            InsertData('983170', XDiscSemiFinAcctsPayable, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('983210', XRawMaterialsPurchase0PercVAT, 0, 1, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            InsertData('983220', XRawMaterialsPurchase6PercVAT, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('997210', XRawMaterialsPurchase21PercVAT, 0, 1, 0, '', 1, DomesticCode, RawMatCode, '', '', true);
            InsertData('983240', XRawMatPurchRevChrgVAT, 0, 1, 0, '', 1, '', '', '', '', true);
            InsertData('997220', XRawMaterialsPurchaseVATEU, 0, 1, 0, '', 1, EUCode, RawMatCode, '', '', true);
            InsertData('997230', XRawMatPurchaseOutsideEU, 0, 1, 0, '', 1, ExportCode, RawMatCode, '', '', true);
            InsertData('997240', XDiscRawMatAcctsPayable, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('983310', XAdditivesPurchase0PercentVAT, 0, 1, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            InsertData('983320', XAdditivesPurchase6PercentVAT, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('983330', XAdditivesPurchase21PercentVAT, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('983340', XAdditivPurchRevChrgVAT, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('983350', XAdditivesPurchaseVATEU, 0, 1, 0, '', 1, EUCode, MiscCode, '', '', true);
            InsertData('983360', XAdditivesPurchaseOutsideEU, 0, 1, 0, '', 1, ExportCode, MiscCode, '', '', true);
            ...
            InsertData('997150', XFreightTradeGoods, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', false);
            InsertData('983620', XFreightSemiFinishedGoods, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', false);
            InsertData('997250', XFreightRawMaterials, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', false);
            InsertData('983640', XFreightAdditives, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', '', false);
            ...
            InsertData('998110', XCleaningExpenses, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('998120', XGasWaterElectricity, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('998130', XRepairMaintenanceCost, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('984213', XCostOfRentLease, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('984214', XMinorExpensesInvMach, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('984217', XEquipmentExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('998640', XOtherOverheadCosts, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('998910', XOtherOperatingExpenses, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('998240', XPostalCharges, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('998230', XTelephoneCharges, 0, 0, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('998310', XComputerExpensesSoftware, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('998330', XComputerExpensesOther, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('998510', XFuelExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('998530', XMaintenanceExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('984520', XInsurances, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998520', XTaxes, 0, 0, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('998420', XEntertainmentExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('984625', XPromotionalGifts, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998430', XTravelAndAccommodnExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('999140', XInvoiceDifferences, 0, 0, 0, '', 0, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('998630', XAccountancyExpenses, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('998320', XConsultancyExpenses, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            ...
            InsertData('988010', XTradeGoodsSales0Percent, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            InsertData('988020', XTradeGoodsSales6Percent, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData('996110', XTradeGoodsSales21Percent, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('996120', XTradeGoodsSalesEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('996130', XTradeGoodsSalesOutsideEU, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('988110', XSemiFinishedGoodsSales0Perc, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            InsertData('988120', XSemiFinishedGoodsSales6Perc, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData('988130', XSemiFinishedGoodsSales21Perc, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('988140', XSemiFinishedGoodsSalesEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('988150', XSFGoodsSalesOutsideEU, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('996210', XRawMaterialsSales0Percent, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            InsertData('988220', XRawMaterialsSales6Percent, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData('988230', XRawMaterialsSales21Percent, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('996220', XRawMaterialsSalesEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('996230', XRawMaterialsSalesOutsideEU, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('988310', XAdditivesSales0Percent, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            InsertData('988320', XAdditivesSales6Percent, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData('996410', XAdditivesSales21Percent, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('996420', XAdditivesSalesEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('996430', XAdditivesSalesOutsideEU, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('988410', XFinishedGoodsSales0Percent, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            InsertData('988420', XFinishedGoodsSales6Percent, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData('988430', XFinishedGoodsSales21Percent, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('988440', XFinishedGoodsSalesEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('988450', XFinGoodsSalesOutsideEU, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('988550', XGamblingMachineSales, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('996620', XJobSales, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('996610', XOtherJobSales, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('996710', XConsultancySales, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('996810', XVariousSales, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('999120', XAccountReceivable, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
