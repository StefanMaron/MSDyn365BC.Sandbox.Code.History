codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('0201', X0201, 3, 1, 0, '', 0, '', '', '', GoodsVATCode, true);
            InsertData('0210', X0210, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0220', X0220, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0240', X0240, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0260', X0260, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0280', X0280, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('0290', X0290, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0299', X0299, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0300', X0300, 4, 1, 0, '', 0, '', '', '', '', false);
            InsertData('0301', X0301, 3, 1, 0, '', 0, '', '', '', '', false);
            InsertData('0310', X0310, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0320', X0320, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('0350', X0350, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('0380', X0380, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0400', X0400, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0410', X0410, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0420', X0420, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0430', X0430, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0440', X0440, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0450', X0450, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0460', X0460, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0480', X0480, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0490', X0490, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0491', X0491, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('0492', X0492, 0, 1, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            ...
            InsertData('1511', StrSubstNo(X1511, ServicesVATText), 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('1517', StrSubstNo(X1517, GoodsVATText), 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('1561', StrSubstNo(X1561, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1562', X1562, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1565', StrSubstNo(X1565, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1567', X1567, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1568', StrSubstNo(X1568, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1569', X1569, 4, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1570', X1570, 3, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1571', StrSubstNo(X1571, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1572', X1572, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1573', StrSubstNo(X1573, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1575', StrSubstNo(X1575, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1577', X1577, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1578', X1578, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1579', StrSubstNo(X1579, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('1588', X1588, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', 'EUST', true);
            ...
            InsertData('1711', StrSubstNo(X1711, ServicesVATText), 0, 1, 0, '', 2, DomesticCode, ManufactCode, '', ServicesVATCode, true);
            InsertData('1717', StrSubstNo(X1717, GoodsVATText), 0, 1, 0, '', 2, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            ...
            InsertData('1758', StrSubstNo(X1758, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1760', X1760, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1761', StrSubstNo(X1761, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1762', X1762, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1763', StrSubstNo(X1763, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1765', StrSubstNo(X1765, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1767', X1767, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1768', X1768, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('1771', StrSubstNo(X1771, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1772', X1772, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1773', StrSubstNo(X1773, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1775', StrSubstNo(X1775, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1777', X1777, 0, 1, 0, '', 0, '', '', '', '', false);
            InsertData('1778', StrSubstNo(X1778, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
            ...
            InsertData('1786', StrSubstNo(X1786, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('2000', X2000, 0, 0, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('2171', StrSubstNo(X2171, ServicesVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('2175', StrSubstNo(X2175, GoodsVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('2401', StrSubstNo(X2401, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', ServicesVATCode, true);
            InsertData('2402', X2402, 0, 0, 0, '', 2, EUCode, MiscCode, '', '', true);
            InsertData('2403', StrSubstNo(X2403, ServicesVATText), 0, 0, 0, '', 2, EUCode, MiscCode, '', ServicesVATCode, true);
            InsertData('2404', StrSubstNo(X2404, GoodsVATText), 0, 0, 0, '', 2, EUCode, MiscCode, '', '', true);
            InsertData('2405', StrSubstNo(X2405, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('2650', X2650, 0, 0, 0, '', 2, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('3110', StrSubstNo(X3110, ServicesVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3115', StrSubstNo(X3115, ServicesVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3120', StrSubstNo(X3120, GoodsVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3125', StrSubstNo(X3125, GoodsVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3130', StrSubstNo(X3130, ServicesVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3135', StrSubstNo(X3135, ServicesVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3140', StrSubstNo(X3140, GoodsVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3145', StrSubstNo(X3145, GoodsVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3150', X3150, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3200', X3200, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3300', StrSubstNo(X3300, ServicesVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3400', StrSubstNo(X3400, GoodsVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('3420', StrSubstNo(X3420, ServicesVATText), 0, 0, 0, '', 1, EUCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3425', StrSubstNo(X3425, GoodsVATText), 0, 0, 0, '', 1, EUCode, RetailCode, '', '', true);
            InsertData('3430', StrSubstNo(X3430, ServicesVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3435', StrSubstNo(X3435, GoodsVATText), 0, 0, 0, '', 1, '', '', '', '', true);
            InsertData('3550', X3550, 0, 0, 0, '', 1, EUCode, RetailCode, '', NoVATCode, true);
            InsertData('3559', X3559, 0, 0, 0, '', 1, ExportCode, RetailCode, '', NoVATCode, true);
            InsertData('3598', X3598, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3600', X3600, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3610', StrSubstNo(X3610, ServicesVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('3650', StrSubstNo(X3650, GoodsVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('3698', X3698, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3700', X3700, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3710', StrSubstNo(X3710, ServicesVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3720', StrSubstNo(X3720, GoodsVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('3724', StrSubstNo(X3724, ServicesVATText), 0, 0, 0, '', 1, EUCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3725', StrSubstNo(X3725, GoodsVATText), 0, 0, 0, '', 1, EUCode, RetailCode, '', '', true);
            ...
            InsertData('3731', StrSubstNo(X3731, ServicesVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3732', StrSubstNo(X3732, GoodsVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('3733', X3733, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('3734', X3734, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('3736', X3736, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', '', true);
            InsertData('3737', X3737, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3740', X3740, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3750', StrSubstNo(X3750, ServicesVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3760', StrSubstNo(X3760, GoodsVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('3765', X3765, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3770', X3770, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3780', StrSubstNo(X3780, ServicesVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('3790', StrSubstNo(X3790, GoodsVATText), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('3795', X3795, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3796', X3796, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3799', X3799, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('3800', X3800, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('3830', X3830, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            ...
            InsertData('4205', X4205, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4210', X4210, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4218', X4218, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4220', X4220, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', '', true);
            InsertData('4228', X4228, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4230', X4230, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4240', X4240, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4250', X4250, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4260', X4260, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4270', X4270, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4280', X4280, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4300', X4300, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('4301', StrSubstNo(X4301, ServicesVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('4305', StrSubstNo(X4305, GoodsVATText), 0, 0, 0, '', 0, '', '', '', '', true);
            ...
            InsertData('4500', X4500, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4510', X4510, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4520', X4520, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4530', X4530, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4540', X4540, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4550', X4550, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4570', X4570, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4580', X4580, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4600', X4600, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4610', X4610, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4630', X4630, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4635', X4635, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4638', X4638, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4640', X4640, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4650', X4650, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4653', X4653, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4654', X4654, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4655', X4655, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4660', X4660, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4670', X4670, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4700', X4700, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4710', X4710, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4730', X4730, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4750', X4750, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4760', X4760, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4780', X4780, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4790', X4790, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4800', X4800, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4805', X4805, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4809', X4809, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4810', X4810, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4811', X4811, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('4900', X4900, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4905', X4905, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4910', X4910, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4920', X4920, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4925', X4925, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4930', X4930, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4940', X4940, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4945', X4945, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4946', X4946, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4948', X4948, 0, 0, 0, '', 1, DomesticCode, ManufactCode, '', GoodsVATCode, true);
            InsertData('4950', X4950, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('4955', X4955, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('4957', X4957, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4960', X4960, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4965', X4965, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4966', X4966, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4968', X4968, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4969', X4969, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4970', X4970, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4975', X4975, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4976', X4976, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4980', X4980, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('4985', X4985, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('7110', X7110, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('7120', X7120, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('7130', X7130, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('7140', X7140, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            InsertData('7149', X7149, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8000', X8000, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8099', X8099, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8100', X8100, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8110', X8110, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8120', X8120, 0, 0, 0, '', 2, ExportCode, RetailCode, '', NoVATCode, true);
            InsertData('8125', X8125, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('8128', X8128, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('8130', X8130, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('8140', X8140, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('8150', X8150, 0, 0, 0, '', 2, ExportCode, RetailCode, '', '', true);
            InsertData('8196', StrSubstNo(X8196, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8199', X8199, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8200', X8200, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8300', StrSubstNo(X8300, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8310', StrSubstNo(X8310, ServicesVATText), 0, 0, 0, '', 2, EUCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8315', StrSubstNo(X8315, GoodsVATText), 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('8320', X8320, 0, 0, 0, '', 2, EUCode, MiscCode, '', NoVATCode, true);
            InsertData('8338', X8338, 0, 0, 0, '', 2, ExportCode, MiscCode, '', NoVATCode, true);
            InsertData('8339', X8339, 0, 0, 0, '', 2, EUCode, MiscCode, '', NoVATCode, true);
            InsertData('8400', StrSubstNo(X8400, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('8505', X8505, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', NoVATCode, true);
            InsertData('8506', StrSubstNo(X8506, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8508', StrSubstNo(X8508, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8509', X8509, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8511', X8511, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8515', X8515, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8520', X8520, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8530', X8530, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8540', X8540, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8549', X8549, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8550', X8550, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8589', X8589, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8590', X8590, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8591', StrSubstNo(X8591, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8595', StrSubstNo(X8595, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8600', X8600, 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8610', X8610, 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8611', StrSubstNo(X8611, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8620', X8620, 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8625', X8625, 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8630', StrSubstNo(X8630, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8640', StrSubstNo(X8640, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, ManufactCode, '', '', true);
            InsertData('8645', X8645, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8649', X8649, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8650', X8650, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8660', X8660, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8699', X8699, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8700', X8700, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8705', X8705, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8710', StrSubstNo(X8710, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8720', StrSubstNo(X8720, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8725', StrSubstNo(X8725, ServicesVATText), 0, 0, 0, '', 2, EUCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8726', StrSubstNo(X8726, GoodsVATText), 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            InsertData('8730', X8730, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8731', StrSubstNo(X8731, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8732', StrSubstNo(X8732, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('8750', StrSubstNo(X8750, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8760', StrSubstNo(X8760, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8765', X8765, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8770', X8770, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8780', StrSubstNo(X8780, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', ServicesVATCode, true);
            InsertData('8790', StrSubstNo(X8790, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('8801', StrSubstNo(X8801, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8807', X8807, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', NoVATCode, true);
            InsertData('8808', X8808, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', NoVATCode, true);
            InsertData('8809', StrSubstNo(X8809, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8817', X8817, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('8818', X8818, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('8819', X8819, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('8820', StrSubstNo(X8820, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData('8827', X8827, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', NoVATCode, true);
            InsertData('8828', X8828, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', NoVATCode, true);
            ...
            InsertData('8905', X8905, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', NoVATCode, true);
            InsertData('8910', StrSubstNo(X8910, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8915', StrSubstNo(X8915, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', ServicesVATCode, true);
            InsertData('8916', X8916, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('8919', X8919, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8920', X8920, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8921', StrSubstNo(X8921, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8930', StrSubstNo(X8930, ServicesVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', ServicesVATCode, true);
            InsertData('8935', X8935, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8939', X8939, 4, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8940', X8940, 3, 0, 0, '', 0, '', '', '', '', false);
            InsertData('8941', StrSubstNo(X8941, GoodsVATText), 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8945', X8945, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('8949', X8949, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
    ...
    var
        ...
        X40000: Label 'INCOME STATEMENT';
        X40001: Label 'INCOME';
        X40100: Label 'Income, Services';
        X40200: Label 'Income, Product Sales';
        X40300: Label 'Sales Discounts';
        X40400: Label 'Sales Returns & Allowances';
        X40500: Label 'Interest Income';
        X40990: Label 'TOTAL INCOME';
        X50001: Label 'COST OF GOODS SOLD';
        X50100: Label 'Cost of Materials';
        X50200: Label 'Cost of Labor';
        X50990: Label 'TOTAL COST OF GOODS SOLD';
        X60001: Label 'EXPENSES';
        X60100: Label 'Rent Expense';
        X60200: Label 'Advertising Expense';
        X60300: Label 'Interest Expense';
        X60400: Label 'Bank Charges and Fees';
        X60500: Label 'Processing Fees';
        X60600: Label 'Bad Debt Expense';
        X60700: Label 'Salaries Expense';
        X60800: Label 'Payroll Tax Expense';
        X60900: Label 'Workers Compensation ';
        X61000: Label 'Health & Dental Insurance Expense';
        X61100: Label 'Life Insurance Expense';
        X61200: Label 'Repairs and Maintenance Expense';
        X61300: Label 'Utilities Expense';
        X61400: Label 'Office Supplies Expense';
        X61500: Label 'Miscellaneous Expense';
        X61600: Label 'Depreciation, Equipment';
        X61700: Label 'Federal Income Tax Expense';
        X61800: Label 'State Income Tax Expense';
        X61900: Label 'Rounding';
        X61990: Label 'TOTAL EXPENSES';
        X61995: Label 'NET INCOME';
        X10000: Label 'BALANCE SHEET';
        X10001: Label 'ASSETS';
        X10100: Label 'Checking account';
        X10200: Label 'Savings account';
        X10300: Label 'Petty Cash';
        X10400: Label 'Accounts Receivable';
        X10500: Label 'Prepaid Rent';
        X10600: Label 'Prepaid Insurance';
        X10700: Label 'Inventory';
        X10800: Label 'Equipment';
        X10900: Label 'Accumulated Depreciation';
        X10990: Label 'TOTAL ASSETS';
        X20001: Label 'LIABILITIES';
        X20100: Label 'Accounts Payable';
        X20200: Label 'Purchase Discounts';
        X20300: Label 'Purchase Returns & Allowances';
        X20400: Label 'Deferred Revenue';
        X20500: Label 'Credit Cards';
        X20600: Label 'Sales Tax Payable';
        X20700: Label 'Accrued Salaries & Wages';
        X20800: Label 'Federal Withholding Payable';
        X20900: Label 'State Withholding Payable';
        X21000: Label 'FICA Payable';
        X21100: Label 'Medicare Payable';
        X21200: Label 'FUTA Payable';
        X21300: Label 'SUTA Payable';
        X21400: Label 'Employee Benefits Payable';
        X21500: Label 'Vacation Compensation Payable';
        X21600: Label 'Garnishment Payable';
        X21700: Label 'Federal Income Taxes Payable';
        X21800: Label 'State Income Tax Payable';
        X21900: Label 'Notes Payable';
        X30100: Label 'Capital Stock';
        X30200: Label 'Retained Earnings';
        X30290: Label 'This Year Earnings';
        X30300: Label 'Distributions to Shareholders';
        X30990: Label 'TOTAL LIABILITIES';
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData(SaleofFinishedGoods(), SaleofFinishedGoodsName(), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData(SaleofRawMaterials(), SaleofRawMaterialsName(), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            InsertData(ResaleofGoods(), ResaleofGoodsName(), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData(SaleofResources(), SaleofResourcesName(), 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData(SaleofSubcontracting(), SaleofSubcontractingName(), 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            InsertData(TotalSalesofResources(), TotalSalesofResourcesName(), 4, 0, 0, '4410..4413', 0, '', '', '', '', true);
            InsertData(Incomefromsecurities(), IncomefromsecuritiesName(), 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', GoodsVATCode(), true);
            InsertData(ManagementFeeRevenue(), ManagementFeeRevenueName(), 0, 0, 0, '', 2, '', '', '', '', true);
            InsertData(InterestIncome(), InterestIncomeName(), 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData(SalesofServiceContracts(), SalesofServiceContractsName(), 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            ...
            InsertData(PayableInvoiceRounding(), PayableInvoiceRoundingName(), 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData(MiscVATPayable(), MiscVATPayableName(), 0, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', true);
