codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('992920', StrSubstNo(XBank, UpperCase("Currency Code")), 0, 1, 0, '', 0, '', '', '', '', false);
            ...
            InsertData('998240', XPostage, 0, 0, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('998430', XTravel, 0, 0, 0, '', 1, DomesticCode, NoVATCode, '', '', true);
            ...
            InsertData('998510', XFuelandMotorOil, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('999999', XNETINCOME, 2, 0, 1,
              Adjust.Convert('996000') + '..' + Adjust.Convert('999999'), 0, '', '', '', '', true);
            InsertData('995612', StrSubstNo(XSalesFullVAT, ServicesVATText), 0, 1, 0, '', 2, '', 'MISC', '', '', true);
            InsertData('995613', StrSubstNo(XSalesFullVAT, GoodsVATText), 0, 1, 0, '', 2, '', 'MISC', '', '', true);
            InsertData('995632', StrSubstNo(XPurchaseFullVAT, ServicesVATText), 0, 1, 0, '', 1, '', 'MISC', '', '', true);
            InsertData('995633', StrSubstNo(XPurchaseFullVAT, GoodsVATText), 0, 1, 0, '', 1, '', 'MISC', '', '', true);
        end;
