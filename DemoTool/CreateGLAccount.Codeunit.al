                ...
                "Company Type"::VAT:
                    begin
                        ...
                        if "Advanced Setup" then begin
                            ...
                            InsertData('995613', StrSubstNo(XSalesVATPERCENTUnrealized, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995616', StrSubstNo(XSalesVATPERCENTUnrealized, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995620', StrSubstNo(XPurchaseVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995621', StrSubstNo(XPurchaseVATPERCENT, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995623', StrSubstNo(XPurchaseVATPCTUnrealized, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995626', StrSubstNo(XPurchaseVATPCTUnrealized, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            ...
                            InsertData('995615', StrSubstNo(XSalesVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995620', StrSubstNo(XPurchaseVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995621', StrSubstNo(XPurchaseVATPERCENT, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995625', StrSubstNo(XPurchaseVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995630', StrSubstNo(XSalesVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        end;
                    end;
            end;
