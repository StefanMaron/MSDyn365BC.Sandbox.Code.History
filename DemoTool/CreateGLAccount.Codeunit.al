codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('360000', XVendorPrepayments, 0, 1, 0, '', 0, '', MiscCode, '', GoodsVATCode);
            ...
            InsertData('406000', XCustomerPrepayments, 0, 1, 0, '', 0, '', MiscCode, '', GoodsVATCode);
            InsertData('407000', XDoubtfulDebtors, 0, 1, 0, '', 0, '', '', '', '');
            InsertData('41', XOtherReceivables, 2, 1, 0, '410..419999', 0, '', '', '', '');
            InsertData('411000', XVATRecoverable, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XVAT);
            ...
            InsertData('451000', XVATPayable, 0, 1, 0, '', 2, DomesticCode, MiscCode, '', XVAT);
            InsertData('452000', XTaxesPayable, 0, 1, 0, '', 0, '', '', '', '');
            InsertData('453', XPersonnelrelatedItems, 2, 1, 0, '4530..459999', 0, '', '', '', '');
            InsertData('453000', XRetainedDeductionsatSource, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('454000', XSocialSecurity, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            ...
            InsertData('600000', XPurchasesRawMatDom, 0, 1, 0, '', 1, DomesticCode, RawMatCode, '', XG1);
            InsertData('600010', XPurchasesRawMatEU, 0, 1, 0, '', 1, EUCode, RawMatCode, '', XG1);
            InsertData('600020', XPurchasesRawMatExport, 0, 1, 0, '', 1, ExportCode, RawMatCode, '', XG1);
            InsertData('601', XPurchasesAuxiliaryMaterials, 2, 1, 0, '6010..601999', 0, '', '', '', '');
            InsertData('602', XPurchasesServices, 2, 1, 0, '6020..602999', 0, '', '', '', '');
            InsertData('602000', XResourceUsageCosts, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('602010', XJobCosts, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('603', XGeneralSubcontractings, 2, 1, 0, '6030..603999', 0, '', '', '', '');
            InsertData('604', XPurchasesofGoods, 2, 1, 0, '6040..604999', 0, '', '', '', '');
            InsertData('604000', XPurchasesRetailDom, 0, 1, 0, '', 1, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('604010', XPurchasesRetailEU, 0, 1, 0, '', 1, EUCode, RetailCode, '', GoodsVATCode);
            InsertData('604020', XPurchasesRetailExport, 0, 1, 0, '', 1, ExportCode, RetailCode, '', GoodsVATCode);
            ...
            InsertData('609180', XJobCostAdjustmentRetail, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('609270', XInventAdjRawMat, 0, 1, 0, '', 0, '', '', '', '');
            InsertData('609271', XInventAdjRawMatInt, 0, 1, 0, '', 0, '', '', '', '');
            InsertData('609280', XJobCostAdjustmentRawMat, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('609480', XJobCostAdjustmentResources, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('61', XServicesandInvestmentGoods, 2, 0, 1, '610..619999', 0, '', '', '', '');
            InsertData('610000', XRentBuildingsRSEquipm, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('611000', XRandMBuildingsandEquipm, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('611300', XRandMRollingStock, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('611400', XCleaningProducts, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612000', XElectricityWaterandHeating, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612120', XGasolineandMotorOil, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612200', XPhoneandFax, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612400', XPostage, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('612500', XOfficeSupplies, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612600', XSoftware, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612610', XConsultantServices, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612620', XOtherComputerExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('612800', XMailings, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('613100', XInsurancesRSFire, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('613230', XLawyersandAccountants, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('613310', XLegalContests, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('613390', XOtherServiceCharges, 2, 0, 0, '613390..613399', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('613392', XPurchaseCostsRawMat, 0, 0, 0, '', 1, DomesticCode, RawMatCode, '', XG1);
            InsertData('613395', XPurchaseCostsRetail, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('613399', XPurchaseCostsInterim, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('613900', XTravel, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('613930', XTranspCostspurchRawMat, 0, 0, 0, '', 1, DomesticCode, RawMatCode, '', XG1);
            InsertData('613935', XTranspCostspurchRetail, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('614000', XAdvertising, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('614500', XEntertainmentandPR, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('62', XSocialSecurity, 2, 0, 1, '620..629999', 0, '', '', '', '');
            InsertData('620200', XSalaries, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('620300', XWages, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('621000', XPayrollTaxes, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('623000', XOtherPersonnelExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('624000', XRetirementPlanContributions, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            ...
            InsertData('640100', XVehicleTaxes, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('640200', XFines, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('643000', XMiscCostsofOperations, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('65', XFinancialCharges, 2, 0, 1, '650..659999', 0, '', '', '', '');
            InsertData('650000', XInterestonBankBalances, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('650010', XInterestonBankAccount, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('650020', XMortgage, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            ...
            InsertData('660000', XExtraordinaryExpenses, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('663000', XLossesDisposalFixedAssets, 0, 0, 0, '', 0, '', '', '', '');
            InsertData('67', XCorporateTax, 2, 0, 0, '670..679999', 0, '', '', '', '');
            InsertData('670000', XCorporateTax, 0, 0, 1, '', 1, DomesticCode, MiscCode, '', XS0);
            ...
            InsertData('700000', XSalesRetailDom, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('700010', XSalesRetailEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', GoodsVATCode);
            InsertData('700020', XSalesRetailExport, 0, 0, 0, '', 2, ExportCode, RetailCode, '', GoodsVATCode);
            InsertData('701', XSalesofRawMaterials, 2, 0, 0, '7010..701999', 0, '', '', '', '');
            InsertData('701000', XSalesRawMatDom, 0, 0, 0, '', 2, DomesticCode, RawMatCode, '', XG1);
            InsertData('701010', XSalesRawMatEU, 0, 0, 0, '', 2, EUCode, RawMatCode, '', XG1);
            InsertData('701020', XSalesRawMatExport, 0, 0, 0, '', 2, ExportCode, RawMatCode, '', XG1);
            InsertData('702', XSalesofResources, 2, 0, 0, '7020..702999', 0, '', '', '', '');
            InsertData('702000', XSalesResourcesDom, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('702010', XSalesResourcesEU, 0, 0, 0, '', 2, EUCode, ServicesCode, '', ServicesVATCode);
            InsertData('702020', XSalesResourcesExport, 0, 0, 0, '', 2, ExportCode, ServicesCode, '', ServicesVATCode);
            InsertData('703', XSalesofJobs, 2, 0, 0, '7030..703999', 0, '', '', '', '');
            InsertData('703000', XSalesJobs, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('703010', XSalesOtherJobExpenses, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('704000', XConsultingFees, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', ServicesVATCode);
            ...
            InsertData('754200', XInvoiceRounding, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('755000', XCashDiscrepancies, 0, 0, 0, '', 0, '', '', '', '');
            InsertData('756200', XFinanceChargesfromCustomers, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', XS0);
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData('602000', XResourceUsageCosts, 0, 1, 0, '', 1, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('602010', XJobCosts, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', ServicesVATCode);
            InsertData('603', XGeneralSubcontractings, 2, 0, 0, '6030..603999', 0, '', '', '', '');
            InsertData('604', XPurchasesofGoods, 2, 0, 0, '6040..604999', 0, '', '', '', '');
            InsertData('604000', XPurchasesRetailDom, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', GoodsVATCode);
            InsertData('604010', XPurchasesRetailEU, 0, 0, 0, '', 1, EUCode, RetailCode, '', GoodsVATCode);
            InsertData('604020', XPurchasesRetailExport, 0, 0, 0, '', 1, ExportCode, RetailCode, '', GoodsVATCode);
            ...
            InsertData('609180', XJobCostAdjustmentRetail, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('609270', XInventAdjRawMat, 0, 0, 0, '', 0, '', '', '', '');
            InsertData('609271', XInventAdjRawMatInt, 0, 0, 0, '', 0, '', '', '', '');
            InsertData('609280', XJobCostAdjustmentRawMat, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('609480', XJobCostAdjustmentResources, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', XS0);
            InsertData('61', XServicesandInvestmentGoods, 2, 0, 1, '610..619999', 0, '', '', '', '');
            InsertData('610000', XRentBuildingsRSEquipm, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('611000', XRandMBuildingsandEquipm, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
            InsertData('611300', XRandMRollingStock, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', ServicesVATCode);
