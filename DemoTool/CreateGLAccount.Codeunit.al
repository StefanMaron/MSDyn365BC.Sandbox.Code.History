codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('991120', XIncreasesduringtheYear, 0, 1, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('991130', XDecreasesduringtheYear, 0, 1, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('991230', XDecreasesduringtheYear, 0, 1, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('991330', XDecreasesduringtheYear, 0, 1, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('992410', StrSubstNo(XVendorPrepaymentsVAT, NoVATCode), 0, 1, 0, '', 0, '', NoVATCode, '', '', false);
            InsertData('992420', StrSubstNo(XVendorPrepaymentsVAT, ServicesCode), 0, 1, 0, '', 0, '', ServicesCode, '', '', false);
            InsertData('992430', StrSubstNo(XVendorPrepaymentsVAT, RetailCode), 0, 1, 0, '', 0, '', RetailCode, '', '', false);
            ...
            InsertData('995360', StrSubstNo(XCustomerPrepaymentsVAT, NoVATCode), 0, 1, 0, '', 0, '', NoVATCode, '', '', false);
            InsertData('995370', StrSubstNo(XCustomerPrepaymentsVAT, ServicesCode), 0, 1, 0, '', 0, '', ServicesCode, '', '', false);
            InsertData('995380', StrSubstNo(XCustomerPrepaymentsVAT, RetailCode), 0, 1, 0, '', 0, '', RetailCode, '', '', false);
            ...
            case "Company Type" of
                ...
                "Company Type"::VAT:
                    begin
                        InsertData('995611', StrSubstNo(XSalesVATPERCENT, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995620', StrSubstNo(XPurchaseVATPERCENTEU, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995621', StrSubstNo(XPurchaseVATPERCENTEU, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995630', StrSubstNo(XPurchaseVATPERCENT, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        InsertData('995631', StrSubstNo(XPurchaseVATPERCENT, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        if "Advanced Setup" then begin
                            InsertData('995615', StrSubstNo(XSalesVATPERCENTUnrealized, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995616', StrSubstNo(XSalesVATPERCENTUnrealized, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995625', StrSubstNo(XPurchaseVATPERCENTEUUnreal, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995626', StrSubstNo(XPurchaseVATPERCENTEUUnreal, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995635', StrSubstNo(XPurchaseVATPCTUnrealized, GoodsVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                            InsertData('995636', StrSubstNo(XPurchaseVATPCTUnrealized, ServicesVATText), 0, 1, 0, '', 0, '', '', '', '', false);
                        end;
                    end;
            end;
            ...
            InsertData('996110', XSalesRetailDom, 0, 0, 0, '', 2, '', RetailCode, '', '', true);
            InsertData('996120', XSalesRetailEU, 0, 0, 0, '', 2, EUCode, RetailCode, '', '', true);
            ...
            InsertData('996210', XSalesRawMaterialsDom, 0, 0, 0, '', 2, '', RawMatCode, '', '', true);
            InsertData('996220', XSalesRawMaterialsEU, 0, 0, 0, '', 2, EUCode, RawMatCode, '', '', true);
            ...
            InsertData('996410', XSalesResourcesDom, 0, 0, 0, '', 2, '', ServicesCode, '', '', true);
            InsertData('996420', XSalesResourcesEU, 0, 0, 0, '', 2, EUCode, ServicesCode, '', '', true);
            ...
            InsertData('996610', XSalesOtherJobExpenses, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('996620', XJobSales, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('996695', XTotalSalesofJobs, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('996710', XConsultingFeesDom, 0, 0, 0, '', 2, '', ServicesCode, '', '', true);
            InsertData('996810', XFeesandChargesRecDom, 0, 0, 0, '', 2, '', MiscCode, '', '', true);
            ...
            InsertData('997110', XPurchRetailDom, 0, 0, 0, '', 1, '', RetailCode, '', '', true);
            InsertData('997120', XPurchRetailEU, 0, 0, 0, '', 1, EUCode, RetailCode, '', '', true);
            ...
            InsertData('997150', XDeliveryExpensesRetail, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            ...
            InsertData('997210', XPurchRawMaterialsDom, 0, 0, 0, '', 1, '', RawMatCode, '', '', true);
            InsertData('997220', XPurchRawMaterialsEU, 0, 0, 0, '', 1, EUCode, RawMatCode, '', '', true);
            InsertData('997230', XPurchRawMaterialsExport, 0, 0, 0, '', 1, ExportCode, RawMatCode, '', '', true);
            InsertData('997240', XDiscReceivedRawMaterials, 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData('997250', XDeliveryExpensesRawMat, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            ...
            InsertData('998110', XCleaning, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998120', XElectricityandHeating, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998130', XRepairsandMaintenance, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998190', XTotalBldgMaintExpenses, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998200', XAdministrativeExpenses, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998210', XOfficeSupplies, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998230', XPhoneandFax, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998240', XPostage, 0, 0, 0, '', 1, '', NoVATCode, '', '', true);
            InsertData('998290', XTotalAdministrativeExpenses, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998300', XComputerExpenses, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998310', XSoftware, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998320', XConsultantServices, 0, 0, 0, '', 1, '', ServicesCode, '', '', true);
            InsertData('998330', XOtherComputerExpenses, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998390', XTotalComputerExpenses, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998400', XSellingExpenses, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998410', XAdvertising, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998420', XEntertainmentandPR, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998430', XTravel, 0, 0, 0, '', 1, '', NoVATCode, '', '', true);
            InsertData('998450', XDeliveryExpenses, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998490', XTotalSellingExpenses, 4, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998500', XVehicleExpenses, 3, 0, 0, '', 0, '', '', '', '', true);
            InsertData('998510', XGasolineandMotorOil, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998520', XRegistrationFees, 0, 0, 0, '', 1, '', NoVATCode, '', '', true);
            InsertData('998530', XRepairsandMaintenance, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            ...
            InsertData('998630', XLegalandAccountingServices, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            InsertData('998640', XMiscellaneous, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            ...
            InsertData('998910', XOtherCostsofOperations, 0, 0, 0, '', 1, '', MiscCode, '', '', true);
            ...
            InsertData('999120', XFinanceChargesfromCustomers, 0, 0, 0, '', 2, '', NoVATCode, '', '', true);
            ...
            InsertData('999140', XInvoiceRounding, 0, 0, 0, '', 0, '', NoVATCode, '', '', true);
    ...
    var
        ...
        XShortTermInvestTotal: Label 'Short term investments, Total';
        XPrepaidExpenses: Label 'Prepaid expenses';
        XPrepaidExpensesTotal: Label 'Prepaid expenses, Total';
        XLand: Label 'Land';
        XBuildings: Label 'Buildings';
        XBuildingsTotal: Label 'Buildings, Total';
        ...
        XTotalExpenses: Label 'Total Expenses';
        XRentExpenses: Label 'Rent expenses';
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData(GetGLNoName.SalesOtherJobExpenses(), GetGLNoName.SalesOtherJobExpensesName(), 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.SalesResourcesDom(), GetGLNoName.SalesResourcesDomName(), 0, 0, 0, '', 2, DomesticCode(), ServicesCode(), '', '', true);
            InsertData(GetGLNoName.SalesResourcesExport(), GetGLNoName.SalesResourcesExportName(), 0, 0, 0, '', 2, ExportCode(), ServicesCode(), '', '', true);
            ...
            InsertData(GetGLNoName.SalesRawMaterialsDom(), GetGLNoName.SalesRawMaterialsDomName(), 0, 0, 0, '', 2, DomesticCode(), RawMatCode(), '', '', true);
            InsertData(GetGLNoName.SalesRawMaterialsExport(), GetGLNoName.SalesRawMaterialsExportName(), 0, 0, 0, '', 2, ExportCode(), RawMatCode(), '', '', true);
            ...
            InsertData(GetGLNoName.SalesRetailDom(), GetGLNoName.SalesRetailDomName(), 0, 0, 0, '', 2, DomesticCode(), RetailCode(), '', '', true);
            InsertData(GetGLNoName.SalesRetailExport(), GetGLNoName.SalesRetailExportName(), 0, 0, 0, '', 2, ExportCode(), RetailCode(), '', '', true);
            ...
            InsertData(GetGLNoName.FinanceChargesfromCustomers(), GetGLNoName.FinanceChargesfromCustomersName(), 0, 0, 0, '', 2, '', Zero(), '', '', true);
            ...
            InsertData(GetGLNoName.InvoiceRounding(), GetGLNoName.InvoiceRoundingName(), 0, 0, 0, '', 0, '', Zero(), '', '', true);
            ...
            InsertData(GetGLNoName.FeesandChargesRecDom(), GetGLNoName.FeesandChargesRecDomName(), 0, 0, 0, '', 2, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.PurchRawMaterialsDom(), GetGLNoName.PurchRawMaterialsDomName(), 0, 0, 0, '', 1, DomesticCode(), RawMatCode(), '', '', true);
            InsertData(GetGLNoName.PurchRawMaterialsExport(), GetGLNoName.PurchRawMaterialsExportName(), 0, 0, 0, '', 1, ExportCode(), RawMatCode(), '', '', true);
            InsertData(GetGLNoName.DiscReceivedRawMaterials(), GetGLNoName.DiscReceivedRawMaterialsName(), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData(GetGLNoName.DeliveryExpensesRawMat(), GetGLNoName.DeliveryExpensesRawMatName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.InventoryAdjmtRawMat(), GetGLNoName.InventoryAdjmtRawMatName(), 0, 0, 0, '', 0, '', '', '', '', true);
            InsertData(GetGLNoName.DeliveryExpensesRetail(), GetGLNoName.DeliveryExpensesRetailName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.PurchRetailDom(), GetGLNoName.PurchRetailDomName(), 0, 0, 0, '', 1, DomesticCode(), RetailCode(), '', '', true);
            InsertData(GetGLNoName.PurchRetailExport(), GetGLNoName.PurchRetailExportName(), 0, 0, 0, '', 1, ExportCode(), RetailCode(), '', '', true);
            ...
            InsertData(GetGLNoName.Advertising(), GetGLNoName.AdvertisingName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.EntertainmentandPR(), GetGLNoName.EntertainmentandPRName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.Travel(), GetGLNoName.TravelName(), 0, 0, 0, '', 0, '', Zero(), '', '', true);
            InsertData(GetGLNoName.DeliveryExpenses(), GetGLNoName.DeliveryExpensesName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.GasolineandMotorOil(), GetGLNoName.GasolineandMotorOilName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.RegistrationFees(), GetGLNoName.RegistrationFeesName(), 0, 0, 0, '', 0, '', Zero(), '', '', true);
            InsertData(GetGLNoName.RepairsandMaintenance(), GetGLNoName.RepairsandMaintenanceName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.Software(), GetGLNoName.SoftwareName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.ConsultantServices(), GetGLNoName.ConsultantServicesName(), 0, 0, 0, '', 0, '', ServicesCode(), '', '', true);
            InsertData(GetGLNoName.OtherComputerExpenses(), GetGLNoName.OtherComputerExpensesName(), 0, 0, 0, '', 0, '', MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.Cleaning(), GetGLNoName.CleaningName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.ElectricityandHeating(), GetGLNoName.ElectricityandHeatingName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.OfficeSupplies(), GetGLNoName.OfficeSuppliesName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.PhoneandFax(), GetGLNoName.PhoneandFaxName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.Postage(), GetGLNoName.PostageName(), 0, 0, 0, '', 1, '', Zero(), '', '', true);
            ...
            InsertData(GetGLNoName.LegalandAccountingServices(), GetGLNoName.LegalandAccountingServicesName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.Miscellaneous(), GetGLNoName.MiscellaneousName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
            InsertData(GetGLNoName.OtherCostsofOperations(), GetGLNoName.OtherCostsofOperationsName(), 0, 0, 0, '', 1, '', MiscCode(), '', '', true);
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData(GetGLNoName.VendorPrepaymentsSERVICES(), GetGLNoName.VendorPrepaymentsSERVICESName(), 0, 1, 0, '', 0, '', ServicesCode(), '', '', true);
            InsertData(GetGLNoName.VendorPrepaymentsRETAIL(), GetGLNoName.VendorPrepaymentsRETAILName(), 0, 1, 0, '', 0, '', RetailCode(), '', '', true);
            ...
            InsertData(GetGLNoName.Vehicles(), GetGLNoName.VehiclesName(), 3, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.OperatEquipment(), GetGLNoName.OperatingEquipmentName(), 0, 1, 0, '', 1, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.LandandBuilding(), GetGLNoName.LandandBuildingsName(), 0, 1, 0, '', 0, DomesticCode(), MiscCode(), '', '', true);
            ...
            InsertData(GetGLNoName.CustomerPrepaymentsSERVICES(), GetGLNoName.CustomerPrepaymentsSERVICESName(), 0, 1, 0, '', 0, '', ServicesCode(), '', '', true);
            InsertData(GetGLNoName.CustomerPrepaymentsRETAIL(), GetGLNoName.CustomerPrepaymentsRETAILName(), 0, 1, 0, '', 0, '', RetailCode(), '', '', true);
    ...
    local procedure AddGIFICodeToGLAccounts()
    begin
        AssignGIFICode('40000', '8299');
        AssignGIFICode('42000', '8000');
        AssignGIFICode('42500', '8000');
        AssignGIFICode('43000', '8040');
        AssignGIFICode('43500', '8040');
        AssignGIFICode('44000', '8000');
        AssignGIFICode('44500', '8000');
        AssignGIFICode('45000', '8241');
        AssignGIFICode('45100', '8239');
        AssignGIFICode('45200', '8000');
        AssignGIFICode('47000', '8090');
        AssignGIFICode('47600', '8090');
        AssignGIFICode('48000', '8230');
        AssignGIFICode('48100', '8231');
        AssignGIFICode('48200', '8231');
        AssignGIFICode('48300', '8231');
        AssignGIFICode('48400', '8231');
        AssignGIFICode('48600', '8230');
        AssignGIFICode('49950', '8299');
        AssignGIFICode('51000', '8360');
        AssignGIFICode('52000', '8340');
        AssignGIFICode('52300', '8340');
        AssignGIFICode('53000', '8320');
        AssignGIFICode('53900', '8320');
        AssignGIFICode('54000', '8450');
        AssignGIFICode('54900', '8450');
        AssignGIFICode('59950', '8518');
        AssignGIFICode('59999', '8519');
        AssignGIFICode('65000', '8961');
        AssignGIFICode('65400', '8961');
        AssignGIFICode('65500', '9284');
        AssignGIFICode('65900', '9284');
        AssignGIFICode('64000', '9150');
        AssignGIFICode('64400', '9150');
        AssignGIFICode('61100', '8521');
        AssignGIFICode('61200', '8523');
        AssignGIFICode('61300', '9200');
        AssignGIFICode('61350', '9275');
        AssignGIFICode('63000', '9281');
        AssignGIFICode('63450', '1066');
        AssignGIFICode('63500', '9281');
        AssignGIFICode('67200', '8590');
        AssignGIFICode('67300', '8860');
        AssignGIFICode('67400', '9270');
        AssignGIFICode('69950', '9367');
        AssignGIFICode('69960', '9368');
        AssignGIFICode('69999', '9369');
        AssignGIFICode('62000', '9060');
        AssignGIFICode('62950', '9060');
        AssignGIFICode('66000', '8670');
        AssignGIFICode('66400', '8670');
        AssignGIFICode('48500', '8231');
        AssignGIFICode('67500', '9270');
        AssignGIFICode('68000', '8710');
        AssignGIFICode('68600', '8710');
        AssignGIFICode('84000', '9990');
        AssignGIFICode('85300', '9975');
        AssignGIFICode('84300', '9990');
        AssignGIFICode('85000', '9975');
        AssignGIFICode('99999', '9999');
        AssignGIFICode('18400', '1600');
        AssignGIFICode('18100', '1680');
        AssignGIFICode('18200', '1681');
        AssignGIFICode('17100', '1787');
        AssignGIFICode('17200', '1788');
        AssignGIFICode('16200', '1742');
        AssignGIFICode('16300', '1743');
        AssignGIFICode('14000', '1120');
        AssignGIFICode('14500', '1120');
        AssignGIFICode('13100', '1062');
        AssignGIFICode('13200', '1062');
        AssignGIFICode('13350', '1060');
        AssignGIFICode('13500', '1484');
        AssignGIFICode('13540', '1484');
        AssignGIFICode('12000', '1180');
        AssignGIFICode('12300', '1180');
        AssignGIFICode('11100', '1000');
        AssignGIFICode('11200', '1001');
        AssignGIFICode('11400', '1001');
        AssignGIFICode('11500', '1001');
        AssignGIFICode('11600', '1001');
        AssignGIFICode('11700', '1000');
        AssignGIFICode('30100', '3500');
        AssignGIFICode('30200', '3849');
        AssignGIFICode('30500', '3620');
        AssignGIFICode('25300', '3240');
        AssignGIFICode('21000', '3499');
        AssignGIFICode('25000', '3450');
        AssignGIFICode('25100', '3143');
        AssignGIFICode('25200', '3141');
        AssignGIFICode('25400', '3450');
        AssignGIFICode('22000', '3139');
        AssignGIFICode('22100', '2700');
        AssignGIFICode('22150', '2961');
        AssignGIFICode('22190', '2961');
        AssignGIFICode('22300', '2621');
        AssignGIFICode('22400', '2621');
        AssignGIFICode('22450', '2620');
        AssignGIFICode('22600', '2680');
        AssignGIFICode('22790', '2680');
        AssignGIFICode('23050', '2624');
        AssignGIFICode('23100', '2628');
        AssignGIFICode('23200', '2628');
        AssignGIFICode('23300', '2624');
        AssignGIFICode('24500', '3139');
        AssignGIFICode('25995', '3499');
        AssignGIFICode('39950', '3640');
    end;
