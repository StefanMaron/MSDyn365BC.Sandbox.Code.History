codeunit 101015 "Create G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('991220', XIncreasesduringtheYear, 0, 1, 0, '', 0, DomesticCode, MiscCode, '', '', true);
            InsertData('991230', XDecreasesduringtheYear, 0, 1, 0, '', 0, DomesticCode, MiscCode, '', '', true);
            InsertData('991240', XAccumDeprOperEquip, 0, 1, 0, '', 0, '', '', '', '', true);
            InsertData('991310', XVehicles, 0, 1, 0, '', 1, '', '', '', '', true);
            InsertData('991320', XIncreasesduringtheYear, 0, 1, 0, '', 0, DomesticCode, MiscCode, '', '', true);
            InsertData('991330', XDecreasesduringtheYear, 0, 1, 0, '', 0, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('996110', XSalesRetailDom, 0, 0, 0, '', 2, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('996210', XSalesRawMaterialsDom, 0, 0, 0, '', 2, DomesticCode, RawMatCode, '', '', true);
            ...
            InsertData('996410', XSalesResourcesDom, 0, 0, 0, '', 2, DomesticCode, ServicesCode, '', '', true);
            ...
            InsertData('997110', XPurchRetailDom, 0, 0, 0, '', 1, DomesticCode, RetailCode, '', '', true);
            ...
            InsertData('997210', XPurchRawMaterialsDom, 0, 0, 0, '', 1, DomesticCode, RawMatCode, '', '', true);
            ...
            InsertData('998640', XMiscellaneous, 0, 0, 1, '', 1, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('604000', XResourceUsageCosts, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('608000', XIncidentalCosts, 0, 0, 0, '', 1, DomesticCode, ServicesCode, '', '', true);
            InsertData('608200', XIncidentalCostsIntra, 0, 0, 0, '', 1, EUCode, MiscCode, '', '', true);
            InsertData('608900', XIncidentalCosts, 0, 0, 0, '', 1, ExportCode, MiscCode, '', '', true);
            InsertData('624100', XTransportsOnPurchases, 0, 0, 0, '', 1, DomesticCode, MiscCode, '', '', true);
            InsertData('624200', XTransportsOnSells, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            ...
            InsertData('708810', XSideActivitiesFranceGains, 0, 0, 0, '', 2, DomesticCode, MiscCode, '', '', true);
            InsertData('708820', XSideActivitiesIntraGains, 0, 0, 0, '', 2, EUCode, MiscCode, '', '', true);
            InsertData('708890', XSideActivitiesExportGains, 0, 0, 0, '', 2, ExportCode, MiscCode, '', '', true);
    ...
    var
        ...
        XIncidentalCostsFrance: Label 'Incidental Costs - France';
        ...
        XVendIntercompany: Label 'Vendors, Intercompany ';
        XCustIntercompany: Label 'Customers, Intercompany';
