codeunit 101080 "Create Gen. Journal Template"
{
    ...
    procedure InsertData(Name: Code[10]; Description: Text[80]; Type: Option; Recurring: Boolean; "Source Code": Code[10]; "No. Series": Code[10]; NoSeriesDescription: Text[30]; NoSeriesStartNo: Code[20]; NoSeriesEndNo: Code[20]; PostNoSeries: Code[20])
    var
