    ...
    begin
        with DemoDataSetup do begin
            ...
            if ("Data Type" = "Data Type"::Evaluation) or ("Data Type" = "Data Type"::Standard) then begin
                ...
                InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
                InsertData('161', StrSubstNo(XValueofOverseasSalesTxt, GoodsVATText, ''), 1, '', 2, ExportCode, GoodsVATCode, '', 2, 0, false, 1, false);
                InsertData('170', StrSubstNo(XValueofOverseasSalesTxt, GoodsVATText, XTotalTxt), 2, '', 0, '', '', '161..169', 0, 0, true, 1, false);
                InsertData(
                  '171', StrSubstNo(XValueofOverseasSalesTxt, ServicesVATText, ''), 1, '', 2, ExportCode, ServicesVATCode, '', 2, 0, false, 1, false);
                InsertData(
                ...
                InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
                InsertData(
                  '261', StrSubstNo(XValueofOverseasPurchasesTxt, GoodsVATText, ''), 1, '', 1, ExportCode, GoodsVATCode, '', 2, 0, false, 0, false);
                InsertData(
                  '270', StrSubstNo(XValueofOverseasPurchasesTxt, GoodsVATText, XTotalTxt), 2, '', 0, '', '', '261..269', 0, 0, true, 0, false);
                InsertData(
                  '271', StrSubstNo(XValueofOverseasPurchasesTxt, ServicesVATText, ''), 1, '', 1, ExportCode, ServicesVATCode, '', 2, 0, false, 0, false);
                InsertData(
