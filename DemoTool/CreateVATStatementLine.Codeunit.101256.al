codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData2('', '10', XAmtSalesVAT16PERCENToutgoing, 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B010', XBaseSalesVAT16PERCENToutgoing, 1, '', 2, DomesticCode, GoodsVATCode, '', 2, 0, false, 1, false, false);
            ...
            InsertData2('', '20', XAmtSalesVAT7PERCENToutgoing, 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B020', XBaseSalesVAT7PERCENToutgoing, 1, '', 2, DomesticCode, ServicesVATCode, '', 2, 0, false, 1, false, false);
            ...
            InsertData2('', '30', XAmtVAT16PERCENTonEUPurchsetc, 1, '', 1, EUCode, GoodsVATCode, '', 1, 1, false, 1, false, false);
            InsertData2('', 'B030', XBaseVAT16PERCENTonEUPurchsetc, 1, '', 1, EUCode, GoodsVATCode, '', 2, 1, false, 1, false, false);
            ...
            InsertData2('', '40', XAmtVAT7PERCENTonEUPurchsetc, 1, '', 1, EUCode, ServicesVATCode, '', 1, 1, false, 1, false, false);
            InsertData2('', 'B040', XBaseVAT7PERCENTonEUPurchsetc, 1, '', 1, EUCode, ServicesVATCode, '', 2, 1, false, 1, false, false);
            ...
            InsertData2('', '', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, false);
            InsertData2('', '110', XAmountPurchaseVAT16PERCENT, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B110', XBasePurchaseVAT16PERCENT, 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, false, 0, false, false);
            ...
            InsertData2('', '120', XAmountPurchaseVAT7PERCENT, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B120', XBasePurchaseVAT7PERCENT, 1, '', 1, DomesticCode, ServicesVATCode, '', 2, 0, false, 0, false, false);
            ...
            InsertData2('', '131', XBasePurchaseVAT7PERCENTEU, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B131', XBasePurchaseVAT16PERCENTEU, 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, false, 0, false, false);
            ...
            InsertData2('', '140', XAmountPurchaseVAT7PERCENTEU, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, false, 1, false, false);
            InsertData2('', 'B140', XBasePurchaseVAT7PERCENTEU, 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, false, 0, false, false);
            ...
            InsertData2('', '', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, false);
            InsertData2('', '', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, false);
            InsertData2('', '230', StrSubstNo(XValueofEUSalesPERCENT, GoodsVATText), 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, false, 1, false, false);
            InsertData2('', '240', StrSubstNo(XValueofEUSalesPERCENT, ServicesVATText), 1, '', 2,
              EUCode, ServicesVATCode, '', 2, 0, false, 1, false, false);
            InsertData2('35', '250', XValueofEUSales, 2, '', 0, '', '', '230|240', 0, 0, true, 1, false, false);
            InsertData2('', '310', XNonVATliablesalesOverseas, 1, '', 2, ExportCode, GoodsVATCode, '', 2, 0, false, 0, false, false);
            InsertData2('', '311', XNonVATliablesalesOverseas, 1, '', 2, ExportCode, ServicesVATCode, '', 2, 0, false, 0, false, false);
            InsertData2('36', '319', XNonVATliablesalesOverseas, 2, '', 0, '', '', '310|311', 0, 0, true, 1, false, false);
            InsertData2('', '320', XNonVATliablesalesDomestic, 1, '', 2, DomesticCode, NoVATCode, '', 2, 0, false, 0, false, false);
            InsertData2('37', '329', XNonVATliablesalesDomestic, 2, '', 0, '', '', '320..328', 0, 0, true, 1, false, false);

            // FES (320)
            InsertData2('', '10', XAmtSalesVAT16PERCENToutgoing, 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B010', XBaseSalesVAT16PERCENToutgoing, 1, '', 2, DomesticCode, GoodsVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '20', XAmtSalesVAT7PERCENToutgoing, 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B020', XBaseSalesVAT7PERCENToutgoing, 1, '', 2, DomesticCode, ServicesVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '30', XAmtSalesVAT4PERCENToutgoing, 1, '', 2, DomesticCode, ReducedVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B030', XBaseSalesVAT4PERCENToutgoing, 1, '', 2, DomesticCode, ReducedVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '40', XAmtVAT16PERCENTonEUSalesetc, 1, '', 2, EUCode, GoodsVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B040', XBaseVAT16PERCENTonEUSalesetc, 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '50', XAmtVAT7PERCENTonEUSalesetc, 1, '', 2, EUCode, ServicesVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B050', XBaseVAT7PERCENTonEUSalesetc, 1, '', 2, EUCode, ServicesVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '60', XAmtVAT4PERCENTonEUSalesetc, 1, '', 2, EUCode, ReducedVATCode, '', 1, 0, false, 1, false, true);
            InsertData2('', 'B060', XBaseVAT4PERCENTonEUSalesetc, 1, '', 2, EUCode, ReducedVATCode, '', 2, 0, false, 1, false, true);
            ...
            InsertData2('', '', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, true);
            InsertData2('', '110', XAmountPurchaseVAT16PERCENT, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B110', XBasePurchaseVAT16PERCENT, 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '120', XAmountPurchaseVAT7PERCENT, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B120', XBasePurchaseVAT7PERCENT, 1, '', 1, DomesticCode, ServicesVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '130', XAmountPurchaseVAT4PERCENT, 1, '', 1, DomesticCode, ReducedVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B130', XBasePurchaseVAT4PERCENT, 1, '', 1, DomesticCode, ReducedVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, true);
            InsertData2('', '140', XAmountPurchaseVAT16PERCENTEU, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B140', XBasePurchaseVAT16PERCENTEU, 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '150', XAmountPurchaseVAT7PERCENTEU, 2, '', 1, EUCode, ServicesVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B150', XBasePurchaseVAT7PERCENTEU, 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '160', XAmountPurchaseVAT4PERCENTEU, 1, '', 1, EUCode, ReducedVATCode, '', 1, 0, false, 0, false, true);
            InsertData2('', 'B160', XBasePurchaseVAT4PERCENTEU, 1, '', 1, EUCode, ReducedVATCode, '', 2, 0, false, 0, false, true);
            ...
            InsertData2('', '', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, true);
            InsertData2('', '', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, true);
            InsertData2('', '230', StrSubstNo(XValueofEUSalesPERCENT, GoodsVATText), 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '240', StrSubstNo(XValueofEUSalesPERCENT, ServicesVATText), 1, '', 2,
              EUCode, ServicesVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '250', StrSubstNo(XValueofEUSalesPERCENT, ReducedVATText), 1, '', 2, EUCode, ReducedVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '260', XTotalValueofEUSales, 2, '', 0, '', '', '230|240|250', 0, 0, true, 1, false, true);
            InsertData2('', '310', XNonVATliablesalesOverseas16, 1, '', 2, ExportCode, GoodsVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '311', XNonVATliablesalesOverseas7, 1, '', 2, ExportCode, ServicesVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '312', XNonVATliablesalesOverseas4, 1, '', 2, ExportCode, ReducedVATCode, '', 2, 0, false, 1, false, true);
            InsertData2('', '319', XTNonVATliablesalesOverseas, 2, '', 0, '', '', '310|311|312', 0, 0, true, 1, false, true);
            InsertData2('', '320', XNonVATliablesalesDomestic, 1, '', 2, DomesticCode, NoVATCode, '', 2, 0, false, 1, false, true);
    ...
    var
        ...
        XTBaseVAT7PERCENTonEUPurcsetc: Label 'Total Base VAT 7 % on EU Purchases etc.';
        ...
        XBaseAVAT7PERCENTonEUSalesetc: Label 'Base Amount VAT 7 % on EU Sales etc.';
        XBaseAVAT4PERCENTonEUSalesetc: Label 'Base Amount VAT 4 % on EU Sales etc.';
