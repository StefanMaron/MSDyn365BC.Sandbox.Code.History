codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData2('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData2('1010', XSalesBase20PERCNational, 1, '', 2, DomesticCode, GoodsVATCode, '', 2, 0, true, 0, false);
            InsertData2('1020', XSalesBase10PERCNational, 1, '', 2, DomesticCode, ServicesVATCode, '', 2, 0, true, 0, false);
            ...
            InsertData2('1030', XSalesBase20PERCEU, 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, true, 0, false);
            InsertData2('1040', XSalesBase10PERCEU, 1, '', 2, EUCode, ServicesVATCode, '', 2, 0, true, 0, false);
            ...
            InsertData2('1110', XPurchaseBase20PERCNational, 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, true, 0, false);
            InsertData2('1120', XPurchaseBase10PERCNational, 1, '', 1, DomesticCode, ServicesVATCode, '', 2, 0, true, 0, false);
            InsertData2('1125', XPurchaseBase2050PERCNondeduct, 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, true, 0, false);
            InsertData2('1199', XPassiveOperationsVP3, 2, '', 0, '', '', '1110..1125', 0, 0, true, 0, false);
            InsertData2('1200', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData2('1210', XPurchaseBase20PERCEU, 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, true, 0, false);
            InsertData2('1220', XPurchaseBase10PERCEU, 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, true, 0, false);
            InsertData2('1290', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData2('1299', XReverseChargePurchaseVP4, 2, '', 0, '', '', '1210..1220', 0, 0, true, 0, false);
            InsertData2('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData2('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData2('5010', XSalesVAT20PERCNational, 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData2('5020', XSalesVAT10PERCNational, 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false);
            InsertData2('5030', XSalesVATfromEUPurchase20PERC, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData2('5040', XSalesVATfromEUPurchase10PERC, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, true, 0, false);
            ...
            InsertData2('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData2('5110', XPurchaseVAT20PERCNational, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData2('5120', XPurchaseVAT10PERCNational, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false);
            InsertData2('5130', XPurchaseVAT20PERCEU, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData2('5140', XPurchaseVAT10PERCEU, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, true, 0, false);
            InsertData2('5150', XPurchaseVAT2050PERCNondeduct, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false);
            ...
            InsertData3('5010', XSalesVAT20PERCNational, 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData3('5020', XSalesVAT10PERCNational, 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false);
            InsertData3('5030', XSalesVATfromEUPurchase20PERC, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData3('5040', XSalesVATfromEUPurchase10PERC, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, true, 0, false);
            ...
            InsertData3('5110', XPurchaseVAT20PERCNational, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData3('5120', XPurchaseVAT10PERCNational, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false);
            InsertData3('5130', XPurchaseVAT20PERCEU, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, true, 0, false);
            InsertData3('5140', XPurchaseVAT10PERCEU, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, true, 0, false);
            ...
            InsertData4('1', XVATSales20, 1, 2, DomesticCode, GoodsVATCode, 2, '', 1, 0, true);
            InsertData4('2', XVATSales10, 1, 2, DomesticCode, ServicesVATCode, 2, '', 1, 0, true);
            ...
            InsertData4('5', "XSales ExemptArt13", 1, 2, DomesticCode, XE13, 2, '', 1, 0, true);
            InsertData4('6', XSalesNoVAT, 1, 2, DomesticCode, NoVATCode, 2, '', 1, 0, true);
            InsertData4('CD1.3', XTotalExemptSales, 2, 0, '', '', 0, '5|6', 0, 3, true);
            InsertData4('7', XVAT20IntracomGoodSales, 1, 2, EUCode, GoodsVATCode, 2, '', 1, 0, true);
            InsertData4('8', XVAT10IntracomGoodSales, 1, 2, EUCode, ServicesVATCode, 2, '', 1, 0, true);
            InsertData4('CD1.3', XTotalEUSales, 2, 0, '', '', 0, '7|8', 0, 4, true);
            InsertData4('', '', 3, 0, '', '', 0, '', 0, 0, true);
            InsertData4('', XPurchase, 3, 0, '', '', 0, '', 0, 0, true);
            InsertData4('', '', 3, 0, '', '', 0, '', 0, 0, true);
            InsertData4('9', XVATPurchases20, 1, 1, DomesticCode, GoodsVATCode, 2, '', 1, 0, true);
            InsertData4('10', XVATPurchases10, 1, 1, DomesticCode, ServicesVATCode, 2, '', 1, 0, true);
            ...
            InsertData4('13', XPurchasesExemptArt13, 1, 1, DomesticCode, XE13, 2, '', 1, 0, true);
            InsertData4('14', XPurchasesNonVAT, 1, 1, DomesticCode, NoVATCode, 2, '', 1, 0, true);
            InsertData4('CD2.3', XTotalExemptPurchases, 2, 0, '', '', 0, '13|14', 0, 7, true);
            InsertData4('15', XVAT20IntracomGoodPurchases, 1, 1, EUCode, GoodsVATCode, 2, '', 1, 0, true);
            InsertData4('16', XVAT10IntracomGoodPurchases, 1, 1, EUCode, ServicesVATCode, 2, '', 1, 0, true);
