codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('1010', StrSubstNo(XSalesVATPERCENToutgoing, GoodsVATText), 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, false, 1, false);
            InsertData('1019', StrSubstNo(XSalesVATPERCENToutgoing, GoodsVATText), 2, '', 0, '', '', '1010..1018', 0, 0, true, 1, false);
            InsertData('1030', StrSubstNo(XVATPERCENTonEUPurchasesetc, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 1, 1, false, 1, false);
            InsertData('1031', XVAT25PERCENTonForeignPurchasesTxt, 1, '', 1, ExportCode, GoodsVATCode, '', 1, 1, false, 0, false);
            InsertData('1039', XVAT25PERCENTonForeignPurchasesTotalingTxt, 2, '', 0, '', '', '1030..1038', 0, 0, true, 1, false);
            InsertData('1040', XServicePurchaseVAT25EUTxt, 1, '', 1, EUCode, ServicesVATCode, '', 1, 1, false, 0, false);
            InsertData('1041', XServicePurchaseVAT25ForeignTxt, 1, '', 1, ExportCode, ServicesVATCode, '', 1, 1, false, 0, false);
            ...
            InsertData('1110', StrSubstNo(XPurchaseVATPERCENTDomestic, GoodsVATText), 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, false, 0, false);
            InsertData('1130', StrSubstNo(XPurchaseVATPERCENTEU, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, false, 0, false);
            InsertData('1131', XVAT25PERCENTonForeignPurchases2Txt, 1, '', 1, ExportCode, GoodsVATCode, '', 1, 0, false, 0, false);
            InsertData('1140', XServicePurchaseVAT25EU2Txt, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, false, 0, false);
            InsertData('1141', XServicePurchaseVAT25Foreign2Txt, 1, '', 1, ExportCode, ServicesVATCode, '', 1, 0, false, 0, false);
            ...
            InsertData('1210', StrSubstNo(XValueofEUPurchasesPERCENT, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, false, 0, false);
            InsertData('1219', StrSubstNo(XValueofEUPurchasesPERCENT, GoodsVATText), 2, '', 0, '', '', '1210..1218', 0, 0, true, 0, false);
            InsertData('1220', XValueServicePurchaseVAT25EUTxt, 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, false, 0, false);
            InsertData('1229', XValueServicePurchaseVAT25EUTxt, 2, '', 0, '', '', '1220..1228', 0, 0, true, 0, false);
            InsertData('1230', XValueOfEUSalesNoVATTxt, 1, '', 2, EUCode, NoVATCode, '', 2, 0, false, 0, false);
            ...
            InsertData('1310', XNonVATliablesalesExportTxt, 1, '', 2, ExportCode, NoVATCode, '', 2, 0, false, 0, false);
            InsertData('1319', XNonVATliablesalesExportTxt, 2, '', 0, '', '', '1310..1318', 0, 0, true, 1, false);
            InsertData('1320', XNonVATliablesalesDenmarkTxt, 1, '', 2, DomesticCode, NoVATCode, '', 2, 0, false, 0, false);
