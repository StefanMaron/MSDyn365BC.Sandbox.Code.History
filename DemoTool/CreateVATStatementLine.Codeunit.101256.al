codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(
              '1010', StrSubstNo(XSalesVATPERCENToutgoing, GoodsVATText), 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, false, 1, false, '5');
            InsertData(
              '1020', StrSubstNo(XSalesVATPERCENToutgoing, ServicesVATText), 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, false, 1, false, '6');
            InsertData(
              '1050', StrSubstNo(XVATPERCENTonEUPurchasesetc, GoodsVATText), 1, '', 1, MiscCode, GoodsVATCode, '', 1, 1, false, 1, false, '7');
            InsertData(
              '1060', StrSubstNo(XVATPERCENTonEUPurchasesetc, ServicesVATText), 1, '', 1, MiscCode, ServicesVATCode, '', 1, 1, false, 1, false, '8');
            InsertData('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData('1099', XTotal, 2, '', 0, '', '', '1019|1029|1039|1049', 0, 0, true, 1, false, '');
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData(
              '1110', StrSubstNo(XPurchaseVATPERCENTDomestic, GoodsVATText), 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, false, 0, false, '9');
            InsertData(
              '1120',
              StrSubstNo(XPurchaseVATPERCENTDomestic, ServicesVATText), 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, false, 0, false, '10');
            InsertData(
              '1150', StrSubstNo(XPurchaseVATPERCENTEU, GoodsVATText), 1, '', 1, MiscCode, GoodsVATCode, '', 1, 0, false, 0, false, '11');
            InsertData(
              '1160', StrSubstNo(XPurchaseVATPERCENTEU, ServicesVATText), 1, '', 1, MiscCode, ServicesVATCode, '', 1, 0, false, 0, false, '12');
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData(
              '1210', StrSubstNo(XValueofEUPurchasesPERCENT, GoodsVATText), 1, '', 1, MiscCode, GoodsVATCode, '', 2, 0, false, 0, false, '');
            InsertData(
              '1220', StrSubstNo(XValueofEUPurchasesPERCENT, ServicesVATText), 1, '', 1, MiscCode, ServicesVATCode, '', 2, 0, false, 0, false, '');
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData(
              '1240', StrSubstNo(XValueofEUSalesPERCENT, GoodsVATText), 1, '', 2, MiscCode, GoodsVATCode, '', 2, 0, false, 1, false, '');
            InsertData(
              '1250', StrSubstNo(XValueofEUSalesPERCENT, ServicesVATText), 1, '', 2, MiscCode, ServicesVATCode, '', 2, 0, false, 1, false, '');
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
