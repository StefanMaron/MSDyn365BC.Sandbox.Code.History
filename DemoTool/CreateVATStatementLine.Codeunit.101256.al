    ...
    begin
        with DemoDataSetup do begin
            ...
            if ("Data Type" = "Data Type"::Evaluation) or ("Data Type" = "Data Type"::Standard) then begin
                ...
                InsertData('211', StrSubstNo(XValueofDomesticPurchasesTxt, ServicesVATText, ''), 1, '', 1, DomesticCode, ServicesVATCode,
                  '', 2, 0, false, 0, false);
                InsertData(
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', '==================================================', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('011', StrSubstNo(XSales, GoodsVATText), 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 1, false, 0, false);
            InsertData(
              '012', StrSubstNo(XSales, StrSubstNo('%1 %2', GoodsVATText, XFULL)), 1, '', 2, DomesticCode,
              FullGoodsVATCode, '', 1, 1, false, 0, false);
            InsertData(
              '020', StrSubstNo(XSales, StrSubstNo('%1 %2', GoodsVATText, XTotal2)), 2, '', 0, '', '', '011..019', 0, 0, true, 0, false);
            InsertData('021', StrSubstNo(XSales, ServicesVATText), 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 1, false, 0, false);
            InsertData(
              '022', StrSubstNo(XSales, StrSubstNo('%1 %2', ServicesVATText, XFULL)), 1, '', 2, DomesticCode,
              FullServicesVATCode, '', 1, 1, false, 0, false);
            InsertData(
              '030', StrSubstNo(XSales, StrSubstNo('%1 %2', ServicesVATText, XTotal2)), 2, '', 0, '', '', '021..029', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('031', StrSubstNo(XonEUAcquisitionsetc, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 1, 1, false, 1, false);
            InsertData('040', StrSubstNo(XonEUAcquisitionsetctotal, GoodsVATText), 2, '', 0, '', '', '031..039', 0, 0, true, 1, false);
            InsertData('041', StrSubstNo(XonEUAcquisitionsetc, ServicesVATText), 1, '', 1, EUCode, ServicesVATCode, '', 1, 1, false, 1, false);
            InsertData('050', StrSubstNo(XonEUAcquisitionsetctotal, ServicesVATText), 2, '', 0, '', '', '041..049', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData(
              '061', StrSubstNo(XPurchaseVATPERCENTDomestic, GoodsVATText), 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 1, false, 1, false);
            InsertData('062', StrSubstNo(XPurchaseVATPERCENTDomestic, StrSubstNo('%1 %2', GoodsVATText, XFULL)), 1, '', 1, DomesticCode,
              FullGoodsVATCode, '', 1, 1, false, 1, false);
            InsertData('070', StrSubstNo(XPurchaseVATPERCENTDomesticTot, GoodsVATText), 2, '', 0, '', '', '061..069', 0, 0, true, 1, false);
            InsertData(
              '071', StrSubstNo(XPurchaseVATPERCENTDomestic, ServicesVATText), 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 1, false, 1, false);
            InsertData(
              '072', StrSubstNo(XPurchaseVATPERCENTDomesticFUL, ServicesVATText), 1, '', 1, DomesticCode,
              FullServicesVATCode, '', 1, 1, false, 1, false);
            InsertData('080', StrSubstNo(XPurchaseVATPERCENTDomesticTot, ServicesVATText), 2, '', 0, '', '', '071..079', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('081', StrSubstNo(XonEUAcquisitionsetc, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, false, 1, false);
            InsertData('090', StrSubstNo(XonEUAcquisitionsetctotal, GoodsVATText), 2, '', 0, '', '', '081..089', 0, 0, false, 1, false);
            InsertData('091', StrSubstNo(XonEUAcquisitionsetc, ServicesVATText), 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, false, 1, false);
            InsertData('100', StrSubstNo(XonEUAcquisitionsetctotal, ServicesVATText), 2, '', 0, '', '', '091..099', 0, 0, false, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('101', StrSubstNo(XValueofDomesticSales, GoodsVATText), 1, '', 2, DomesticCode, GoodsVATCode, '', 2, 0, false, 1, false);
            InsertData('110', StrSubstNo(XValueofDomesticSalesTotal, GoodsVATText), 2, '', 0, '', '', '101..109', 0, 0, true, 1, false);
            InsertData(
              '111', StrSubstNo(XValueofDomesticSales, ServicesVATText), 1, '', 2, DomesticCode, ServicesVATCode, '', 2, 0, false, 1, false);
            InsertData('120', StrSubstNo(XValueofDomesticSalesTotal, ServicesVATText), 2, '', 0, '', '', '111..119', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('131', StrSubstNo(XValueofEUSupplies, GoodsVATText), 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, false, 1, false);
            InsertData('140', StrSubstNo(XValueofEUSuppliesTotal, GoodsVATText), 2, '', 0, '', '', '131..139', 0, 0, true, 1, false);
            InsertData('141', StrSubstNo(XValueofEUSupplies, ServicesVATText), 1, '', 2, EUCode, ServicesVATCode, '', 2, 0, false, 1, false);
            InsertData('150', StrSubstNo(XValueofEUSuppliesTotal, ServicesVATText), 2, '', 0, '', '', '141..149', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('161', StrSubstNo(XValueofOverseasSales, GoodsVATText), 1, '', 2, ExportCode, GoodsVATCode, '', 2, 0, false, 1, false);
            InsertData('170', StrSubstNo(XValueofOverseasSalesTotal, GoodsVATText), 2, '', 0, '', '', '161..169', 0, 0, true, 1, false);
            InsertData('171', StrSubstNo(XValueofOverseasSales, ServicesVATText), 1, '', 2, ExportCode, ServicesVATCode, '', 2, 0, false, 1, false);
            InsertData('180', StrSubstNo(XValueofOverseasSalesTotal, ServicesVATText), 2, '', 0, '', '', '171..179', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('190', XValueofnonVATliablesales, 1, '', 2, DomesticCode, NoVATCode, '', 2, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('201', StrSubstNo(XValueofDomesticPurchases, GoodsVATText), 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, false, 0, false);
            InsertData('210', StrSubstNo(XValueofDomesticPurchasesTotal, GoodsVATText), 2, '', 0, '', '', '201..209', 0, 0, true, 0, false);
            InsertData(
              '211', StrSubstNo(XValueofDomesticPurchases, ServicesVATText), 1, '', 1, DomesticCode, ServicesVATCode, '', 2, 0, false, 0, false);
            InsertData('220', StrSubstNo(XValueofDomesticPurchasesTotal, ServicesVATText), 2, '', 0, '', '', '211..219', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('231', StrSubstNo(XValueofEUAcquisitions, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, false, 0, false);
            InsertData('240', StrSubstNo(XValueofEUAcquisitionsTotal, GoodsVATText), 2, '', 0, '', '', '231..239', 0, 0, true, 0, false);
            InsertData('241', StrSubstNo(XValueofEUAcquisitions, ServicesVATText), 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, false, 0, false);
            InsertData('250', StrSubstNo(XValueofEUAcquisitionsTotal, ServicesVATText), 2, '', 0, '', '', '241..249', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('261', StrSubstNo(XValueofOverseasPurchases, GoodsVATText), 1, '', 1, ExportCode, GoodsVATCode, '', 2, 0, false, 0, false);
            InsertData('270', StrSubstNo(XValueofOverseasPurchasesTotal, GoodsVATText), 2, '', 0, '', '', '261..269', 0, 0, true, 0, false);
            InsertData(
              '271', StrSubstNo(XValueofOverseasPurchases, ServicesVATText), 1, '', 1, ExportCode, ServicesVATCode, '', 2, 0, false, 0, false);
            InsertData('280', StrSubstNo(XValueofOverseasPurchasesTotal, ServicesVATText), 2, '', 0, '', '', '271..279', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('290', XValueofnonVATliablepurchases, 1, '', 1, DomesticCode, NoVATCode, '', 2, 0, true, 0, false);
            // GB End
        end;
    end;
