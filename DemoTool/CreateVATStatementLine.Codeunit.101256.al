codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('1180', XFuelTax, 0, MakeAdjustments.Convert('995710'), 0, '', '', '', 0, 0, true, 1, false);
            InsertData('1181', XElectricityTax, 0, MakeAdjustments.Convert('995720'), 0, '', '', '', 0, 0, true, 1, false);
            InsertData('1182', XNaturalGasTax, 0, MakeAdjustments.Convert('995730'), 0, '', '', '', 0, 0, true, 1, false);
            InsertData('1183', XCoalTax, 0, MakeAdjustments.Convert('995740'), 0, '', '', '', 0, 0, true, 1, false);
            InsertData('1184', XCO2Tax, 0, MakeAdjustments.Convert('995750'), 0, '', '', '', 0, 0, true, 1, false);
            InsertData('1185', XWaterTax, 0, MakeAdjustments.Convert('995760'), 0, '', '', '', 0, 0, true, 1, false);
            ...
            StatementName := XUNREAL;
            InsertData(
              '1010', StrSubstNo(XSalesVATPERCENToutgoing, GoodsVATText), 1, '', 2, DomesticCode, GoodsVATCode, '', 3, 0, false, 1, false);
            InsertData(
              '1019', StrSubstNo(XSalesVATPERCENToutgoing, GoodsVATText), 2, '', 0, '', '', '1010..1018', 0, 0, true, 1, false);
            InsertData(
              '1020', StrSubstNo(XSalesVATPERCENToutgoing, ServicesVATText), 1, '', 2, DomesticCode, ServicesVATCode, '', 3, 0, false, 1, false);
            InsertData(
              '1029', StrSubstNo(XSalesVATPERCENToutgoing, ServicesVATText), 2, '', 0, '', '', '1020..1028', 0, 0, true, 1, false);
            InsertData(
              '1030', StrSubstNo(XVATPERCENTonEUPurchasesetc, GoodsVATText), 1, '', 1, EUCode, GoodsVATCode, '', 1, 1, false, 1, false);
            InsertData(
              '1039', StrSubstNo(XVATPERCENTonEUPurchasesetc, GoodsVATText), 2, '', 0, '', '', '1030..1038', 0, 0, true, 1, false);
            InsertData(
              '1040', StrSubstNo(XVATPERCENTonEUPurchasesetc, ServicesVATText), 1, '', 1, EUCode, ServicesVATCode, '', 3, 1, false, 1, false);
            InsertData(
              '1049', StrSubstNo(XVATPERCENTonEUPurchasesetc, ServicesVATText), 2, '', 0, '', '', '1040..1048', 0, 0, true, 1, false);
            InsertData('', '--------------------------------------------------', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData(
              '1099', XTotal, 2, '', 0, '', '', '1019|1029|1039|1049', 0, 0, true, 1, false);
        end;
    end;
