codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('0022', xNormalVatRate, 1, '', 2, DomesticCode, XVATNormal, '', 2, 1, true, 0, false);
            InsertData('0026', xReducedVatRate, 1, '', 2, DomesticCode, xVATRed, '', 2, 1, true, 0, false);
            InsertData('0032', xExportNormalVatRate, 1, '', 2, ExportCode, XVATNormal, '', 2, 1, false, 0, false);
            InsertData('0036', xExportRedVatRate, 1, '', 2, ExportCode, xVATRed, '', 2, 1, false, 0, false);
            ...
            InsertData('0062', xExportNormalVatRate, 1, '', 2, ExportCode, XVATNormal, '', 2, 0, true, 0, false);
            InsertData('0064', xExportRedVatRate, 1, '', 2, ExportCode, xVATRed, '', 2, 0, true, 0, false);
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('0124', xNormalVatRate, 1, '', 2, DomesticCode, XVATNormal, '', 1, 0, true, 0, false);
            InsertData('0126', xReducedVatRate, 1, '', 2, DomesticCode, xVATRed, '', 1, 0, true, 0, false);
            InsertData('0199', xTotalVAT, 2, '', 0, '', '', '0101..0198', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('0200', xAccountablePurchaseVAT, 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('0222', xNormalVatRate, 1, '', 1, DomesticCode, XVATNormal, '', 1, 0, true, 0, false);
            InsertData('0224', xReducedVatRate, 1, '', 1, DomesticCode, xVATRed, '', 1, 0, true, 0, false);
            InsertData('0262', xImportNormalVatRate, 1, '', 1, ExportCode, XVATNormal, '', 1, 0, true, 0, false);
            InsertData('0264', xImportRedVatRate, 1, '', 1, ExportCode, xVATRed, '', 1, 0, true, 0, false);
            InsertData('0280', xFullImportTax, 1, '', 1, DomesticCode, xVATImport, '', 1, 0, true, 0, false);
            InsertData('0299', xTotalPurchMatServ, 2, '', 0, '', '', '0200..0298', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('0300', xInvesBusExp, 1, '', 1, DomesticCode, xVATOpexp, '', 1, 0, true, 0, false);
            InsertData('0310', xBusExpHalf, 1, '', 1, DomesticCode, xVATHalfNor, '', 1, 0, true, 0, false);
            InsertData('0320', xBusExpHotel, 1, '', 1, DomesticCode, XVATHOTEL, '', 1, 0, true, 0, false);
            ...
            InsertData('1230', xValueofEUExports, 1, '', 2, ExportCode, XVATNormal, '', 2, 0, false, 1, false);
            InsertData('', xValueofEUExports16, 2, '', 0, '', '', '1230..1238', 0, 0, true, 1, false);
            InsertData('1240', xValueofEUExports, 1, '', 2, ExportCode, XVATHOTEL, '', 2, 1, false, 1, false);
            InsertData('', xValueofEUExports7, 2, '', 0, '', '', '1240..1248', 0, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('1310', xCountryExport, 1, '', 2, ExportCode, XVATNormal, '', 2, 0, false, 0, false);
            InsertData('1312', xCountryExport, 1, '', 2, ExportCode, XVATHOTEL, '', 2, 1, false, 0, false);
            InsertData('', xCountryExport, 2, '', 0, '', '', '1310..1318', 0, 0, true, 1, false);
            InsertData('1320', xTaxFreeSalesDomestic, 1, '', 2, DomesticCode, NoVATCode, '', 2, 1, false, 0, false);
