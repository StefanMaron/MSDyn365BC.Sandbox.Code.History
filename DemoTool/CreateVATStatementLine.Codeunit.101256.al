codeunit 101256 "Create VAT Statement Line"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData('1A-1', XTaxedWith19PERCENTBaseAmount, 1, '', 2, DomesticCode, GoodsVATCode, '', 2, 0, true, 1, false, '1A-1');
            InsertData('1A-2', XTaxedWith19PERCENTTaxAmount, 1, '', 2, DomesticCode, GoodsVATCode, '', 1, 0, true, 1, false, '1A-2');
            InsertData('1B-1', XTaxedWith6PERCENTBaseAmount, 1, '', 2, DomesticCode, ServicesVATCode, '', 2, 0, true, 1, false, '1B-1');
            InsertData('1B-2', XTaxedWith6PERCENTTaxAmount, 1, '', 2, DomesticCode, ServicesVATCode, '', 1, 0, true, 1, false, '1B-2');
            InsertData('1E', '', 1, '', 2, DomesticCode, NoVATCode, '', 2, 0, true, 1, false, '1E');

            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData('', XPurchasesDomestic, 3, '', 0, '', '', '', 0, 0, true, 0, false, '');

            InsertData('2A-1', XTaxedWith19PERCENTBaseAmount, 1, '', 1, DomesticCode, GoodsVATCode, '', 2, 0, true, 1, false, '');
            InsertData('2A-1', XTaxedWith6PERCENTBaseAmount, 1, '', 1, DomesticCode, ServicesVATCode, '', 2, 0, true, 1, false, '');
            InsertData('', XPurchasesDomesticBaseAmount, 2, '', 0, '', '', '2A-1', 0, 0, true, 0, false, '2A-1');

            InsertData('2A-2', XTaxedWith19PERCENTTaxAmount, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, true, 1, false, '');
            InsertData('2A-2', XTaxedWith6PERCENTTaxAmount, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, true, 1, false, '');
            InsertData('', XPurchasesDomesticTaxAmount, 2, '', 0, '', '', '2A-2', 0, 0, true, 0, false, '2A-2');

            InsertData('', XSalesForeignNonEU, 3, '', 0, '', '', '', 0, 0, true, 1, false, '');
            InsertData('3A', XTaxedWith19PERCENTBaseAmount, 1, '', 2, ExportCode, GoodsVATCode, '', 2, 0, true, 1, false, '');
            InsertData('3A', XTaxedWith6PERCENTBaseAmount, 1, '', 2, ExportCode, ServicesVATCode, '', 2, 0, true, 1, false, '');
            ...
            InsertData('3B', XTaxedWith19PERCENTBaseAmount, 1, '', 2, EUCode, GoodsVATCode, '', 2, 0, true, 1, false, '');
            InsertData('3B', XTaxedWith6PERCENTBaseAmount, 1, '', 2, EUCode, ServicesVATCode, '', 2, 0, true, 1, false, '');
            InsertData('', XEUShipments, 2, '', 0, '', '', '3B', 0, 0, true, 1, false, '3B');

            InsertData('', '', 0, '', 0, '', '', '', 0, 0, true, 1, false, '');
            InsertData('', XPurchaseForeign, 0, '', 0, '', '', '', 0, 0, true, 1, false, '');

            InsertData('4A-1', XTaxedWith19PERCENTBaseAmount, 1, '', 1, ExportCode, GoodsVATCode, '', 2, 0, true, 1, false, '');
            InsertData('4A-1', XTaxedWith6PERCENTBaseAmount, 1, '', 1, ExportCode, ServicesVATCode, '', 2, 0, true, 1, false, '');
            InsertData('', XPurchasesForeignNonEUBaseAmount, 2, '', 0, '', '', '4A-1', 0, 0, true, 0, false, '4A-1');

            InsertData('4A-2', XTaxedWith19PERCENTTaxAmount, 1, '', 1, ExportCode, GoodsVATCode, '', 1, 0, true, 1, false, '');
            InsertData('4A-2', XTaxedWith6PERCENTTaxAmount, 1, '', 1, ExportCode, ServicesVATCode, '', 1, 0, true, 1, false, '');
            InsertData('', XPurchasesForeignNonEUTaxAmount, 2, '', 0, '', '', '4A-2', 0, 0, true, 0, false, '4A-2');

            InsertData('4B-1', XTaxedWith19PERCENTBaseAmount, 1, '', 1, EUCode, GoodsVATCode, '', 2, 0, true, 1, false, '');
            InsertData('4B-1', XTaxedWith6PERCENTBaseAmount, 1, '', 1, EUCode, ServicesVATCode, '', 2, 0, true, 1, false, '');
            InsertData('', XPurchasesForeingEUBaseAmount, 2, '', 0, '', '', '4B-1', 0, 0, true, 0, false, '4B-1');

            InsertData('4B-2', XTaxedWith19PERCENTTaxAmount, 1, '', 1, EUCode, GoodsVATCode, '', 1, 0, true, 1, false, '');
            InsertData('4B-2', XTaxedWith6PERCENTTaxAmount, 1, '', 1, EUCode, ServicesVATCode, '', 1, 0, true, 1, false, '');
            ...
            InsertData('', XPurchasesDomestic, 3, '', 0, '', '', '', 0, 0, true, 0, false, '');
            InsertData('5B', XTaxedWith19PERCENT, 1, '', 1, DomesticCode, GoodsVATCode, '', 1, 0, true, 0, false, '');
            InsertData('5B', XTaxedWith6PERCENT, 1, '', 1, DomesticCode, ServicesVATCode, '', 1, 0, true, 0, false, '');
