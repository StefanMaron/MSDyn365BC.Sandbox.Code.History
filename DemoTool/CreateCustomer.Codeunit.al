codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Andrea Ricci';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Elena Sabbatini';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Aldo Pisani';
        XxRIBA: Label 'RIBA';
        XxCENTER: Label 'CENTER';
    ...
    begin
        ...
        "Country Code" := CreatePostCode.GetCountryPrefix("Post Code");
        ...
        case (Counter - 1) mod 3 of
            ...
            2:
                begin
                    ...
                    Customer.Validate("Payment Method Code", XxRIBA);//IT
                end;
        end;
