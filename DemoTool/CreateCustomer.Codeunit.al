codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XEXW: Label 'EXW';
        X1M8D: Label '1M(8D)';
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Pedro Jaramillo';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Fatima Ruiz';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Tomas Madera';
    ...
    begin
        ...
        InsertData(
          '40000', XDeerfieldGraphicsCompany, X10DeerfieldRoad, CreatePostCode.Convert('GB-GL1 9HM'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('40000', XIanDeberry);
        InsertData(
          '50000', XGuildfordWaterDepartment, X25WaterWay, CreatePostCode.Convert('GB-GU7 5GT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
