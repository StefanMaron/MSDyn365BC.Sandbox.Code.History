codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XEXW: Label 'EXW';
        X1M8D: Label '1M(8D)';
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Anders Madsen';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Heidi Iversen';
        XMeaganBond: Label 'Meagan Bond', Comment = 'CELA approved translation: Elisabeth Lund';
    ...
    begin
        ...
        case Customer."No." of
            '10000':
                Customer.Validate(GLN, '5790000510146');
            '20000':
                Customer.Validate(GLN, '5790001398644');
        end;
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '10000', XTheCannonGroupPLC, X192MarketSquare, CreatePostCode.Convert('GB-B27 4KT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('10000', XRobertTownes);
        InsertData(
          '20000', XSelangorianLtd, X153ThomasDrive, CreatePostCode.Convert('GB-CV6 1GY'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('20000', XHelenRay);
        InsertData(
          '30000', XJohnHaddockInsuranceCo, X10HighTowerGreen, CreatePostCode.Convert('GB-MO2 4RT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('30000', XMeaganBond);
        InsertData(
          '40000', XDeerfieldGraphicsCompany, X10DeerfieldRoad, CreatePostCode.Convert('US-FL 37125'), '', '', '',
          'US', '', '', '', '', '');
        UpdateContact('40000', XIanDeberry);
        InsertData(
          '50000', XGuildfordWaterDepartment, X25WaterWay, CreatePostCode.Convert('GB-GU2 7YQ'), '', '', '',
          'GB', '', 'GB333333333', '', '', '');
