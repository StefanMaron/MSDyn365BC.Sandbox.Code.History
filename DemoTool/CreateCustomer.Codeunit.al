codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Andreas Ekeli';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Mari Bardsen';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Isak Kvam';
    ...
    begin
        ...
        Customer.Validate("Customer Posting Group", CreateCurrency.GetPostingGroup("Currency Code"));
        Customer.Validate("Gen. Bus. Posting Group", CreateCurrency.GetCustBusPostingGroup("Currency Code"));
