codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Daniel Almaraz';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Isabelina Castaneda';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Diego Echevarria';
        XGIRO: Label 'GIRO';
        XCHECK: Label 'CHECK';
        XBANK: Label 'BANK';
    ...
    begin
        ...
        Customer.County := CreatePostCode.FindCounty("Post Code");
        ...
        if Customer."No." <> '40000' then begin
            ...
            Customer."Preferred Bank Account Code" := XBEE;
        end;
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '', '582048936A', '', XSurrey, '');
