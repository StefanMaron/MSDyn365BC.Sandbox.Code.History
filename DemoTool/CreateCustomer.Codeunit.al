codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Jens Lind';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Kelly Hellstrom';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Sami Jakobsson';
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '', 'SE582048936701', '', XSurrey, '');
