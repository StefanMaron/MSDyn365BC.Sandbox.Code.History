codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Philippe Quenneville';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Lorie Leblanc';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Marcel Lacombe';
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '', 'FR58204893678', '', XSurrey, '');
