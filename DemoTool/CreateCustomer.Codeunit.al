codeunit 101018 "Create Customer"
{
    ...
    begin
        ...
        InsertData('32124578', 'Nieuwe Zandpoort NV', 'Nieuwstraat 28', 'BE-2200', '', 'Kevin Verboort', 'EUR', 'BE',
          XYELLOW, '0999000030', '', '', '');
        InsertData('32656565', 'Antarcticopy', 'Katwilgweg 274', 'BE-2050', '', 'Michael Zeman', 'EUR', 'BE', XYELLOW, '0998000039', '', '', '');
        InsertData('32789456', 'Lovaina Contractors', 'Vuurberg 137', 'BE-3000', '', 'Hans Visser', 'EUR', 'BE', XYELLOW, '0997000048', '', '', '');
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Stewart Witherell';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Karen Snow';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Jimme Veenhuizen';
    ...
    begin
        ...
        if "Country Code" = DemoDataSetup."Country/Region Code" then
            Customer.Validate("Enterprise No.", "VAT Registration No.")
        else
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", '', '0992000093', '', XSurrey, '');
