codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Anthony Lording';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Mary Kumm';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Mason Kingsley';
        X52004004612: Label '52004004612';
        X30DAYS: Label '30 DAYS';
        X20028478: Label '20028478';
        X52004005616: Label '52004005616';
        X20104226: Label '20104226';
    ...
    begin
        ...
        Customer."Tax Document Type" := Customer."Tax Document Type"::"Document Post";
        ...
        case Customer."No." of
            '10000':
                begin
                    Customer.Validate(ABN, X52004004612);
                    Customer.Registered := true;
                    Customer.Validate("Payment Terms Code", X30DAYS);
                    AddressID."Table No." := DATABASE::Customer;
                    AddressID."Table Key" := Customer.GetPosition();
                    AddressID."Address Type" := AddressID."Address Type"::Main;
                    AddressID.Validate("Address ID", X20028478);
                    AddressID."Bar Code System" := AddressID."Bar Code System"::"4-State Bar Code";
                    AddressID.Insert();
                end;
            '20000':
                begin
                    Customer.Validate(ABN, X52004005616);
                    Customer.Registered := true;
                    Customer.Validate("Payment Terms Code", X30DAYS);
                end;
            '30000':
            ...
            '50000':
                begin
                    ...
                    AddressID."Table Key" := Customer.GetPosition();
                    AddressID."Address Type" := AddressID."Address Type"::Main;
                    AddressID.Validate("Address ID", X20104226);
                    AddressID."Bar Code System" := AddressID."Bar Code System"::"4-State Bar Code";
                    AddressID.Insert();
                end;
        end;
