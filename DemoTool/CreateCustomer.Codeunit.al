codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        X192MarketSquare: Label '360 Main Street, Suite 1150';
        XMr: Label 'Mr.';
        ...
        case DemoDataSetup."Data Type" of
            ...
            DemoDataSetup."Data Type"::Evaluation:
                begin
                    ...
                    case (Counter - 1) mod 3 of
                        0:
                            Customer.Validate("Global Dimension 2 Code", XSMALL);
                        1:
                            Customer.Validate("Global Dimension 2 Code", XMEDIUM);
                        2:
                            Customer.Validate("Global Dimension 2 Code", XLARGE);
                    end;
                    Customer.Modify();
                end;
        end;
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '10000', 'Adatum Corporation', X192MarketSquare, CreatePostCode.Convert('GB-B27 4KT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('10000', XRobertTownes);
        InsertData(
          '20000', 'Trey Research', X153ThomasDrive, CreatePostCode.Convert('GB-CV6 1GY'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('20000', XHelenRay);
        InsertData(
          '30000', 'School of Fine Art', X10HighTowerGreen, CreatePostCode.Convert('GB-MO2 4RT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('30000', XMeaganBond);
        InsertData(
          '40000', 'Alpine Ski House', X10DeerfieldRoad, CreatePostCode.Convert('GB-GL1 9HM'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
        UpdateContact('40000', XIanDeberry);
        InsertData(
          '50000', 'Relecloud', X25WaterWay, CreatePostCode.Convert('GB-GU7 5GT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '', '', '', '');
