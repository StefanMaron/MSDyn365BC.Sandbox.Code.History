codeunit 101018 "Create Customer"
{
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Jakob Otto';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Brigitte Werner';
        XMeaganBond: Label 'Meagan Bond';
        XIanDeberry: Label 'Ian Deberry';
        XJesseHomer: Label 'Jesse Homer', Comment = 'CELA approved translation: Izaak Schroder';
        XW1: Label 'W';
        XN1: Label 'N';
        XS1: Label 'S';
        XMID3: Label 'MID';
    ...
    begin
        ...
        InsertData(
          '40000', XAlpineSkiHouse, X5WalterGropiusStrasse, CreatePostCode.Convert('GB-B68 5TT'), '', '', '',
          'GB', '', '609458790', '', XParkStadtSchwabing, '');
        UpdateContact('40000', XIanDeberry);
        InsertData(
          '50000', XRelecloud, X1OccamCourt, CreatePostCode.Convert('GB-GU7 5GT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', '582048936', '', XSurrey, '');
