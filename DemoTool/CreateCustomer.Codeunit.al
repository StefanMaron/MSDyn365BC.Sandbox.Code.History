codeunit 101018 "Create Customer"
{
    ...
    begin
        ...
        InsertData(
          '46897889', 'Englunds Kontorsmöbler AB', 'Kungsgatan 18', 'SE-600 03', '', '', 'SEK', 'SE', XYELLOW, '777777777701', '', '', '');
        ...
        InsertData('49525252', 'Beef House', 'Südermarkt 6', 'DE-40593', 'Frau', 'Karin Fleischer', 'EUR', 'DE', XGREEN, '632541794', XW1, '', '');
        InsertData('49633663', 'Autohaus Mielberg KG', 'Porschestraße 911', 'DE-22417', '', '', 'EUR', 'DE', XGREEN, '525252141', XN1, '', '');
        InsertData('49858585', 'Hotel Pferdesee', 'Plett Straße 187', 'DE-60320', 'Herrn', 'Jonathan Haas', 'EUR', 'DE',
          XGREEN, '963963963', XMID3, '', '');
        InsertData(
          '44180220', 'Afrifield Corporation', '100 Maidstone Ave.', 'GB-ME5 6RL', 'Mrs.', 'Ariane Peeters', 'GBP', 'GB',
          XBLUE, '609458790', XFOREIGN1, '', '');
        InsertData(
          '44171511', 'Zuni Home Crafts Ltd.', '456 Main Street', 'GB-DY5 4DJ', 'Mr.', 'James R. Hamilton', 'GBP', 'GB', XBLUE, '879132357',
          XFOREIGN1, '', '');
        InsertData(
          '44756404', 'London Light Company', '235 Peachtree Street', 'GB-PE17 4RN', 'Mr.', 'Mathew Charles', 'GBP', 'GB', XBLUE, '748863386',
          XFOREIGN1, '', '');
        InsertData(
    ...
    var
        ...
        XRobertTownes: Label 'Robert Townes', Comment = 'CELA approved translation: Robert Egger';
        XHelenRay: Label 'Helen Ray', Comment = 'CELA approved translation: Leonie Fischer';
        ...
        XS1: Label 'S';
        XMID3: Label 'MID';
        XFOREIGN1: Label 'FOREIGN';
        XAT: Label 'AT';
        XATU78945627: Label 'ATU78945627';
        XATU25468745: Label 'ATU25468745';
        XATU53343578: Label 'ATU53343578';
        XATU73349578: Label 'ATU73349578';
        XATU58204893: Label 'ATU58204893';
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '10000', XAdatumCorporation, X21StationRoad, CreatePostCode.Convert('GB-B27 4KT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', 'XATU78945627', '', '', '');
        UpdateContact('10000', XRobertTownes);
        InsertData(
          '20000', XTreyResearch, "X91-95SouthwarkBridgeRd", CreatePostCode.Convert('GB-CV6 1GY'), '', '', '',
          DemoDataSetup."Country/Region Code", '', 'XATU25468745', '', '', '');
        ...
        InsertData(
          ...
          'DE', '', '533435789', '', XParkStadtSchwabing, '');
        UpdateContact('40000', XIanDeberry);
        InsertData(
          '50000', XRelecloud, X1OccamCourt, CreatePostCode.Convert('GB-GU7 5GT'), '', '', '',
          DemoDataSetup."Country/Region Code", '', 'XATU58204893', '', XSurrey, '');
