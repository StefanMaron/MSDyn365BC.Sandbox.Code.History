    ...
    begin
        with WarehouseSetup do begin
            ...
            "Create No. Series".InitBaseSeries(
              "Whse. Receipt Nos.", XWMSRCPT, XWhseReceipt, XRE000001, XRE999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Posted Whse. Receipt Nos.", XWMSRCPTplus, XPostedWhseReceipt, XR_000001, XR_999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Put-away Nos.", XWMSPUT, XWhsePutaway, XPU000001, XPU999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Internal Put-away Nos.", XWMSPAO, XWhseInternalPutaway, XWA000001, XWA999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Internal Pick Nos.", XWMSPIO, XWhseInternalPick, XWI000001, XWI999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Registered Whse. Put-away Nos.", XWMSPUTplus, XRegisteredWhsePutaway, XPU_000001, XPU_999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Pick Nos.", XWMSPICK, XWhsePick, XPI000001, XPI999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Registered Whse. Pick Nos.", XWMSPICKplus, XRegisteredWhsePick, XP_000001, XP_999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Ship Nos.", XWMSSHIP, XWhseShip, XSH000001, XSH999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Posted Whse. Shipment Nos.", XWMSSHIPplus, XPostedWhseShpt, XS_000001, XS_999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Whse. Movement Nos.", XWMSMov, XWhseMovement, XWM000001, XWM999999, '', '', 1);
            "Create No. Series".InitBaseSeries(
              "Registered Whse. Movement Nos.", XWMSMovplus, XRegisteredWhseMovement, XWM_000001, XWM_999999, '', '', 1);
