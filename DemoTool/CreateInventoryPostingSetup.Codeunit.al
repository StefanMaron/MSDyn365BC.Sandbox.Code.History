codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        with DemoDataSetup do begin
            Get();
            InsertData('', ResaleCode, '16200', '16200');
        end;
    end;
    ...
    begin
        with DemoDataSetup do begin
            Get();
            InsertData(XMAIN, ResaleCode, '16200', '16200');
            InsertData(XEAST, ResaleCode, '16200', '16200');
            InsertData(XWEST, ResaleCode, '16200', '16200');
        end;
    end;
}
