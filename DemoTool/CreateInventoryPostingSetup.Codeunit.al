codeunit 101110 "Create Inventory Posting Setup"
{
    ...
    begin
        with DemoDataSetup do begin
            Get();
            InsertData(XMAIN, ResaleCode, CreateGLAccount.GoodsforResale(), '');
            InsertData(XEAST, ResaleCode, CreateGLAccount.GoodsforResale(), '');
            InsertData(XWEST, ResaleCode, CreateGLAccount.GoodsforResale(), '');
        end;
    end;
}
