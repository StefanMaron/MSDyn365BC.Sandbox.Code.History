codeunit 101579 "Create Marketing Setup"
{
    ...
    begin
        ...
        with MarketingSetup do begin
            ...
            Validate("Mergefield Language ID", 1040);
    ...
    begin
        with MarketingSetup do begin
            ...
            CreateNoSeries.InitBaseSeries("Campaign Nos.", XCAMP, XCampaign, XCP0001, XCP9999, '', '', 1,
              NoSeries."No. Series Type"::Normal, '', 0, '', false, true);
            CreateNoSeries.InitBaseSeries("Segment Nos.", XSEGM, XSegment, XSM00001, XSM99999, '', '', 1,
              NoSeries."No. Series Type"::Normal, '', 0, '', false, true);
            CreateNoSeries.InitBaseSeries("To-do Nos.", XTASK, XTaskDescr, XTD000001, XTD999999, '', '', 1,
              NoSeries."No. Series Type"::Normal, '', 0, '', false, true);
            CreateNoSeries.InitBaseSeries("Opportunity Nos.", XOPP, XOpportunity, XOP000001, XOP999999, '', '', 1,
              NoSeries."No. Series Type"::Normal, '', 0, '', false, true);
