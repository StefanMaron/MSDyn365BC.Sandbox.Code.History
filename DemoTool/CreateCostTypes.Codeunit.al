codeunit 119085 "Create Cost Types"
{
    ...
    var
        ...
        XACTACCR: Label 'ACTACCR', Comment = 'ACTACCR stands for Actual Accurals and it is a cost center.';
    ...
    begin
        ...
        CostType.SetRange("No.", MakeAdjustments.Convert('997120'), MakeAdjustments.Convert('999250'));
        CostType.DeleteAll();
        CostType.SetRange("No.", MakeAdjustments.Convert('997220'), MakeAdjustments.Convert('997293'));
        CostType.DeleteAll();
        CostType.Reset();
        ...
        CostType."G/L Account Range" := MakeAdjustments.Convert('997110') + '..' + MakeAdjustments.Convert('999250');
        ...
        CostType.Get(MakeAdjustments.Convert('996100'));
        CostType.Name := XCOSTACC;
        CostType.Modify();

        CostType.Get(MakeAdjustments.Convert('8084300'));
        CostType.Delete();
