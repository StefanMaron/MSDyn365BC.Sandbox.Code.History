codeunit 119085 "Create Cost Types"
{
    ...
    var
        ...
        XPAINT: Label 'PAINT', Comment = 'Paint is the name of Cost Object.';
        XADM: Label 'ADM';
        ...
        XACTACCR: Label 'ACTACCR', Comment = 'ACTACCR stands for Actual Accurals and is a name of cost center.';
    ...
    begin
        ...
        // CostType.SETRANGE("Line Type",0);
        // CostType.SETRANGE("No.",MakeAdjustments.Convert('997110'),MakeAdjustments.Convert('997293'));
        // CostType.MODIFYALL(CostType."Combine Entries",CostType."Combine Entries"::Day);
        ...
        // CostType.MODIFYALL(CostType."Combine Entries",CostType."Combine Entries"::Month);
        // CostType.Reset();
        ...
        // CostType.SETRANGE("No.",MakeAdjustments.Convert('998810'),MakeAdjustments.Convert('998890'));
        // CostType.MODIFYALL("G/L Account Range",'');
