codeunit 119085 "Create Cost Types"
{
    ...
    var
        ...
        XMATERIAL: Label 'MATERIAL', Comment = 'Material is the name of Cost Center.';
        XGL: Label 'GL';
        ...
        XEXPENSES: Label 'EXPENSES', Comment = 'Expenses is a substring of Cost Type name.';
        XCOSTS: Label 'COSTS';
        XEXP: Label 'Expense';
        XCOS: Label 'Costs';
        XEXPE: Label 'expense';
        XCOST: Label 'costs', Comment = 'costs is a substring of Cost Type name.';
        XEARNINGS: Label 'EARNINGS', Comment = 'Earnings is a substring of the Cost Type name.';
        XREVENUE: Label 'REVENUE';
        XEARN: Label 'Earning';
        XREV: Label 'Revenue';
        XEARNI: Label 'earning';
        XREVE: Label 'revenue', Comment = 'revenue is a substring of Cost Type name.';
    ...
    begin
        ...
        CostType.SetRange("No.", MakeAdjustments.Convert('997210'));
        ...
        if CostType.Get(MakeAdjustments.Convert('996000')) then begin
