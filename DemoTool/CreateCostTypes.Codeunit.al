codeunit 119085 "Create Cost Types"
{
    ...
    begin
        ...
        // Total: Delete Cost Type and create new From/To Range
        // CostType.SETRANGE("No.",MakeAdjustments.Convert('997120'),MakeAdjustments.Convert('997193'));
        CostType.SetRange("No.", MakeAdjustments.Convert('997120'), MakeAdjustments.Convert('997130'));
        CostType.DeleteAll();
        //CostType.SETRANGE("No.",MakeAdjustments.Convert('997220'),MakeAdjustments.Convert('997293'));
        CostType.SetRange("No.", MakeAdjustments.Convert('997220'), MakeAdjustments.Convert('997230'));
        CostType.DeleteAll();
        CostType.Reset();
        ...
        CostType."G/L Account Range" := MakeAdjustments.Convert('997110') + '..' + MakeAdjustments.Convert('997130');
        ...
        CostType."G/L Account Range" := MakeAdjustments.Convert('997210') + '..' + MakeAdjustments.Convert('997230');
        CostType."Cost Center Code" := XMATERIAL;
        if CostType.Modify() then;
