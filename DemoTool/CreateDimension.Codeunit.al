codeunit 101342 "Create Dimension"
{
    ...
    begin
        ...
        InsertDimensionTransl(XDEPARTMENT, 3084, 'Département', 'Code de département', 'Filtre département');
        InsertDimensionTransl(XPROJECT, 3084, 'Project', 'Code de projet', 'Filtre projet');
        InsertDimensionTransl(XCUSTOMERGROUP, 3084, 'Groupe de clients', 'Code groupe de clients', 'Filtre groupe de clients');
        InsertDimensionTransl(XBUSINESSGROUP, 3084, 'Groupe d''affaires', 'Code groupe d''affaires', 'Filtre groupe d''affaires');
        InsertDimensionTransl(XAREA, 3084, 'Régional', 'Indicatif régional', 'Filtre région');
        InsertDimensionTransl(XSALESCAMPAIGN, 3084, 'Campagne de promotion', 'Code campagne de promotion',
                                                                                              'Filtre campagne de promotion');
        InsertDimensionTransl(XSALESPERSON, 3084, 'Représentant', 'Code du représentant', 'Filtre représentant');
        InsertDimensionTransl(XPURCHASER, 3084, 'Acheteur', 'Code de l''acheteur', 'Filtre acheteur');
