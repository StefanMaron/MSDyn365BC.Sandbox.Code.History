codeunit 101342 "Create Dimension"
{
    ...
    begin
        ...
        InsertDimensionTransl(XDEPARTMENT, 2067, 'Kostenplaats', 'Kostenplaats', 'Kostenplaatsfilter');
        InsertDimensionTransl(XDEPARTMENT, 2060, 'Département', 'Code département', 'Filtre département');
        InsertDimensionTransl(XPROJECT, 2067, 'Kostendrager', 'Kostendrager', 'Kostendragerfilter');
        InsertDimensionTransl(XPROJECT, 2060, 'Dossier', 'Code dossier', 'Filtre dossier');
        InsertDimensionTransl(XCUSTOMERGROUP, 2067, 'Klantengroep', 'Klantengroep', 'Klantengroepfilter');
        InsertDimensionTransl(XCUSTOMERGROUP, 2060, 'Type de client', 'Code type de client', 'Filtre type de client');
        InsertDimensionTransl(XBUSINESSGROUP, 2067, 'Bedrijfsgroep', 'Bedrijfsgroep', 'Bedrijfsgroepfilter');
        InsertDimensionTransl(XBUSINESSGROUP, 2060, 'Marché', 'Code marché', 'Filtre marché');
        InsertDimensionTransl(XAREA, 2067, 'Area', 'Area', 'Areafilter');
        InsertDimensionTransl(XAREA, 2060, 'Région', 'Code région', 'Filtre région');
        InsertDimensionTransl(XSALESCAMPAIGN, 2067, 'Verkoopcampagne', 'Verkoopcampagne', 'Verkoopcampagnefilter');
        InsertDimensionTransl(XSALESCAMPAIGN, 2060, 'Campagne de vente', 'Code campagne de vente', 'Filtre campagne de vente');
        InsertDimensionTransl(XSALESPERSON, 2067, 'Verkoper', 'Verkoper', 'Verkoperfilter');
        InsertDimensionTransl(XSALESPERSON, 2060, 'Commercial', 'Code commercial', 'Filtre commercial');
