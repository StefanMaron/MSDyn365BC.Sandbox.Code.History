codeunit 117041 "Create Service Item"
{
    ...
    begin
      ...
      44.25, XSMdashITEM, '', '');
        InsertData('28', 'SN 5TR78', XDESKTOP, XComputerIII866MHz, ServiceItem.Status::Installed, ServiceItem.Priority::Low, '10000', XCALGARY, '80005', XPCS,
      19030116D, 12, 26.7, XSMdashITEM, '', '');
        InsertData('29', 'SNM2453', XMONITOR, X24INCHUltrascan, ServiceItem.Status::Installed, ServiceItem.Priority::Low, '10000', XCALGARY, '80105', XPCS, 19030116D, 24,
      70.35, XSMdashITEM, '', '');
