codeunit 101258 "Create Transaction Type"
{
    ...
    begin
        ...
        InsertData('31', XGoodsusedinMISCaidprograms);
        ...
        InsertData('91', XMcgoodssameownsenttoprivstor);
        InsertData('92', XMcgoodsrecdforprivatestorage);
    ...
    var
        ...
        XMcgoodsrecdforprivatestorage: Label 'MISC goods received for private storage';
