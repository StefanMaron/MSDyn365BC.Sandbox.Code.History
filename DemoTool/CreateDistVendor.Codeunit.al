    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(
              ...
              XGrassblueLtd, XRB, XLondon, DomesticCode, DomesticCode, DomesticCode, 0, XCOD, 1, XWHITE, XCIF, '', XGIRO);
            InsertData(
              '61000', XElectronicsLtd, X354OxfordStreet, CreatePostCode.Convert('GB-N16 34Z'), "Country/Region Code",
              XElectronicsLtd, XRB, XLondon, DomesticCode, DomesticCode, DomesticCode, 0, XCOD, 2, XWHITE, XCPT, '', XCASH);
            InsertData(
              '62000', XWalkerHolland, X116KensingtonRoad, CreatePostCode.Convert('GB-WC1 3DG'), "Country/Region Code",
              XWalkerHolland, XRB, XLondon, DomesticCode, DomesticCode, DomesticCode, 0, XCOD, 3, XWHITE, XCFR, '', XCASH);
        end;
    end;
