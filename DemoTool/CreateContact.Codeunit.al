codeunit 101550 "Create Contact"
{
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData(XCT100019, 'WoodImex Ltd', 'Strandvejen 334', ForeignCode, 'DKK', 'DAN', XBC, 'DK', 'DK-2950',
              0, XCT100019, '', '', '', 0);
            InsertData(XCT100120, 'Patrick Sands', '340 Marlboro Drive', ForeignCode, '', 'ENU', XEH, 'US', 'US-GA 31772',
              1, XCT100014, XM, '', '', 0);
            InsertData(XCT100121, 'Sussie Leth', 'Strandvejen 334', ForeignCode, '', 'DAN', XBC, 'DK', 'DK-2950',
              1, XCT100019, XFMAR, '', '', 0);
    ...
    begin
        ...
        with Contact do begin
            SetFilter("Country/Region Code", '=CA');
            Find('-');
            repeat
                if County in ['NS', 'ON', 'PQ'] then
                    "Territory Code" := 'ECAN';
                if County in ['BC', 'AB'] then
                    "Territory Code" := 'WCAN';
                Modify();
            until Next = 0;
            ...
            SetFilter("Company No.", 'CT000001 | CT000049');
            Find('-');
            repeat
