codeunit 160700 "Create SE"
{
    ...
    var
        ...
        XExportSales0: Label 'Export Sales 0%';
    ...
    begin
        ...
        with DemoDataSetup do begin
            ...
            InsertData('0501', XSalesinSweden25, 1, '', 2, DomesticCode, XVat25, '', 2, 0, false, 1, false);
            InsertData('0502', XSalesinSweden12, 1, '', 2, DomesticCode, XVat12, '', 2, 0, false, 1, false);
            InsertData('0503', XSalesinSweden6, 1, '', 2, DomesticCode, XVat6, '', 2, 0, false, 1, false);
            ...
            InsertData('10', XOutputVAT25, 1, '', 2, DomesticCode, XVat25, '', 1, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('11', XOutputVAT12, 1, '', 2, DomesticCode, XVat12, '', 1, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('12', XOutputVAT6, 1, '', 2, DomesticCode, XVat6, '', 1, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', XPurchaseSubject, 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('2001', XPurchaseEU25, 1, '', 1, EUCode, XVat25, '', 2, 0, false, 0, false);
            InsertData('2002', XPurchaseEU12, 1, '', 1, EUCode, XVat12, '', 2, 0, false, 0, false);
            InsertData('2003', XPurchaseEU6, 1, '', 1, EUCode, XVat6, '', 2, 0, false, 0, false);
            InsertData('2004', XPurchaseEU0, 1, '', 1, EUCode, XNoVat, '', 2, 0, false, 0, false);
            ...
            InsertData('30', XOutputVAT25, 1, '', 1, EUCode, XVat25, '', 1, 1, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('31', XOutputVAT12, 1, '', 1, EUCode, XVat12, '', 1, 1, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('32', XOutputVAT6, 1, '', 1, EUCode, XVat6, '', 1, 1, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', XSalesexemptVAT, 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('3501', XEUSales25, 1, '', 2, EUCode, XVat25, '', 2, 0, false, 1, false);
            InsertData('3502', XEUSales12, 1, '', 2, EUCode, XVat12, '', 2, 0, false, 1, false);
            InsertData('3503', XEUSales6, 1, '', 2, EUCode, XVat6, '', 2, 0, false, 1, false);
            InsertData('3504', XEUSales0, 1, '', 2, EUCode, XNoVat, '', 2, 0, false, 1, false);
            InsertData('35', XSalesGoodAnotherEC, 2, '', 0, '', '', '3501..3599', 0, 0, true, 1, false);
            InsertData('3601', XExportSales25, 1, '', 2, ExportCode, XVat25, '', 2, 0, false, 1, false);
            InsertData('3602', XExportSales12, 1, '', 2, ExportCode, XVat12, '', 2, 0, false, 1, false);
            InsertData('3603', XExportSales6, 1, '', 2, ExportCode, XVat6, '', 2, 0, false, 1, false);
            InsertData('3604', XEUSales0, 1, '', 2, EUCode, XNoVat, '', 2, 0, false, 1, false);
            ...
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, false, 0, false);
            InsertData('42', XOtherSalesetc, 1, '', 2, DomesticCode, XNoVat, '', 2, 0, true, 1, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', XFInputVAT, 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('4801', XPurchaseSE25, 1, '', 1, DomesticCode, XVat25, '', 1, 0, false, 0, false);
            InsertData('4802', XPurchaseSE12, 1, '', 1, DomesticCode, XVat12, '', 1, 0, false, 0, false);
            InsertData('4803', XPurchaseSE6, 1, '', 1, DomesticCode, XVat6, '', 1, 0, false, 0, false);
            InsertData('4804', XPurchaseSE0, 1, '', 1, DomesticCode, XNoVat, '', 1, 0, false, 0, false);
            InsertData('4805', XPurchaseSEOnly, 1, '', 1, DomesticCode, XNoVat, '', 1, 0, false, 0, false);
            InsertData('4810', XPurchaseEU25, 1, '', 1, EUCode, XVat25, '', 2, 0, false, 0, false);
            InsertData('4811', XPurchaseEU12, 1, '', 1, EUCode, XVat12, '', 2, 0, false, 0, false);
            InsertData('4812', XPurchaseEU6, 1, '', 1, EUCode, XVat6, '', 2, 0, false, 0, false);
            InsertData('48', XInputVAT, 2, '', 1, EUCode, XNoVat, '4800..4899', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
            InsertData('', '', 3, '', 0, '', '', '', 0, 0, true, 0, false);
