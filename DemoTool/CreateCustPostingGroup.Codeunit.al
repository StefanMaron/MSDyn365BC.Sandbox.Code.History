codeunit 101092 "Create Cust. Posting Group"
{
    ...
    begin
        ...
        // NAVCZ
        CustomerPostingGroup.Validate("Credit Curr. Appln. Rndg. Acc.", '663100');
        CustomerPostingGroup.Validate("Debit Curr. Appln. Rndg. Acc.", '563100');
        CustomerPostingGroup.Validate("Debit Rounding Account", '568100');
        CustomerPostingGroup.Validate("Credit Rounding Account", '668100');
        // NAVCZ
