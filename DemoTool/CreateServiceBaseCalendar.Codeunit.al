codeunit 117507 "Create Service Base Calendar"
{
    ...
    var
        ...
        XNewYearDay: Label 'New Year''''s Day';
        XAustraliaDay: Label 'Australia Day';
        XGoodFriday: Label 'Good Friday';
        XEasterMonday: Label 'Easter Monday';
        XAnzacDay: Label 'Anzac Day';
        XQueenBirthday: Label 'Queen''''s Birthday';
        XDayafterNewYearDay: Label 'Day after New Year''''s Day';
    ...
    begin
        ...
        InsertBaseCalChange(
          XAUSTRALIA, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true, 20030101D, XNewYearDay);
        CheckHolidayDate(20030101D, XNewYearDay);
        InsertBaseCalChange(
          XAUSTRALIA, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true, 20030126D, XAustraliaDay);
        CheckHolidayDate(20030126D, XAustraliaDay);
        InsertBaseCalChange(
        ...
        InsertBaseCalChange(
          XAUSTRALIA, BaseCalChange."Recurring System"::" ", BaseCalChange.Day::" ", true, 20030609D, XQueenBirthday);
        CheckHolidayDate(20030609D, XQueenBirthday);
        InsertBaseCalChange(
          XAUSTRALIA, BaseCalChange."Recurring System"::" ", BaseCalChange.Day::" ", true, 20040614D, XQueenBirthday);
        CheckHolidayDate(20040614D, XQueenBirthday);
    end;
    ...
    begin
        ...
        CheckHolidayDate(20021226D, XBoxingDay);
        InsertBaseCalChange(
         XNZ, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true, 20030101D, XNewYearDay);
        CheckHolidayDate(20030101D, XNewYearDay);
        InsertBaseCalChange(
         XNZ, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true, 20030102D, XDayafterNewYearDay);
        CheckHolidayDate(20030102D, XDayafterNewYearDay);
        InsertBaseCalChange(
        ...
        CheckHolidayDate(20030425D, XAnzacDay);
        InsertBaseCalChange(
         XNZ, BaseCalChange."Recurring System"::" ", BaseCalChange.Day::" ", true, 20030602D, XQueenBirthday);
        CheckHolidayDate(20030602D, XQueenBirthday);
        InsertBaseCalChange(
         XNZ, BaseCalChange."Recurring System"::" ", BaseCalChange.Day::" ", true, 20040607D, XQueenBirthday);
        CheckHolidayDate(20040607D, XQueenBirthday);
        InsertBaseCalChange(
