codeunit 117507 "Create Service Base Calendar"
{
    ...
    begin
        ...
        InsertBaseCalChange(
          ...
          DateToDMY(19021231D), XNewYearsEve);
        CheckHolidayDate(DateToDMY(19021231D), XNewYearsEve);

        InsertBaseCalChange(
          XGB, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true,
          DateToDMY(19030101D), XNewYearsDay);
        CheckHolidayDate(DateToDMY(19030101D), XNewYearsDay);

        InsertBaseCalChange(
          XGB, BaseCalChange."Recurring System"::"Annual Recurring", BaseCalChange.Day::" ", true,
          DateToDMY(19030430D), XQueensBirthday);
        CheckHolidayDate(DateToDMY(19030430D), XQueensBirthday);
