codeunit 163505 "Create Banking Setup CZB"
{
    ...
    begin
        with BankAccount do
            if Get(CreateBankAccount.GetBankAccountCode('XNBL')) then begin
                CreateNoSeries.InitBaseSeries2("Payment Order Nos. CZB", XPORDER, XPaymentOrder, 'BPRI0001', 'BPRI9999', '', '', 1);
                CreateNoSeries.InitBaseSeries2("Issued Payment Order Nos. CZB", XPORDERPlus, XIssuedPaymentOrder, 'BPRI00001', 'BPRI99999', '', '', 1);
                CreateNoSeries.InitBaseSeries2("Bank Statement Nos. CZB", XBSTMT, XBankStatement, 'BVYP0001', 'BVYP9999', '', '', 1);
                CreateNoSeries.InitBaseSeries2("Issued Bank Statement Nos. CZB", XBSTMTPlus, XIssuedBankStatement, 'BVYP00001', 'BVYP99999', '', '', 1);
                Modify();
            end;
    end;
