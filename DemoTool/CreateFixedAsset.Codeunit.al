codeunit 101800 "Create Fixed Asset"
{
    ...
    begin
        ...
        InsertData(
          ...
          XAKW2476111, 19030421D, "Vendor No.", "Vendor No.", XxFA000010);
        InsertData(
          XFA000090, XSwitchboard, XTANGIBLE, XTELEPHONE, XADM, '', XRECEPTION, 0, '', XEH,
          XTELE4476Z, 19031212D, "Vendor No.", "Vendor No.", XxFA000020);
    end;

    var
        XxFA000010: Label 'FA000010';
        XxFA000020: Label 'FA000020';
    ...
    begin
        ...
        "Fixed Asset".Validate("Source FA No.", "Source FA No.");//IT
        "Fixed Asset".Modify();
    end;
}
