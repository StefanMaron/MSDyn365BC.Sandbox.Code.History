codeunit 101800 "Create Fixed Asset"
{
    ...
    begin
        ...
        ModifyData(XFA000010, XBLUE, XGSTGroup0988, XHSNCode0988001);
        ModifyData(XFA000020, XBLUE, XGSTGroup0988, XHSNCode0988001);
    end;
    ...
    local procedure ModifyData(FANo: Code[20]; LocationCode: Code[10]; GSTGroupCode: Code[20]; HSNSacCode: Code[20])
    var
        FixedAsset: Record "Fixed Asset";
    begin
        if FixedAsset.Get(FANo) then begin
            FixedAsset."Location Code" := LocationCode;
            FixedAsset."GST Group Code" := GSTGroupCode;
            FixedAsset."HSN/SAC Code" := HSNSacCode;
            FixedAsset.Modify();
        end;
    end;
}
