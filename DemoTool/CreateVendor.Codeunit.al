...
codeunit 101023 "Create Vendor"
{
    ...
    var
        ...
        X41000: Label '41000';
        X51000: Label '51000';
        XNewDelhiPostmaster: Label 'New Delhi Postmaster';
        XDelhiPropertyManagement: Label 'Delhi Property Management';
        XWoodTechnologies: Label 'Wood Technologies';
        XFineHomeFurniture: Label 'Fine Home Furniture';
        XTechnoElectronicsLtd: Label 'Techno Electronics Ltd.';
        XPatelRoad25: Label 'Patel Road 25';
        XDwarkaSector6: Label 'Dwarka, Sector 6';
        XSector62Faridabad: Label 'Sector 62, Faridabad';
        XHitechDrive33: Label 'Hitech Drive 33';
        X10ARJUNNAGAR: Label '10, ARJUN NAGAR';
        X1Name: Label 'Delhi Postmaster';
        X1Address: Label 'Patel Road 25';
        X1PostCode: Label 'IN-110001';
        X1VendCity: Label 'New Delhi';
        X1CountryCode: Label 'IN';
        X1StateCode: Label 'DL';
        X1LocationCode: Label 'BLUE';
        X1GSTVendorType: Enum "GST Vendor Type";
        XPANStatus: Enum "P.A.N.Status";
        X1AssesseeCode: Label 'COM';
        X1PanNo: label 'CONQB0007I';
        X1GSTRegNo: Label '07CONQB0007I1Z3';
        X2Name: Label 'AR Day Property Management';
        X2Address: Label 'Dwarka, Sector 6';
        X2PostCode: Label 'IN-110001';
        X2VendCity: Label 'Watford';
        X2CountryCode: Label 'US';
        X2StateCode: Label '';
        X2LocationCode: Label 'BLUE';
        X2AssesseeCode: Label 'COM';
        X2PanStatus: Label 'PANAPPLIED';
        X2PanRefNo: Label '123456778';
        X2GSTRegNo: Label '07CONQB0007I1Z3';
        X5Name: Label 'Service Electronics Ltd.';
        X5Address: Label 'Noida Sector 76, Gautam Budda Nagar';
        X5PostCode: Label 'IN-122002';
        X5PanNo: Label 'LOCAT6543B';
        X5VendCity: Label 'New Delhi';
        X5CountryCode: Label 'IN';
        X5StateCode: Label 'DL';
        X5LocationCode: Label 'BLUE';
        X5AssesseeCode: Label 'COM';
        X5GSTRegNo: Label '06LOCAT6543B1Z2';
        XRED: Label 'RED';
