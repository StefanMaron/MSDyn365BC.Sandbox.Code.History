codeunit 163539 "Create Cash Desk Event CZP"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(XEET, XSalesWithRegistrationToEET, CashDocumentType::Receipt, AccountType::"G/L Account", '602110', 2, DomesticCode, BaseVATServiceCode(), true);
            InsertData(XEETCORR, XCorrectionEET, CashDocumentType::Withdrawal, AccountType::"G/L Account", '602110', 1, DomesticCode, BaseVATServiceCode(), true);
        end;
    end;
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(XEET, XSalesWithRegistrationToEET, CashDocumentType::Receipt, AccountType::"G/L Account", '602110', 2, DomesticCode, BaseVATServiceCode(), true);
            InsertData(XEETCORR, XCorrectionEET, CashDocumentType::Withdrawal, AccountType::"G/L Account", '602110', 1, DomesticCode, BaseVATServiceCode(), true);
            InsertData(XFUEL, XFuelpurchase, CashDocumentType::Withdrawal, AccountType::"G/L Account", '501200', 1, DomesticCode, BaseVATItemCode(), false);
            ...
            InsertData(XOFFSUPP, XOfficesupplies, CashDocumentType::Withdrawal, AccountType::"G/L Account", '501100', 1, DomesticCode, BaseVATItemCode(), false);
            InsertData(XREPCOSTS, XRepresentationcosts, CashDocumentType::Withdrawal, AccountType::"G/L Account", '513100', 0, '', '', false);
            InsertData(XREPAIRS, XRepairandmaintenance, CashDocumentType::Withdrawal, AccountType::"G/L Account", '511100', 1, DomesticCode, BaseVATServiceCode(), false);
            InsertData(XMATPAID, XMaterialpaidbycash, CashDocumentType::Withdrawal, AccountType::"G/L Account", '501100', 1, DomesticCode, BaseVATItemCode(), false);
        end;
    end;
