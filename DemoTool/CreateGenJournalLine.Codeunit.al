codeunit 101081 "Create Gen. Journal Line"
{
    ...
    begin
        ...
        InsertDailyEntry(
          ...
          0, '998290', 15.13, XADM, '', 0, '', 0D); // NAVCZ
        InsertDailyEntry(
        ...
        InsertDailyEntry(
          ...
          0, '998290', 27.66, XPROD, '', 0, '', 0D); // NAVCZ
        InsertDailyEntry(
          XGENERAL, 0, '998290', 19030126D, 0, '2608', XRepairandUpgofSpraypaintRobot, // NAVCZ
          0, '', -311.15, XPROD, '', 0, '', 0D);
        InsertDailyEntry(
        ...
        InsertOpeningEntry(0, '998290', 19011231D, -382542.6); // NAVCZ
        InsertOpeningEntry(0, '991210', 19011231D, 654733.13);
        InsertOpeningEntry(0, '998290', 19011231D, -406926.51); // NAVCZ
        InsertOpeningEntry(0, '991110', 19011231D, 173535.88);
        InsertOpeningEntry(0, '998290', 19011231D, -70682.82); // NAVCZ
        InsertOpeningEntry(0, '991310', 19011231D, 55573.43);
        InsertOpeningEntry(0, '998290', 19011231D, -27861.76); // NAVCZ
        ...
        InsertOpeningEntry(0, '998290', 19011231D, 169.12); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020101D, 246823.09, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020101D, -246823.09, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020101D, 97717.13, XSALES, '', '30', '', ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020101D, -97717.13, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020101D, 72702.0, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020101D, -72702.0, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020101D, 16745.29, XSALES, '', '30', XINDUSTRIAL, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020101D, -16745.29, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020101D, 1850.53, XSALES, '', '80', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020101D, -658.62, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020101D, -1977.97, XSALES, '', '30', '', ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020201D, 330504.44, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020201D, -330504.44, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020201D, 59569.56, XSALES, '', '30', '', ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020201D, -59569.56, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020201D, 75955.87, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020201D, -75955.87, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020201D, 27097.14, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020201D, -497.12, XSALES, '', '30', '', ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020201D, -2337.85, XSALES, '', '', '', ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020301D, 252579.3, XSALES, '', '30', XINDUSTRIAL, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020301D, -252579.3, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, 7704.26, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020301D, -7704.26, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, 77343.24, XSALES, '', '50', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020301D, -77343.24, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, -858.57, XSALES, '', '50', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020301D, 72657.14, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020301D, -72657.14, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, 5814.59, XSALES, '', '30', XINDUSTRIAL, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020301D, -5814.59, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, 12930.39, XSALES, '', '80', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020301D, -12930.39, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020301D, -262.4, XSALES, '', '30', XINDUSTRIAL, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020401D, 236191.86, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020401D, -236191.86, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020401D, 1914.47, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020401D, -1914.47, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020401D, 87433.67, XSALES, '', '70', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020401D, -87433.67, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020401D, 66088.16, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020401D, -66088.16, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020401D, 6716.66, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020401D, -6716.66, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020401D, 15912.13, XSALES, '', '70', XHOME, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020401D, -203.1, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020401D, -893.08, XSALES, '', '30', XHOME, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020501D, 261028.66, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020501D, -261028.66, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020501D, 10691.57, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020501D, -10691.57, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020501D, 3564.59, XSALES, '', '70', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020501D, -3564.59, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020501D, 59972.89, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020501D, -59972.89, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020501D, 17580.25, XSALES, '', '70', XHOME, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020601D, 305004.93, XSALES, '', '30', XHOME, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020601D, -305004.93, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020601D, 21289.83, XSALES, '', '30', XHOME, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020601D, -21289.83, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020601D, 1706.55, XSALES, '', '80', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020601D, -1706.55, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020601D, 64926.8, XSALES, '', '30', XHOME, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020601D, -64926.8, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020601D, 7639.08, XSALES, '', '30', XHOME, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020601D, -7639.08, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020601D, 16697.84, XSALES, '', '80', XHOME, XSUMMER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020601D, -1645.77, XSALES, '', '30', XHOME, XSUMMER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020701D, 200066.85, XSALES, '', '30', XINDUSTRIAL, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020701D, -200066.85, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020701D, 74638.4, XSALES, '', '70', XOFFICE, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020701D, -74638.4, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020701D, -1308.72, XSALES, '', '30', XOFFICE, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020701D, 52406.77, XSALES, '', '30', XOFFICE, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020701D, -52406.77, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020701D, 16817.63, XSALES, '', '70', XINDUSTRIAL, XSUMMER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020701D, -16817.63, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020701D, -525.06, XSALES, '', '30', XOFFICE, XSUMMER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020801D, 341542.81, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020801D, -341542.81, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020801D, 1175.21, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020801D, -1175.21, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020801D, 68270.44, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020801D, -68270.44, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020801D, 14422.62, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020801D, -49.59, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020801D, -1525.07, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020901D, 245508.66, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020901D, -245508.66, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020901D, 98683.84, XSALES, '', '30', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020901D, -98683.84, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020901D, 1171.66, XSALES, '', '70', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19020901D, -1171.66, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020901D, 72871.71, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19020901D, -72871.71, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19020901D, 20249.13, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19020901D, -179.09, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19020901D, -1283.66, XSALES, '', '30', XHOME, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021001D, 233115.8, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021001D, -233115.8, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021001D, 79888.56, XSALES, '', '80', XHOME, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021001D, -79888.56, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021001D, 77623.66, XSALES, '', '30', XINDUSTRIAL, ''); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021001D, -77623.66, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021001D, 4358.41, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021001D, -4358.41, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021001D, 3950.13, XSALES, '', '70', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021001D, -766.08, XSALES, '', '70', XOFFICE, ''); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19021001D, -2054.72, XSALES, '', '30', XOFFICE, ''); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021101D, 309681.81, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021101D, -309681.81, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021101D, 6092.71, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021101D, -6092.71, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021101D, 84654.03, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021101D, -84654.03, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021101D, 1783.2, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021101D, -1783.2, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021101D, 126.96, XSALES, '', '70', XHOME, XWINTER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021101D, -1952.12, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021201D, 306509.81, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021201D, -306509.81, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021201D, 131.26, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021201D, -131.26, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021201D, 38505.98, XSALES, '', '50', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995420', 19021201D, -38505.98, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021201D, 77238.96, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '995410', 19021201D, -77238.96, '', '', '', '', '');
        InsertPeriodicEntry(0, '998290', 19021201D, 13649.84, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        ...
        InsertPeriodicEntry(0, '998290', 19021201D, -417.22, XSALES, '', '50', XHOME, XWINTER); // NAVCZ
        InsertPeriodicEntry(0, '998290', 19021201D, -1707.57, XSALES, '', '30', XHOME, XWINTER); // NAVCZ
        ...
        "Exactly Balanced" := true;
        InsertOtherEntry(0, '998290', 19021231D, '00-12A', XDepreciation, -70008.19, ''); // NAVCZ
        ...
        "Exactly Balanced" := true;
        InsertOtherEntry(0, '998290', 19021231D, '00-12A', XDepreciation, -68312.56, ''); // NAVCZ
        ...
        "Exactly Balanced" := true;
        InsertOtherEntry(0, '998290', 19021231D, '00-12A', XDepreciation, -160417.72, ''); // NAVCZ
        ...
        "Exactly Balanced" := true;
        InsertOtherEntry(0, '998290', 19021231D, '00-12A', XDepreciation, -25217.82, ''); // NAVCZ
        ...
        InsertOtherEntry(0, '998290', 19021231D, '00-12B', XBalanceSheetChanges, 1103.92, ''); // NAVCZ
        ...
        case "Document No." of
            '2806':
                begin
                    ...
                    GenJournalLine.Validate("Applies-to Doc. No.", '103023'); // NAVCZ
                end;
            '2807':
                begin
