codeunit 101081 "Create Gen. Journal Line"
{
    ...
    begin
        ...
        "Exactly Balanced" := false;
        InsertDailyEntry(
          XGENERAL, XDAILY, 3, XNBL, 19030119D, 1, 'BANK1', 'BANK1',
          3, CreateBankAccount.GetCheckingBankAccountCode(), -2000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, XDAILY, 3, XNBL, 19030119D, 1, 'BANK2', 'BANK2',
          3, CreateBankAccount.GetCheckingBankAccountCode(), -3000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, XDAILY, 3, XNBL, 19030119D, 1, 'DEPOSIT3', 'DEPOSIT3',
          3, CreateBankAccount.GetCheckingBankAccountCode(), -4000.0, '', '', 0, '', 0D);
        InsertDailyEntry(
          XGENERAL, XDAILY, 3, XNBL, 19030119D, 1, 'DEPOSIT4', 'DEPOSIT4',
          3, CreateBankAccount.GetCheckingBankAccountCode(), -4000.0, '', '', 0, '', 0D);
    end;
    ...
    begin
        ...
        if (Date = OpeningEntryDate) and (GenJournalLine."Account Type" = GenJournalLine."Account Type"::"G/L Account") then
            GenJournalLine.Validate("Posting Date", ClosingDate(Date))
        else
            GenJournalLine.Validate("Posting Date", Date);
        GenJournalLine.Validate("Account Type", "Account Type");
        ...
        if DocumentNo <> '' then begin
            ...
            if Date = OpeningEntryDate then begin
                ...
                GenJournalLine.Validate("VAT Prod. Posting Group", DemoDataSetup.NoVATCode);
