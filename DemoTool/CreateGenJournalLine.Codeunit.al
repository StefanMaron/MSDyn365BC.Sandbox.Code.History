codeunit 101081 "Create Gen. Journal Line"
{
    ...
    begin
        ...
        InsertDailyEntry(
          ...
          0, '997120', -2300 / 0.8902428, '', '', 0, '', 19030202D, '', 100);
        InsertDailyEntry(
          XPURCH, 2, '49454647', 19030103D, 2, '2702', 'VAG - Jürgensen',
          0, '997120', -1500 / 0.8902428, '', '', 0, '', 19030203D, '', 101);
        InsertDailyEntry(
          XPURCH, 2, '49454647', 19030107D, 2, '2703', 'VAG - Jürgensen',
          0, '997120', -3500 / 0.8902428, '', '', 0, '', 19030207D, '', 102);
        InsertDailyEntry(
          XPURCH, 2, '49454647', 19030115D, 2, '2704', 'VAG - Jürgensen',
          0, '997120', -2600 / 0.8902428, '', '', 0, '', 19030215D, '', 103);
        InsertDailyEntry(
          XPURCH, 2, '49454647', 19030120D, 3, '2705', 'VAG - Jürgensen',
          0, '997120', 1100 / 0.8902428, '', '', 0, '', 19030220D, '', 104);
        InsertDailyEntry(
          XPURCH, 2, '49494949', 19030104D, 2, '2706', 'KKA Büromaschinen Gmbh',
          0, '997120', -3300 / 0.8902428, '', '', 0, '', 19030204D, '', 105);
        InsertDailyEntry(
          XPURCH, 2, '49494949', 19030107D, 2, '2707', 'KKA Büromaschinen Gmbh',
          0, '997120', -1400 / 0.8902428, '', '', 0, '', 19030204D, '', 106);
        InsertDailyEntry(
          XPURCH, 2, '49494949', 19030115D, 2, '2708', 'KKA Büromaschinen Gmbh',
          0, '997120', -2700 / 0.8902428, '', '', 0, '', 19030215D, '', 107);
        InsertDailyEntry(
          XPURCH, 2, '49494949', 19030116D, 2, '2709', 'KKA Büromaschinen Gmbh',
          0, '997120', -5600 / 0.8902428, '', '', 0, '', 19030216D, '', 108);
        InsertDailyEntry(
          XPURCH, 2, '49494949', 19030120D, 3, '2710', 'KKA Büromaschinen Gmbh',
          0, '997120', 1900 / 0.8902428, '', '', 0, '', 19030220D, '', 109);

        InsertDailyEntry(
          XSALES, 1, '49525252', 19030106D, 2, '2801', 'Beef House',
          0, '996120', 2500 / 0.8902428, XSALES, '', 0, '', 19030206D, '', 200);
        InsertDailyEntry(
          XSALES, 1, '49525252', 19030107D, 2, '2802', 'Beef House',
          0, '996120', 4000 / 0.8902428, XSALES, '', 0, '', 19030206D, '', 201);
        InsertDailyEntry(
          XSALES, 1, '49525252', 19030109D, 2, '2803', 'Beef House',
          0, '996120', 3500 / 0.8902428, XSALES, '', 0, '', 19030209D, '', 202);
        InsertDailyEntry(
          XSALES, 1, '49525252', 19030120D, 2, '2804', 'Beef House',
          0, '996120', 2200 / 0.8902428, XSALES, '', 0, '', 19030220D, '', 203);
        InsertDailyEntry(
          XSALES, 1, '49525252', 19030125D, 3, '2805', 'Beef House',
          0, '996120', -1000 / 0.8902428, XSALES, '', 0, '', 19030225D, '', 204);
        InsertDailyEntry(
          XSALES, 1, '49633663', 19030121D, 1, '2806', 'Autohaus Mielberg KG',
          0, '996120', -1045.556 / 0.8902428, XSALES, '', 0, '', 19030221D, '', 205);
        InsertDailyEntry(
          XSALES, 1, '49633663', 19030123D, 1, '2807', 'Autohaus Mielberg KG',
          3, XWWBEUR, -729.463 / 0.8902428, XSALES, '', 0, '', 19030223D, '', 206);
        InsertDailyEntry(
          XSALES, 1, '49633663', 19030124D, 2, '2808', 'Autohaus Mielberg KG',
          0, '996120', 4000 / 0.8902428, XSALES, '', 0, '', 19030224D, '', 207);
        InsertDailyEntry(
          XSALES, 1, '49633663', 19030125D, 2, '2809', 'Autohaus Mielberg KG',
          0, '996120', 2500 / 0.8902428, XSALES, '', 0, '', 19030225D, '', 208);
        InsertDailyEntry(
          XSALES, 1, '49633663', 19030126D, 3, '2810', 'Autohaus Mielberg KG',
          0, '996120', -500 / 0.8902428, XSALES, '', 0, '', 19030226D, '', 209);
        VATDocumentNo := StrSubstNo(VATDocNumber, XSET4Q, (DemoDataSetup."Starting Year" - 1));

        // Adjust of External Document No. and Transaction No.
        // The Demo Tool entries have been separated in two entries
        // InsertDailyEntry(
        // XGENERAL,0,'995310',01021902D,0,VATDocumentNo,XVATSettlement,
        // 0,'995780',-104423.13,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998120',05011903D,0,'2588',XCleaningExpensesDec,
        // 0,'992910',172.86,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998110',05011903D,0,'2589',XRent1stQuarter,
        // 3,XWWBOPERATING,234.19,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998130',05011903D,0,'2590',XWarehouseWindowReplacement,
        // 0,'992910',234.19,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998420',05011903D,0,'2591',XDinnerwithMarsholmFurniture,
        // 0,'992910',234.19,XSALES,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998530',05011903D,0,'2592',XNewTires,
        // 3,XWWBOPERATING,49.96,XSALES,XTOYOTA,0,'',0D);
        InsertDailyEntry(
          XGENERAL, 0, '995310', 19020201D, 0, VATDocumentNo, XVATSettlement,
          0, '995780', -104423.13, '', '', 0, '', 0D, '', 2);
        InsertDailyEntry(
          XGENERAL, 0, '998120', 19030105D, 2, '2500', XCleaningExpensesDec,
          2, '10000', 172.86, '', '', 0, '', 19030105D, '1242', 3);
        InsertDailyEntry(
          XGENERAL, 2, '10000', 19030105D, 1, '25001', XCleaningExpensesDec,
          0, '992910', 172.86, '', '', 2, '2500', 0D, '', 4);
        InsertDailyEntry(
          XGENERAL, 0, '998110', 19030105D, 2, '2501', XRent1stQuarter,
          2, '20000', 234.19, '', '', 0, '', 19030105D, '6125', 5);
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030105D, 1, '25011', XRent1stQuarter,
          3, XWWBOPERATING, 234.19, '', '', 2, '2501', 0D, '', 6);
        InsertDailyEntry(
          XGENERAL, 0, '998130', 19030105D, 2, '2502', XWarehouseWindowReplacement,
          2, '30000', 234.19, '', '', 0, '', 19030105D, '12417', 7);
        InsertDailyEntry(
          XGENERAL, 2, '30000', 19030105D, 1, '25021', XWarehouseWindowReplacement,
          0, '992910', 234.19, '', '', 2, '2502', 0D, '', 8);
        InsertDailyEntry(
          XGENERAL, 0, '998420', 19030105D, 2, '2503', XDinnerwithMarsholmFurniture,
          2, '10000', 234.19, XSALES, '', 0, '', 19030105D, '4542', 9);
        InsertDailyEntry(
          XGENERAL, 2, '10000', 19030105D, 1, '25031', XDinnerwithMarsholmFurniture,
          3, XWWBOPERATING, 234.19, XSALES, '', 2, '2503', 0D, '', 10);
        InsertDailyEntry(
          XGENERAL, 0, '998530', 19030105D, 2, '2504', XNewTires,
          2, '20000', 49.96, XSALES, XTOYOTA, 0, '', 19030105D, '4885', 11);
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030105D, 1, '25041', XNewTires,
          3, XWWBOPERATING, 49.96, XSALES, XTOYOTA, 2, '2504', 0D, '', 12);

        // InsertDailyEntry(
        // XGENERAL,2,'10000',11011903D,1,'2593',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'5437',11011903D);
        // InsertDailyEntry(
        // XGENERAL,1,'20000',12011903D,1,'2594',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-2',12011903D);
        // InsertDailyEntry(
        // XGENERAL,1,'20000',12011903D,1,'2594',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-5',12011903D);
        // InsertDailyEntry(
        // XGENERAL,1,'20000',12011903D,1,'2594',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-12',12011903D);
        // InsertDailyEntry(
        // XGENERAL,0,'998710',14011903D,0,'2595',XSalariesWeek1AND2,
        // 0,'',864.30,XSALES,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998710',14011903D,0,'2595',XSalariesWeek1AND2,
        // 0,'',259.29,XPROD,'',0,'',0D);
        // "Exactly Balanced" := TRUE;
        // InsertDailyEntry(
        // XGENERAL,3,XWWBOPERATING,14011903D,0,'2595',XSalariesWeek1AND2,
        // 0,'',-1123.59,'','',0,'',0D);
        InsertDailyEntry(
          XGENERAL, 2, '10000', 19030111D, 1, '2593', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '5437', 19030111D, '', 13);
        InsertDailyEntry(
          XGENERAL, 1, '20000', 19030112D, 1, '2594', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-2', 19030112D, '', 13);
        InsertDailyEntry(
          XGENERAL, 1, '20000', 19030112D, 1, '2594', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-5', 19030112D, '', 13);
        InsertDailyEntry(
          XGENERAL, 1, '20000', 19030112D, 1, '2594', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-12', 19030112D, '', 13);
        InsertDailyEntry(
          XGENERAL, 0, '998710', 19030114D, 0, '2595', XSalariesWeek1AND2,
          0, '', 864.3, XSALES, '', 0, '', 0D, '', 13);
        InsertDailyEntry(
          XGENERAL, 0, '998710', 19030114D, 0, '2595', XSalariesWeek1AND2,
          0, '', 259.29, XPROD, '', 0, '', 0D, '', 13);
        "Exactly Balanced" := true;
        InsertDailyEntry(
        ...
        //ES Avoid Entries = 0
        // InsertDailyEntry(
        // XGENERAL,1,'10000',15011903D,1,'2596',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-1',15011903D);
        // InsertDailyEntry(
        // XGENERAL,1,'10000',15011903D,1,'2596',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-3',15011903D);
        // InsertDailyEntry(
        // XGENERAL,1,'10000',15011903D,1,'2596',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'00-6',15011903D);
        // InsertDailyEntry(
        // XGENERAL,2,'20000',15011903D,1,'2597',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'4362',15011903D);
        InsertDailyEntry(
          XGENERAL, 1, '10000', 19030115D, 1, '2596', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-1', 19030115D, '', 13);
        InsertDailyEntry(
          XGENERAL, 1, '10000', 19030115D, 1, '2596', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-3', 19030115D, '', 13);
        InsertDailyEntry(
          XGENERAL, 1, '10000', 19030115D, 1, '2596', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '00-6', 19030115D, '', 13);
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030115D, 1, '2597', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '4362', 19030115D, '', 13);
        // FES

        // InsertDailyEntry(
        // XGENERAL,0,'995710',18011903D,0,'2598',XInvoiceno156683forGasoline,
        // 0,'',13.94,XSALES,XTOYOTA,0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'995750',18011903D,0,'2598',XInvoiceno156683forGasoline,
        // 0,'',6.96,XSALES,XTOYOTA,0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998510',18011903D,0,'2598',XInvoiceno156683forGasoline,
        ...
        InsertDailyEntry(
          ...
          0, '', 13.0, XSALES, XTOYOTA, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '995750', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 6.0, XSALES, XTOYOTA, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '998510', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 25.0, XSALES, XTOYOTA, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '995710', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 6.0, XSALES, XVW, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '995750', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 3.0, XSALES, XVW, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '998510', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 11.0, XSALES, XVW, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '995710', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 17.0, XSALES, XMERCEDES, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '995750', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 8.0, XSALES, XMERCEDES, 0, '', 0D, '', 14);
        InsertDailyEntry(
          XGENERAL, 0, '998510', 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          0, '', 32.0, XSALES, XMERCEDES, 0, '', 0D, '', 14);
        "Exactly Balanced" := true;

        InsertDailyEntry(
          XGENERAL, 2, '30000', 19030118D, 2, '2505', XInvoiceno156683forGasoline,
          0, '', -121.0, '', '', 0, '', 0D, 'X/3531', 14);

        // InsertDailyEntry(
        // XGENERAL,3,XWWBOPERATING,18011903D,0,'2598',XInvoiceno156683forGasoline,
        // 0,'',-127.36,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,3,XWWBEUR,19011903D,0,XBANK1,XBankTransfer,
        // 3,XWWBOPERATING,5000.00,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,3,XWWBUSD,19011903D,0,'BANK2',XBankTransfer,
        // 3,XWWBOPERATING,3000.00,'','',0,'',0D);

        InsertDailyEntry(
          XGENERAL, 3, XWWBOPERATING, 19030118D, 0, '2598', XInvoiceno156683forGasoline,
          2, '30000', -121.0, '', '', 2, '2505', 0D, '', 15);
        InsertDailyEntry(
          XGENERAL, 3, XWWBEUR, 19030119D, 0, XBANK1, XBankTransfer,
          3, XWWBOPERATING, 5000.0, '', '', 0, '', 0D, '', 16);
        InsertDailyEntry(
          XGENERAL, 3, XWWBUSD, 19030119D, 0, 'BANK2', XBankTransfer,
          3, XWWBOPERATING, 3000.0, '', '', 0, '', 0D, '', 17);
        InsertDailyEntry(
          XGENERAL, 0, '998910', 19030120D, 2, '2506', XCoffeeandTea,
          2, '50000', 21.92, '', '', 0, '', 19030120D, '56822', 18);
        InsertDailyEntry(
          XGENERAL, 2, '50000', 19030120D, 1, '25061', XCoffeeandTea,
          0, '992910', 21.92, '', '', 2, '2506', 0D, '', 19);
        InsertDailyEntry(
          XGENERAL, 0, '998910', 19030120D, 2, '2507', XBirthdayBreakfastMD,
          2, '10000', 4.43, '', '', 0, '', 19030120D, '65897', 20);
        // InsertDailyEntry(
        // XGENERAL,0,'998910',20011903D,0,'2599',XCoffeeandTea,
        // 0,'992910',21.92,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998910',20011903D,0,'2600',XBirthdayBreakfastMD,
        // 0,'992910',4.43,'','',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998240',25011903D,0,'2601',XPostage,
        // 3,XWWBOPERATING,217.46,XSALES,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998210',25011903D,0,'2602','Office Supplies',
        // 0,'992910',15.13,XADM,'',0,'',0D);
        InsertDailyEntry(
          XGENERAL, 2, '10000', 19030120D, 1, '25071', XBirthdayBreakfastMD,
          0, '992910', 4.43, '', '', 2, '2507', 0D, '', 21);
        InsertDailyEntry(
          XGENERAL, 0, '998240', 19030125D, 2, '2508', XPostage,
          2, '20000', 217.46, XSALES, '', 0, '', 19030125D, '56771', 22);
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030125D, 1, '25081', XPostage,
          3, XWWBOPERATING, 217.46, XSALES, '', 2, '2508', 0D, '', 23);
        InsertDailyEntry(
          XGENERAL, 0, '998210', 19030125D, 2, '2509', 'Office Supplies',
          2, '30000', 15.13, XADM, '', 0, '', 19030125D, '44551', 24);
        InsertDailyEntry(
          XGENERAL, 2, '30000', 19030125D, 1, '25091', 'Office Supplies',
          0, '992910', 15.13, XADM, '', 2, '2509', 0D, '', 25);

        //ES Avoid Entries = 0
        // InsertDailyEntry(
        // XGENERAL,2,'20000',25011903D,1,'2603',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'4511',25011903D);
        // InsertDailyEntry(
        // XGENERAL,2,'30000',25011903D,1,'2604',XPayment,
        // 3,XWWBOPERATING,0.00,'','',2,'12345',25011903D);
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030125D, 1, '2603', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '4511', 19030125D, '', 25);
        InsertDailyEntry(
          XGENERAL, 2, '30000', 19030125D, 1, '2604', XPayment,
          3, XWWBOPERATING, 0.0, '', '', 2, '12345', 19030125D, '', 25);
        // FES

        // InsertDailyEntry(
        // XGENERAL,0,'998320',26011903D,0,'2605',XPaymentAccSystemsHotline,
        // 3,XWWBOPERATING,136.56,XADM,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998910',26011903D,0,'2607',XPackingTape,
        // 0,'992910',27.66,XPROD,'',0,'',0D);

        InsertDailyEntry(
          XGENERAL, 0, '998320', 19030126D, 2, '2510', XPaymentAccSystemsHotline,
          2, '50000', 136.56, XADM, '', 0, '', 19030126D, '565671', 26);
        InsertDailyEntry(
          XGENERAL, 2, '50000', 19030126D, 1, '25101', XPaymentAccSystemsHotline,
          3, XWWBOPERATING, 136.56, XADM, '', 2, '2510', 0D, '', 27);

        InsertDailyEntry(
          XGENERAL, 0, '998910', 19030126D, 2, '2511', XPackingTape,
          2, '10000', 27.66, XPROD, '', 0, '', 19030126D, '95225', 28);
        InsertDailyEntry(
          XGENERAL, 2, '10000', 19030126D, 1, '25111', XPackingTape,
          0, '992910', 27.66, XPROD, '', 2, '2511', 0D, '', 29);

        // InsertDailyEntry(
        // XGENERAL,0,'992910',26011903D,0,'2608',XRepairandUpgofSpraypaintRobot,
        // 0,'',-311.15,XPROD,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'991120',26011903D,0,'2608',XRepairandUpgofSpraypaintRobot,
        // 0,'',207.43,XPROD,'',0,'',0D);
        // "Exactly Balanced" := TRUE; // Before the last line without "Balancing Acc. No."
        // InsertDailyEntry(
        // XGENERAL,0,'998910',26011903D,0,'2608',XRepairandUpgofSpraypaintRobot,
        // 0,'',103.72,XPROD,'',0,'',0D);
        InsertDailyEntry(
          XGENERAL, 0, '998910', 19030126D, 2, '2512', XRepairandUpgofSpraypaintRobot,
          0, '', 103.72, XPROD, '', 0, '', 0D, '', 30);
        InsertDailyEntry(
          XGENERAL, 0, '991120', 19030126D, 2, '2512', XRepairandUpgofSpraypaintRobot,
          0, '', 207.43, XPROD, '', 0, '', 0D, '', 30);
        "Exactly Balanced" := true; // Before the last line without "Balancing Acc. No."
        InsertDailyEntry(
          XGENERAL, 2, '20000', 19030126D, 2, '2512', XRepairandUpgofSpraypaintRobot,
          0, '', -311.15, 'PROD', '', 0, '', 19030126D, '21355', 30);
        InsertDailyEntry(
          'GENERAL', 0, '992910', 19030126D, 1, '25121', XRepairandUpgofSpraypaintRobot,
          2, '20000', -311.15, XPROD, '', 2, '2512', 0D, '', 31);

        // Unposted entries in General Journal
        // The following group of 4 entries has been reorganizated in order to create 1 invoice .

        // InsertDailyEntry(
        // XGENERAL,0,'991220',27011903D,0,'2609',XPackingMachine,
        // 0,'',124.65,XPROD,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998210',27011903D,0,'2609',XBoxesforPackingMachine,
        // 0,'',27.66,XPROD,'',0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998210',27011903D,0,'2609',XGlueforPackingMachine,
        // 0,'',31.17,XPROD,'',0,'',0D);
        // "Exactly Balanced" := TRUE; // Before the last line without "Balancing Acc. No."
        // InsertDailyEntry(
        // XGENERAL,3,XWWBOPERATING,27011903D,0,'2609',XMaterialsforPackingMachine,
        // 0,'',-183.48,'','',0,'',0D);

        InsertDailyEntry(
          XGENERAL, 0, '991220', 19030127D, 2, '2513', XPackingMachine,
          0, '', 124.0, XPROD, '', 0, '', 0D, '', 32);
        InsertDailyEntry(
          XGENERAL, 0, '998210', 19030127D, 2, '2513', XBoxesforPackingMachine,
          0, '', 27.0, XPROD, '', 0, '', 0D, '', 32);
        InsertDailyEntry(
          XGENERAL, 0, '998210', 19030127D, 2, '2513', XGlueforPackingMachine,
          0, '', 31.0, XPROD, '', 0, '', 0D, '', 32);
        "Exactly Balanced" := true; // Before the last line without "Balancing Acc. No."
        InsertDailyEntry(
          XGENERAL, 2, '30000', 19030127D, 2, '2513', XMaterialsforPackingMachine,
          0, '', -182.0, '', '', 0, '', 19030127D, '37936', 32);

        // ES N/A
        // InsertDailyEntry(
        // XGENERAL,0,'995710',27011903D,0,'2610',XInvoiceno156786forGasoline,
        // 0,'',13.94,XSALES,XTOYOTA,0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'995750',27011903D,0,'2610',XInvoiceno156786forGasoline,
        // 0,'',6.96,XSALES,XTOYOTA,0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'998510',27011903D,0,'2610',XInvoiceno156786forGasoline,
        // 0,'',25.56,XSALES,XTOYOTA,0,'',0D);
        // InsertDailyEntry(
        // XGENERAL,0,'995710',27011903D,0,'2610',XInvoiceno156786forGasoline,
        // 0,'',6.51,XSALES,XVW,0,'',0D);
        ...
        // "Exactly Balanced" := TRUE;
        // InsertDailyEntry(
        // XGENERAL,3,XWWBOPERATING,27011903D,0,'2610',XInvoiceno156786forGasoline,
        // 0,'',-127.36,'','',0,'',0D);
        // FES
        ...
        InsertOpeningEntry(0, '991110', 19011230D, 1488346.44);
        InsertOpeningEntry(0, '991140', 19011230D, -382542.6);
        InsertOpeningEntry(0, '991210', 19011230D, 654733.13);
        InsertOpeningEntry(0, '991240', 19011230D, -406926.51);
        InsertOpeningEntry(0, '991110', 19011230D, 173535.88);
        InsertOpeningEntry(0, '991140', 19011230D, -70682.82);
        InsertOpeningEntry(0, '991310', 19011230D, 55573.43);
        InsertOpeningEntry(0, '991340', 19011230D, -27861.76);
        InsertOpeningEntry(0, '992180', 19011230D, 303230.1);
        InsertOpeningEntry(0, '992180', 19011230D, 151913.72);
        InsertOpeningEntry(0, '992180', 19011230D, 40469.43);
        InsertOpeningEntry(0, '992180', 19011230D, 532384.54);
        InsertOpeningEntry(0, '992310', 19011230D, 895104.26);
        InsertOpeningEntry(0, '992320', 19011230D, 99456.03);
        InsertOpeningEntry(0, '992330', 19011230D, 4127.03);
        InsertOpeningEntry(0, '992810', 19011230D, 13322.97);
        InsertOpeningEntry(0, '992910', 19011230D, 169.12);
        InsertOpeningEntry(0, '992920', 19011230D, 2856.88);
        InsertOpeningEntry(0, '992940', 19011230D, 6033.63);
        InsertOpeningEntry(0, '992940', 19011230D, 814000.0);
        InsertOpeningEntry(0, '993110', 19011230D, -500000.0);
        InsertOpeningEntry(0, '994010', 19011230D, -314000.0);
        InsertOpeningEntry(0, '993110', 19011230D, -328000.0);
        InsertOpeningEntry(0, '994010', 19011230D, -170560.0);
        InsertOpeningEntry(0, '995120', 19011230D, -405908.92);
        InsertOpeningEntry(0, '995110', 19011230D, -72207.63);
        InsertOpeningEntry(0, '995310', 19011230D, -517995.84); // will be transfered 311294 for bank WWB-OPERATING
        InsertOpeningEntry(0, '995310', 19011230D, -557534.01); // will be transfered 311294 for bank WWB-OPERATING
        InsertOpeningEntry(0, '995410', 19011230D, -567431.21);
        InsertOpeningEntry(0, '995420', 19011230D, -77816.95);
        InsertOpeningEntry(0, '995780', 19011230D, -104423.13);
        InsertOpeningEntry(0, '995810', 19011230D, -110071.95);
        InsertOpeningEntry(0, '995830', 19011230D, -16515.06);
        InsertOpeningEntry(0, '995840', 19011230D, -5075.46);
        InsertOpeningEntry(0, '995920', 19011230D, -51168.0);
        "Exactly Balanced" := true;
        InsertOpeningEntry(0, '993120', 19011230D, -547534.74);
    ...
    begin
        ...
        if DemoDataSetup."Local Precision Factor" >= 1 then
            Amount := Round(
                ...
                0.01 * DemoDataSetup."Local Precision Factor")
        ...
        if GenJournalLine."Payment Method Code" = '' then
            GenJournalLine."Payment Method Code" := XBANK;
        if GenJournalLine."Payment Terms Code" = '' then
            GenJournalLine."Payment Terms Code" := XCM;

        GenJournalLine.Validate("External Document No.", "External Document No.");
        GenJournalLine.Validate("Transaction No.", "Transaction No.");
        ...
        GenJournalLine.Validate("Gen. Posting Type", 0);
    ...
    begin
        InsertDailyEntry(CurrentJnlBatchName, XDEFAULT, "Account Type", "Account No.", Date, "Document Type", "Document No.", Description, "Bal. Account Type", "Bal. Account No.", Amount, "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", "Applies-to Doc. Type", "Applies-to Doc. No.", "Due Date", "External Document No.", "Transaction No.");
    end;
