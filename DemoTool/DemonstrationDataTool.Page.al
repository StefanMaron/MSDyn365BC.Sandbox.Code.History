page 101900 "Demonstration Data Tool"
{
    ...
    var
        HintMsg: Label 'To Create Demo Data from Config, please, run the Initialize-DemoToolResources action from your enlistment first (also, make sure you are running the web client in the Release configuration).\\To create data for selected domains, make your selection on the Domains tab.\\Then press Create Demo Data to create the demonstration data.';
