codeunit 119088 "Create Cost Acct. Jnl Line"
{
    ...
    begin
        ...
        InsertData(XINTINVC, DMY2Date(30, 6, DemoDataSetup."Starting Year"), 'U12', '6623002', '', '', '9920', '', '',
          XCalcAssetInterest, 15200);
        InsertData(XINTINVC, DMY2Date(31, 12, DemoDataSetup."Starting Year"), 'U15', '6623002', '', '', '9920', '', '',
        ...
        CostJournalBatch.Get(XCOSTACCT, XDEPRECIAT);
        CostJournalBatch."Delete after Posting" := false;
