codeunit 119088 "Create Cost Acct. Jnl Line"
{
    ...
    begin
        with CostJournalLine do begin
            ...
            // NAVCZ
            Validate("Cost Type No.", ConvertCostType(CostTypeNo));
            Validate("Bal. Cost Type No.", ConvertCostType(BalCostTypeNo));
            // NAVCZ
    ...
    local procedure ConvertCostType(CostTypeNo: Code[20]): Code[20]
    begin
        // NAVCZ
        case CostTypeNo of
            '521100':
                exit('520');
            '551100', '551200', '551300':
                exit('550');
            else
                exit(CostTypeNo);
        end;
