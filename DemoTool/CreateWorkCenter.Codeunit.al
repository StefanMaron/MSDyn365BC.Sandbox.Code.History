codeunit 119016 "Create Work Center"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData(
              '500', XSubcontractordepartment, '', '1', 10, 0, 0, '', XMINUTES, 1, 100, 0, 0, 0.0001, 0, '1', 1, false, RetailCode);
        end;
    end;
    ...
    var
        ...
        XSubcontractordepartment: Label 'Subcontractor department';
    ...
    begin
        ...
        if WorkCenter."No." = '500' then              // IT
            WorkCenter."Subcontractor No." := '70000';  // IT
        WorkCenter.Modify();
    end;
}
