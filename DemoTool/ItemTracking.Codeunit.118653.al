codeunit 118653 "Item Tracking - Item Transl."
{
    ...
    begin
        ...
        InsertData('80102-T', 'ENG', '17" M780 Monitor');
        InsertData(X80102T, XENG, X17M780Monitor);
        InsertData('80103-T', 'DAN', '19" M009 Skærm');
        InsertData('80103-T', 'ENG', '19" M009 Monitor');
        InsertData(X80103T, XENG, X19M009Monitor);
        InsertData('80208-T', 'DAN', 'Microsoft Intellimouse');
        InsertData('80208-T', 'ENG', 'Microsoft Intellimouse');
        InsertData(X80208T, XENG, XMicrosoftIntellimouse);
        InsertData('80216-T', 'DAN', 'Ethernet Kabel');
        InsertData('80216-T', 'ENG', 'Ethernet Cable');
        InsertData(X80216T, XENG, XEthernetCable);
        InsertData('80218-T', 'DAN', 'Hard disk');
        InsertData('80218-T', 'ENG', 'Hard disk Drive');
        InsertData(X80218T, XENG, XHarddiskDrive);
    end;
