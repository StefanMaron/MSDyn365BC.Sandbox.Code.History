codeunit 101287 "Create C/V Bank Account"
{
    ...
    begin
        DemoDataSetup.Get();
        InsertData(
          '', '', XTHO, XThompsonsBank, XRussellHunter, XEllesboroughRoad47, CreatePostCode.Convert('GB-B27 4KT'), XGB, XGBP, XDEU,
          X43296696298, X43296696504, X1000, X1000100000, '', '');
        InsertData(
          '', '', XPAR, XParkHouseBankingGroup, XScottMacDonald, XWickRoad56, CreatePostCode.Convert('GB-B27 4KT'), XGB, XGBP, XDEU,
          X43296311044, X43296704144, X1100, X1100100000, '', '');
        InsertData(
          '', '20000', XECA, XECABank, XSheelaWord, XAnchorHouse43, CreatePostCode.Convert('GB-B27 4KT'), XGB, XGBP, XDEU,
          X43296196933, X43296151727, X1200, X1200100000,
    ...
    var
        ...
        X43296696298: Label '+43 296 696298';
        X43296696504: Label '+43 296 696504';
        X43296311044: Label '+43 296 311044';
        X43296704144: Label '+43 296 704144';
        X43296196933: Label '+43 296 196933';
        X43296151727: Label '+43 296 151727';
