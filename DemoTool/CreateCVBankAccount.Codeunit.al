codeunit 101287 "Create C/V Bank Account"
{
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296696298, X44296696504, X1000, X1000100000, '', '', '33577', '05423');
        InsertData(
          '', '', XPAR, XParkHouseBankingGroup, XScottMacDonald, XWickRoad56, CreatePostCode.Convert('GB-B27 4KT'),
          DemoDataSetup."Country/Region Code", XGBP, XENG, X44296311044, X44296704144, X1100, X1100100000, '', '', '58600', '12004');
        InsertData(
    ...
    begin
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                // BEGIN IT
                "Customer Bank Account".Validate(ABI, ABI);
                "Customer Bank Account".Validate(CAB, CAB);
                // END IT
        ...
        if CodeSort.Find('-') then
            repeat
                ...
                // BEGIN IT
                "Vendor Bank Account".Validate(ABI, ABI);
                "Vendor Bank Account".Validate(CAB, CAB);
                // END IT
