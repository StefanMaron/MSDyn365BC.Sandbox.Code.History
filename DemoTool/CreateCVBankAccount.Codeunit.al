codeunit 101287 "Create C/V Bank Account"
{
    ...
    begin
        ...
        InsertData(
          ...
          DemoDataSetup."Country/Region Code", DemoDataSetup."Currency Code", DemoDataSetup."Language Code", // NAVCZ
          X44296196933, X44296151727, X1200, X1200100000,
          XGB54BARC20992012345678, XGB29NWBK60161331926819);
    end;
    ...
    begin
        ...
        // NAVCZ
        if Code = XTHO then begin
            if not "Vendor Bank Account".Get('10000', XTHO) then begin
                "Vendor Bank Account".Init();
                "Vendor Bank Account"."Vendor No." := '10000';
                "Vendor Bank Account".Code := Code;
                "Vendor Bank Account".Name := Name;
                "Vendor Bank Account"."Bank Account No." := '100009/0100';
                "Vendor Bank Account".Insert();
            end else begin
                "Vendor Bank Account"."Bank Account No." := '100009/0100';
                "Vendor Bank Account".Modify();
            end;

            if not "Vendor Bank Account".Get('30000', XTHO) then begin
                "Vendor Bank Account".Init();
                "Vendor Bank Account"."Vendor No." := '30000';
                "Vendor Bank Account".Code := Code;
                "Vendor Bank Account".Name := Name;
                "Vendor Bank Account"."Bank Account No." := '100011/0100';
                "Vendor Bank Account".Insert();
            end else begin
                "Vendor Bank Account"."Bank Account No." := '100011/0100';
                "Vendor Bank Account".Modify();
    ...
    procedure GetCVBankAccountCode(CVBankAccountCode: Text): Code[20]
    begin
        case UpperCase(CVBankAccountCode) of
            'XTHO':
                exit(XTHO);
            'XPAR':
                exit(XPAR);
