codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Create No. Series".InitTempSeries("Delivery Reminder Nos.", XPDELREM, XPurchaseDeliveryReminder);
            "Create No. Series".InitFinalSeries("Issued Delivery Reminder Nos.", XPDELREMPLUS, XIssuedPurchaseDeliveryReminder, 4);
    ...
    var
        ...
        XPDELREM: Label 'P-DELREM', Comment = 'PURCHASE DELIVERY REMINDER';
        XPurchaseDeliveryReminder: Label 'Purchase Delivery Reminder';
        XPDELREMPLUS: Label 'P-DELREM+', Comment = 'PURCHASE DELIVERY REMINDER';
        XIssuedPurchaseDeliveryReminder: Label 'Issued Purch. Deliv. Reminder';
