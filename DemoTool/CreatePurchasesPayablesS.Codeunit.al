codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Create No. Series".InitBaseSeries("Vendor Nos.", XVEND, XVendor, X10, X99990, '', '', 10, true);
            ...
            "Create No. Series".InitBaseSeries("Bank Batch Nos.", XASIAK, XBankBatchNo, XBB0000, XBB9999, '', '', 1);
