codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Create No. Series".InitFinalSeriesPrep("Posted Prepmt. Inv. Nos.", XPREPINVPLUS, XPostedPurchPrepmtInv, XPREPINV, 94, 3);
            ...
            "Create No. Series".InitFinalSeriesPrep("Posted Prepmt. Cr. Memo Nos.", XPREPCRPLUS, XPostedPurchPrepmtCrMemo, XPREPCR, 94, 3);
    ...
    var
        ...
        XPREPINVPLUS: Label 'PREP-FIN+';
        XPostedPurchPrepmtInv: Label 'Posted Purch. Prepmt. Inv.';
        XPREPCRPLUS: Label 'PREP-CR+';
        XPostedPurchPrepmtCrMemo: Label 'Posted Purch. Prepmt. Cr. Memo';
        XPREPINV: Label 'PREP-INV';
        XPREPCR: Label 'PREP-CR';
