codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Create No. Series".InitFinalSeries("Posted Tax Invoice Nos.", XPTAXINVPLUS, XPostedPurchaseTaxInvoice, 8);
            "Create No. Series".InitFinalSeries("WHT Certificate No. Series", XWHTCERT, XWHTCertificate, 8);
            "Create No. Series".InitFinalSeries("Posted Tax Credit Memo Nos", XPTAXCRPLUS, XPostedPurchaseTaxCreditMemo, 8);
            "Post Dated Check Template" := XPAYMENT;
            "Post Dated Check Batch" := XBANK;
            "GST Prod. Posting Group" := DemoDataSetup.NoVATCode;
    ...
    var
        ...
        XPTAXINVPLUS: Label 'P-TAXINV+';
        XPostedPurchaseTaxInvoice: Label 'Posted Purchase Tax Invoice';
        XPTAXCRPLUS: Label 'P-TAXCR+';
        XPostedPurchaseTaxCreditMemo: Label 'Posted Purchase Tax Cr. Memo';
        XWHTCERT: Label 'WHT-CERT';
        XWHTCertificate: Label 'WHT Certificate';
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Document Default Line Type" := "Document Default Line Type"::Item;
            "GST Prod. Posting Group" := DemoDataSetup.NonGST();
            "Invoice Nos." := "Posted Invoice Nos.";
            "Credit Memo Nos." := "Posted Credit Memo Nos.";
            "Copy Line Descr. to G/L Entry" := true;
            Modify();
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Posted Tax Invoice Nos." := XPTAXINVPLUS;
            "Posted Tax Credit Memo Nos" := XPTAXCRPLUS;
            "WHT Certificate No. Series" := XWHTCERT;
            Modify();
        end;
    end;
}
