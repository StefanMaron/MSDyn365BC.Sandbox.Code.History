codeunit 101312 "Create Purchases & Payables S."
{
    ...
    begin
        ...
        with "Purchases & Payables Setup" do begin
            ...
            "Create No. Series".InitFinalSeries("GST Liability Adj. Jnl Nos.", XGSTLAJN, XGSTLiabAdjJnl, 1);
            "RCM Exempt Start Date (Unreg)" := DMY2Date(1, 4, 2020);
            "RCM Exempt End Date (Unreg)" := DMY2Date(2, 4, 2020);
            EnableManualNoSeries("Credit Memo Nos.");
            Modify();
        end;
    end;
    ...
    var
        ...
        XGSTLAJN: Label 'GST-GLB';
        XGSTLiabAdjJnl: Label 'GST Liablility Adjustment Journal';
    ...
    local procedure EnableManualNoSeries(NoSeriesCode: Code[20])
    var
