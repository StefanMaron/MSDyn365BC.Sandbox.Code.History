codeunit 120552 "Create State"
{
    ...
    var
        ...
        gstreG: Record "GST Registration Nos.";
        XANDesLbl: Label 'Andaman and Nicobar Islands';
        XKAStateGstRegNo: Label '29';
        XNDDesLbl: Label 'New Delhi';
        XNDStateGstRegNo: Label '07';
        XUPDesLbl: Label 'UP';
        XUPStateGstRegNo: Label '09';
        XHRDesLbl: Label 'Haryana';
        XHRStateGstRegNo: Label '06';
