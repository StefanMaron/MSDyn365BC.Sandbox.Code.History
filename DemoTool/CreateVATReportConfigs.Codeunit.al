codeunit 101254 "Create VAT Report Configs"
{
    ...
    var
        ...
        BASReportCodeTxt: Label 'BASREPORTS', Locked = true;
        BASReportDescription: Label 'BAS Reports.';
        BASReportStart: Label 'BASREP-0001', Locked = true;
        BASReportEnd: Label 'BASREP-9999', Locked = true;
    ...
    begin
        ...
        BASReportCode := BASReportCodeTxt;
        CreateNoSeries.InitBaseSeries(BASReportCode, BASReportCode, BASReportDescription, BASReportStart, BASReportEnd, '', '', 1);
        ...
        NoSeries.Get(BASReportCode);
        VATReportSetup.Validate("BAS Report No. Series", NoSeries.Code);
