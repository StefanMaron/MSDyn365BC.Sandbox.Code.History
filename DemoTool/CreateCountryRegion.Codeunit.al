codeunit 101009 "Create Country/Region"
{
    ...
    begin
        InsertTranslation('AT', FRCTxt, 'Autriche');
        InsertTranslation('AU', FRCTxt, 'Australie');
        InsertTranslation('BE', FRCTxt, 'Belgique');
        InsertTranslation('BG', FRCTxt, 'Bulgarie');
        InsertTranslation('BR', FRCTxt, 'Br´Š¢sil');
        InsertTranslation('CA', FRCTxt, XCanada);
        InsertTranslation('CH', FRCTxt, 'Suisse');
        InsertTranslation('CZ', FRCTxt, 'R´Š¢publique tch´Š¢que');
        InsertTranslation('DE', FRCTxt, 'Allemagne');
        InsertTranslation('DK', FRCTxt, 'Danemark');
        InsertTranslation('ES', FRCTxt, 'Espagne');
        InsertTranslation('EE', FRCTxt, 'Estonie');
        InsertTranslation('FR', FRCTxt, 'France');
        InsertTranslation('GB', FRCTxt, 'Royaume-Uni');
        InsertTranslation('ID', FRCTxt, 'Indon´Š¢sie');
        InsertTranslation('IN', FRCTxt, 'Inde');
        InsertTranslation('IS', FRCTxt, 'Islande');
        InsertTranslation('IT', FRCTxt, 'Italie');
        InsertTranslation('LU', FRCTxt, XLuxembourg);
        InsertTranslation('LT', FRCTxt, 'Lituanie');
        InsertTranslation('LV', FRCTxt, 'Lettonie');
        InsertTranslation('MY', FRCTxt, 'Malaisie');
        InsertTranslation('MX', FRCTxt, 'Mexique');
        InsertTranslation('NL', FRCTxt, 'Pays-Bas');
        InsertTranslation('NO', FRCTxt, 'Norv´Š¢ge');
        InsertTranslation('NZ', FRCTxt, 'Nouvelle-Z´Š¢lande');
        InsertTranslation('PL', FRCTxt, 'Pologne');
        InsertTranslation('PT', FRCTxt, 'Portugal');
        InsertTranslation('RU', FRCTxt, 'Russie');
        InsertTranslation('SG', FRCTxt, 'Singapour');
        InsertTranslation('SE', FRCTxt, 'Su´Š¢de');
        InsertTranslation('SI', FRCTxt, 'Slov´Š¢nie');
        InsertTranslation('TH', FRCTxt, 'Tha´Š¢lande');
        InsertTranslation('TR', FRCTxt, 'Turquie');
        InsertTranslation('US', FRCTxt, 'Etats-Unis');
        InsertTranslation('ZA', FRCTxt, 'Afrique du Sud');
        InsertTranslation('MA', FRCTxt, 'Maroc');
        InsertTranslation('DZ', FRCTxt, 'Alg´Š¢rie');
        InsertTranslation('TN', FRCTxt, 'Tunisie');
        InsertTranslation('KE', FRCTxt, XKenya);
        InsertTranslation('UG', FRCTxt, 'Ouganda');
        InsertTranslation('AE', FRCTxt, 'Emirats arabes unis');
        InsertTranslation('MZ', FRCTxt, XMozambique);
        InsertTranslation('SZ', FRCTxt, XSwaziland);
        InsertTranslation('FI', FRCTxt, 'Finlande');
        InsertTranslation('HU', FRCTxt, 'Hongrie');
        InsertTranslation('RO', FRCTxt, 'Roumanie');
        InsertTranslation('EL', FRCTxt, 'Gr´Š¢ce');
        InsertTranslation('IE', FRCTxt, 'Irlande');
        InsertTranslation('NG', FRCTxt, XNigeria);
        InsertTranslation('PH', FRCTxt, XPhilippines);
        InsertTranslation('TZ', FRCTxt, 'Tanzanie');
        InsertTranslation('HR', FRCTxt, 'Croatie');
        InsertTranslation('CY', FRCTxt, 'Chypre');
        InsertTranslation('MT', FRCTxt, 'Malte');
        InsertTranslation('SK', FRCTxt, 'Slovaquie');
        InsertTranslation('BN', FRCTxt, 'Brun´Š¢i Darussalam');
        InsertTranslation('FJ', FRCTxt, 'R´Š¢publique des ´Š¢les de Fidji');
        InsertTranslation('JP', FRCTxt, 'Japon');
        InsertTranslation('SA', FRCTxt, 'Arabie Saoudite');
        InsertTranslation('SB', FRCTxt, '´Š¢les Salomon');
        InsertTranslation('VU', FRCTxt, XVanuatu);
        InsertTranslation('WS', FRCTxt, '´Š¢tat ind´Š¢pendant du Samoa');
        InsertTranslation('RS', FRCTxt, 'Serbie');
        InsertTranslation('ME', FRCTxt, 'Mont´Š¢n´Š¢gro');
        InsertTranslation('CN', FRCTxt, 'Chine');
    end;

    local procedure InsertTranslation(CountryCode: Code[10]; LanguageCode: Code[10]; Name: Text[50])
    var
    ...
    begin
        ...
        CountryRegionTranslation.Name := Name;
