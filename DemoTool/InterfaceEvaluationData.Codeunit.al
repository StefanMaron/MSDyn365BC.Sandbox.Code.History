codeunit 122001 "Interface Evaluation Data"
{
    ...
    begin
        ...
        RunCodeunit(Codeunit::"Create GST Rates");
        RunCodeunit(CODEUNIT::"Create TDS Rates");
        RunCodeunit(CODEUNIT::"Create TCS Rates");
        RunCodeunit(Codeunit::"Create Bank Charge");
    ...
    begin
        ...
        CreatePurchDocumentForLocation(PostingDate, '1968-S', 5, XBLUE);
