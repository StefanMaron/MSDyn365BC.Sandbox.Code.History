codeunit 122001 "Interface Evaluation Data"
{
    ...
    begin
        with CreateGenJournalLine do begin
            ...
            InsertEvaluationEntry(0, '20400', PostingDate, AdjustAmount(-20000.0), '');
            InsertEvaluationEntry(0, '18100', PostingDate, AdjustAmount(20000.0), '');
            InsertEvaluationEntry(0, '25100', PostingDate, AdjustAmount(-2329.42), '');
            InsertEvaluationEntry(0, '12400', PostingDate, AdjustAmount(3499.0), '');
            InsertEvaluationEntry(0, '14100', PostingDate, AdjustAmount(5498.0), '');
            InsertEvaluationEntry(0, '16300', PostingDate, AdjustAmount(28547.16), '');
            InsertEvaluationEntry(0, '17100', PostingDate, AdjustAmount(2870.0), '');
            InsertEvaluationEntry(0, '17100', PostingDate, AdjustAmount(31638.4), '');
            SetExactlyBalanced;
            InsertEvaluationEntry(0, '20400', PostingDate, 0, '');
            ...
            for MonthNo := 1 to 15 do begin
                ...
                InsertEvaluationEntry(0, '05010', PostingDate, AdjustAmount(1000), '');
                InsertEvaluationEntry(0, '03010', PostingDate, AdjustAmount(1000), '');
                SetExactlyBalanced;
                InsertEvaluationEntry(0, '18200', PostingDate, 0, '');
            end;
        end;
    end;
