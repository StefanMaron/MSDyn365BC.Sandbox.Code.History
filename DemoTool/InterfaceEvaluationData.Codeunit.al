codeunit 122001 "Interface Evaluation Data"
{
    ...
    var
        ...
        CreateEB: Codeunit "Create EB";
        CreateCODA: Codeunit "Create CODA";
        Seed: Integer;
    ...
    begin
        ...
        CreateEB.CreateEvaluationData();
        RunCodeunit(CODEUNIT::"Create Domiciliation");
        CreateCODA.CreateEvaluationData();
