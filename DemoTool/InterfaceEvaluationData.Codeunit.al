codeunit 122001 "Interface Evaluation Data"
{
    ...
    begin
        ...
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.ShareCapital(), PostingDate, AdjustAmount(-20000.0), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.PettyCash(), PostingDate, AdjustAmount(20000.0), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.AccountsPayableDomestic(), PostingDate, AdjustAmount(-2329.42), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.AccumulatedDepreciation(), PostingDate, AdjustAmount(3499.0), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.EquipmentsandTools(), PostingDate, AdjustAmount(5498.0), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.FinishedGoods(), PostingDate, AdjustAmount(28547.16), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.AccountReceivableDomestic(), PostingDate, AdjustAmount(2870.0), '');
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.AccountReceivableDomestic(), PostingDate, AdjustAmount(31638.4), '');
        CreateGenJournalLine.SetExactlyBalanced();
        CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.Profitorlossfromthepreviousyear(), PostingDate, 0, '');
        ...
        for MonthNo := 1 to 15 do begin
            ...
            CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.Rent_Leases(), PostingDate, AdjustAmount(1000), '');
            CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.Salaries(), PostingDate, AdjustAmount(1000), '');
            CreateGenJournalLine.SetExactlyBalanced();
            CreateGenJournalLine.InsertEvaluationEntry(0, CreateGLAccount.BusinessaccountOperatingDomestic(), PostingDate, 0, '');
        end;
    end;
