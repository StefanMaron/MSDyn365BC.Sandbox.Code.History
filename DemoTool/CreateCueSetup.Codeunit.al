codeunit 101971 "Create Cue Setup"
{
    ...
    begin
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Activities Cue",
          ActivitiesCue.FieldNo("Missing SII Entries"),
          Style::Favorable,
          1,// Threshold 1
          Style::Unfavorable,
          2,// Threshold 2
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Activities Cue",
          ActivitiesCue.FieldNo("Days Since Last SII Check"),
          Style::Favorable,
          5,// Threshold 1
          Style::Ambiguous,
          7,// Threshold 2
    ...
    begin
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Finance Cue",
          FinanceCue.FieldNo("Missing SII Entries"),
          Style::Favorable,
          1,// Threshold 1
          Style::Unfavorable,
          2,// Threshold 2
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Finance Cue",
          FinanceCue.FieldNo("Days Since Last SII Check"),
          Style::Favorable,
          5,// Threshold 1
          Style::Ambiguous,
          7,// Threshold 2
    ...
    begin
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Sales Cue",
          SalesCue.FieldNo("Missing SII Entries"),
          Style::Favorable,
          1,// Threshold 1
          Style::Unfavorable,
          2,// Threshold 2
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Sales Cue",
          SalesCue.FieldNo("Days Since Last SII Check"),
          Style::Favorable,
          5,// Threshold 1
          Style::Ambiguous,
          7,// Threshold 2
    ...
    local procedure InsertDataForPurchaseCue()
    var
        PurchaseCue: Record "Purchase Cue";
    begin
        CuesAndKPIs.InsertData(
          DATABASE::"Purchase Cue",
          PurchaseCue.FieldNo("Missing SII Entries"),
          Style::Favorable,
          1,// Threshold 1
          Style::Unfavorable,
          2,// Threshold 2
        ...
        CuesAndKPIs.InsertData(
          DATABASE::"Purchase Cue",
          PurchaseCue.FieldNo("Days Since Last SII Check"),
          Style::Favorable,
          5,// Threshold 1
          Style::Ambiguous,
          7,// Threshold 2
