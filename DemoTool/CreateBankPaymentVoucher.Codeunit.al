codeunit 101282 "Create Bank Payment Voucher"
{
    ...
    procedure InsertDailyEntry(
      ...
      "Document No.": Code[20];
      Description: Text[50];
      "Bal. Account Type": Option;
      "Bal. Account No.": Code[20];
      Amount: Decimal;
      "Shortcut Dimension 1 Code": Code[20];
      "Shortcut Dimension 2 Code": Code[20];
      "Applies-to Doc. Type": Option;
    ...
    begin
        ...
        InitGenJnlLine(GenJournalLine, CurrentJnlBatchName, XDEFAULT);
