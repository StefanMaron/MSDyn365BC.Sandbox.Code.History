codeunit 117001 "Create Service Header"
{
    ...
    begin
        with ServiceHeader do begin
            InsertData("Document Type"::Order, XSO000001, Priority::High, '10000', '', '10000', '', '', 19030106D, 142150T, 0D, 19030106D,
              143017T, 19030106D, 143031T);
            InsertData("Document Type"::Order, XSO000002, Priority::Low, '50000', '', '50000', '', '', 19030109D, 174712T, 0D, 19040521D,
              174712T, 0D, 0T);
        end;
    end;
