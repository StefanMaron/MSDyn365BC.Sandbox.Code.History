codeunit 118838 "Create Dist. Item"
{
    ...
    procedure InsertData(ItemNo: Code[20]; Desc: Text[30]; UnitPrice: Decimal; UnitCost: Decimal; CostingMethod: Integer; GenProdPostingGroup: Code[20]; TaxPostingGroup: Code[20]; InventoryPostingGroup: Code[20]; ReplenishmentSystem: Option; ReorderingPolicy: Option " ","Fixed Reorder Qty","Maximum Qty.","Order","Lot-for-Lot"; IncludeInventory: Boolean; ManufacturingPolicy: Option "Make-to-Stock","Make-to-Order")
    var
        Item: Record Item;
    begin
        with Item do begin
            ...
            Validate("Tax Group Code", TaxPostingGroup);
