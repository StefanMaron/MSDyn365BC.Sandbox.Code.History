codeunit 101997 "Create Item Template"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, RetailCode, BaseVATItemCode(), ResaleCode); // NAVCZ
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, ServicesCode, BaseVATItemCode(), ''); // NAVCZ
            InsertPricingInfo(ConfigTemplateHeader, false);
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, FreightCode, BaseVATItemCode(), ''); // NAVCZ
            InsertPricingInfo(ConfigTemplateHeader, false);
