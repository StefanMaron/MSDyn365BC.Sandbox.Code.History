codeunit 101997 "Create Item Template"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, RetailCode, xHIGHTxt, ResaleCode);
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Inventory), xBaseUOMPCSTxt, NoVATCode, xWITHOUTTxt, ResaleCode);
            InsertPricingInfo(ConfigTemplateHeader, false);

            // Service template
            InsertTemplateHeader(ConfigTemplateHeader, xServiceDescTxt);
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, ServicesCode, xHIGHTxt, '');
            InsertPricingInfo(ConfigTemplateHeader, false);
            ...
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, NoVATCode, xWITHOUTTxt, '');
            InsertPricingInfo(ConfigTemplateHeader, false);

            // Freight template
            InsertTemplateHeader(ConfigTemplateHeader, FreightCode);
            InsertTemplateLines(ConfigTemplateHeader, Format(Item.Type::Service), xBaseUOMHourTxt, FreightCode, xHIGHTxt, '');
            InsertPricingInfo(ConfigTemplateHeader, false);
