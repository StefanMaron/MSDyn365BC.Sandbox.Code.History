    ...
    begin
        ...
        case PostCode of
            ...
            'GB-B27 4KT':
                Return := 'CZ-697 01';
            'GB-B31 2AL':
                Return := 'CZ-696 42'; // Contact xCT200080
            'GB-B68 5TT':
                Return := 'CZ-696 42'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'CZ-696 42'; // Location xYellow
            'GB-CB1 2FB':
                Return := 'CZ-696 42'; // Customer 10000/xAdatumCorporation
            'GB-SE1 0AX':
                Return := 'CZ-696 42'; // Customer 20000/xTreyResearch
            'GB-CV6 1GY':
                Return := 'CZ-696 42'; // Customer 20000
            'GB-CV9 3QN':
                Return := 'CZ-696 42'; // Ship-To-Address 20000/xTWYCROSS
            'GB-DY5 4DJ':
                Return := 'CZ-696 42'; // Ship-toAdress 10000/xDudley
            'GB-EC2A 3JL':
                Return := 'CZ-696 42'; // East Warehouse
            'GB-EH1 3EG':
                Return := 'CZ-697 01'; // Vendor 50000/xNodPublishers
            'GB-EH16 8JS':
                Return := 'CZ-697 01'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'CZ-669 02'; // Customer 40000
            'GB-GL50 1TY':
                Return := 'CZ-669 02'; // Ship-To-Address 10000/xCHELTENHAM
            'GB-GU2 7YQ':
                Return := 'CZ-669 02'; // Customer 50000/xRelecloud
            'GB-GU2 7XH':
                Return := 'CZ-669 02'; // Vendor 20000/xFirstUpConsultatns
            'GB-GU3 2SE':
                Return := 'CZ-696 42'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU52 8DY':
                Return := 'CZ-678 01'; // Ship-To-Address 20000/xFLEET
            'GB-GU7 5GT':
                Return := 'CZ-678 01'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'CZ-669 02'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'CZ-687 71'; // Location xGreen
            'GB-M22 5TG':
                Return := 'CZ-687 71'; // Vendor 40000/xWideWorldImporters
            'GB-M61 2YG':
                Return := 'CZ-687 71'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'CZ-687 71'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'CZ-697 01';
            'GB-N16 34Z':
                Return := 'CZ-697 01'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'CZ-696 42'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-NP10 8BE':
                Return := 'CZ-696 42'; // West Warehouse
            'GB-OX16 0UA':
                Return := 'CZ-696 42'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'CZ-697 01'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'CZ-697 01'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'CZ-687 71'; // Vendor 30000
            'GB-RG6 1WG':
                Return := 'CZ-678 01'; // Main Warehouse
            'GB-TN27 6YD':
                Return := 'CZ-678 01'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'CZ-678 01'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'CZ-697 01'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 6BD':
                Return := 'CZ-696 42'; // Ship-To-Address 10000/xLODNON
            'GB-W2 8HG':
                Return := 'CZ-696 42'; // Company Information
            'GB-WC1 2GS':
                Return := 'CZ-687 71'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'CZ-696 42'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'CZ-678 01'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
