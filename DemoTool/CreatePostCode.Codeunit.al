codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('AT-2405', XHundsheim, '');
        InsertData('AT-3601', XDurnstein, '');
        InsertData('AT-1010', XWien1, '');
        InsertData('AT-3100', XStPolten, '');
        InsertData('AT-4040', XLinz, '');
        InsertData('AT-5020', XSalzburg, '');
        InsertData('AT-6020', XInnsbruck, '');
        InsertData('AT-6900', XBregenz, '');
        InsertData('AT-9020', XKlagenfurt, '');
        InsertData('AT-8010', XGraz, '');
        InsertData('AT-7000', XEisenstadt, '');
        InsertData('AT-9999', XRosenstadt, '');
    end;
    ...
    var
        ...
        XDurnstein: Label 'Dürnstein';
        XWien1: Label 'Wien';
        XStPolten: Label 'St. Pölten';
        XLinz: Label 'Linz';
        XSalzburg: Label 'Salzburg';
        XInnsbruck: Label 'Innsbruck';
        XBregenz: Label 'Bregenz';
        XKlagenfurt: Label 'Klagenfurt';
        XGraz: Label 'Graz';
        XEisenstadt: Label 'Eisenstadt';
        XRosenstadt: Label 'Rosenstadt';
    ...
    begin
        case PostCode of
            ...
            'GB-BS3 6KL':
                Return := 'AT-1010'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'AT-3601'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'AT-1230'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'AT-4040'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'AT-4810'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'AT-6020'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'AT-5020'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'AT-7000'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'AT-1100'; // Location xGreen
            'GB-M61 2YG':
                Return := 'AT-3100'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'AT-4040'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'AT-1010';
            'GB-N16 34Z':
                Return := 'AT-1230'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'AT-1010'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'AT-1010'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'AT-4040'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'AT-1010'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'AT-6900'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'AT-2355'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'AT-1010'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'AT-1010'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'AT-9999'; // Company Information
            'GB-WC1 2GS':
                Return := 'AT-2405'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'AT-8010'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'AT-1010'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
