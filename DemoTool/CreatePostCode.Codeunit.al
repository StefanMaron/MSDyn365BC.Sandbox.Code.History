codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('NL-1705 RE', XArnhem, '');
        InsertData('NL-9877 KR', XWaalwijk, '');
        InsertData('NL-1324 JW', XZaandam, '');
        InsertData('NL-7413 WG', XAmsterdam, '');
        InsertData('NL-3526 XG', XArnhem, '');
        InsertData('NL-6811 GV', XWaalwijk, '');
        InsertData('NL-3872 LL', XZaandam, '');
        InsertData('NL-7201 HW', XAmsterdam, '');
        InsertData('NL-5141 GP', XApeldoorn, '');
        InsertData('NL-6562 XT', XArnhem, '');
        InsertData('NL-1674 CM', XWaalwijk, '');
        InsertData('NL-2574 HV', XZaandam, '');
        InsertData('NL-1053 UT', XAmsterdam, '');
        InsertData('NL-3781 EN', XApeldoorn, '');
        InsertData('NL-2574 HV', XArnhem, '');
        InsertData('NL-2521 BR', XWaalwijk, '');
        InsertData('NL-1066 PQ', XZaandam, '');
        InsertData('NL-6371 GN', XAmsterdam, '');
        InsertData('NL-1017 PT', XApeldoorn, '');
        InsertData('NL-4338 WT', XArnhem, '');
        InsertData('NL-1009 TT', XWaalwijk, '');
        InsertData('NL-8994 RO', XZaandam, '');
        InsertData('NL-1111 DA', XApeldoorn, '');
        InsertData('NL-3772 TG', XAmsterdam, '');
        InsertData('NL-1012 LX', XArnhem, '');
        InsertData('NL-8071 LM', XWaalwijk, '');
    end;
    ...
    begin
        case PostCode of
            ...
            'GB-B27 4KT':
                Return := 'NL-1705 RE'; // NL0001
            'GB-B31 2AL':
                Return := 'GB-B31 2AL'; // Contact xCT200080
            'GB-B68 5TT':
                Return := 'GB-B68 5TT'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'NL-9877 KR'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'NL-1324 JW'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'NL-7413 WG'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'NL-3526 XG'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'NL-6811 GV'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'NL-3872 LL'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'NL-7201 HW'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'NL-5141 GP'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'NL-6562 XT'; // Location xGreen
            'GB-M61 2YG':
                Return := 'NL-1674 CM'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'NL-2574 HV'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            'GB-N12 5XY':
                Return := 'NL-1053 UT';
            'GB-N16 34Z':
                Return := 'NL-3781 EN'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'NL-2574 HV'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'NL-2521 BR'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'NL-1066 PQ'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'NL-6371 GN'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'NL-1017 PT'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'NL-4338 WT'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'NL-1009 TT'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'NL-8994 RO'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'NL-1111 DA'; // Company Information
            'GB-WC1 2GS':
                Return := 'NL-3772 TG'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'NL-1012 LX'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'NL-8071 LM'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-RG6 1WG':
                Return := 'NL-7413 WG'; // Main location
            'GB-EC2A 3JL':
                Return := 'NL-5141 GP'; // East location
            'GB-NP10 8BE':
                Return := 'NL-1324 JW'; // West location
            'GB-GL50 1TY':
                Return := 'NL-7201 HW'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'NL-3781 EN'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'NL-1012 LX'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'NL-8071 LM'; // Ship-toAdress 20000
            'US-FL 37125':
