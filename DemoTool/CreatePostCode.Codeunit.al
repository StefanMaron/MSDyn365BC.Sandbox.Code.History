codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('MX-DF 01030', XMexicoCityDF, '');
        InsertData('MX-DF 06000', XMexicoCityDF, '');
        InsertData('MX-GT 37500', XLeonGuanajuato, '');
        InsertData('MX-NL 64640', XMonterreyNuevoLeon, '');
        InsertData('MX-SL 78030', XSanLuisPotosiSanLuis, '');
        InsertData('MX-SI 82100', XMazatlanSinaloa, '');
    ...
    var
        ...
        XMexicoCityDF: Label 'Mexico City';
        XLeonGuanajuato: Label 'Leon';
        XMonterreyNuevoLeon: Label 'Monterrey';
        XSanLuisPotosiSanLuis: Label 'San Luis Potosi';
        XMazatlanSinaloa: Label 'Mazatlan';
    ...
    begin
        case PostCode of
            ...
            'GB-CV6 1GY':
                Return := 'MX-DF 06000'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'GB-DY5 4DJ'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'GB-EH16 8JS'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'MX-NL 64640'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'MX-DF 06000'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'MX-SI 82100'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'MX-NL 64640'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'GB-L18 6SA'; // Location xGreen
            'GB-M61 2YG':
                Return := 'GB-M61 2YG'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'MX-GT 37500'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-PO7 2HI':
                Return := 'MX-GT 37500'; // Vendor 30000
            'GB-TN27 6YD':
            ...
            'GB-W2 8HG':
                Return := 'MX-DF 01030'; // Company Information
            'GB-WC1 2GS':
            ...
            'GB-WD2 4RG':
                Return := 'MX-SI 82100'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
