codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('US-FL 37125', xHilliard, '');
        ...
        InsertData('DK-5874', XHesselager, '');
        InsertData('DK-2970', XHorsholm, '');
        InsertData('DK-8981', XSpentrup, '');
        InsertData('DK-9900', XKugleby, '');
        InsertData('DK-2600', XGlostrup, '');
        InsertData('DK-1152', XKobenhavnK, '');
        InsertData('DK-4300', XHolbaek, '');
        InsertData('DK-4684', XHolmeOlstrup, '');
        InsertData('DK-2730', XHerlev, '');
        InsertData('DK-2630', XTastrup, '');
        InsertData('DK-1050', XKobenhavnK, '');
        InsertData('DK-5400', XBogense, '');
        InsertData('DK-2860', XSoborg, '');
        InsertData('DK-2300', XKobenhavnS, '');
        InsertData('DK-4913', XHorslunde, '');
        InsertData('DK-2610', XRodovre, '');
    end;
    ...
    var
        ...
        XHesselager: Label 'Hesselager';
        XHorsholm: Label 'Hørsholm';
        XSpentrup: Label 'Spentrup';
        XKugleby: Label 'Kugleby';
        XGlostrup: Label 'Glostrup';
        XKobenhavnK: Label 'København K';
        XHolbaek: Label 'Holbæk';
        XHolmeOlstrup: Label 'Holme-Olstrup';
        XHerlev: Label 'Herlev';
        XTastrup: Label 'Tåstrup';
        XBogense: Label 'Bogense';
        XSoborg: Label 'Søborg';
        XKobenhavnS: Label 'København S';
        XHorslunde: Label 'Horslunde';
        XRodovre: Label 'Rødovre';
        DemoDataSetup: Record "Demo Data Setup";
        xHilliard: Label 'Hilliard';
    ...
    begin
        case PostCode of
            ...
            'GB-BS3 6KL':
                Return := 'DK-4913'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'DK-4300'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'DK-2630'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'DK-4684'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'DK-4684'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'DK-4600'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'DK-2730'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'DK-2100'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'DK-5874'; // Location xGreen
            'GB-M61 2YG':
                Return := 'DK-2730'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'DK-4600'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'DK-1152';
            'GB-N16 34Z':
                Return := 'DK-2970'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'DK-5800'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'DK-1050'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'DK-2630'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'DK-1050'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'DK-2100'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'DK-2970'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'DK-5400'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'DK-2600'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'DK-9900'; // Company Information
            'GB-WC1 2GS':
                Return := 'DK-8981'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'DK-1152'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'DK-4300'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'DK-2860':
                Return := 'DK-2860';     // Employee PS, JR, RL (cod 101600)
            'DK-2300':
                Return := 'DK-2300';     // Employee LM (cod 117562)
            'DK-4913':
                Return := 'DK-4913';     // Alt. Address XAH/XSUMMER (cod 101616)
            'DK-2610':
                Return := 'DK-2610';     // Responsibility Center Birmingham->Rødovre (cod 118020)
                                         // Main location
            'GB-RG6 1WG':
                Return := 'DK-2800';
            'GB-EC2A 3JL':
            ...
            'GB-CV9 3QN':
                ...
                // EVALUATION PACK
            'US-FL 37125':
                Return := 'US-FL 37125'; // Customer 4000 | Post Code xGuilford
            'GB-GU2 7YQ':
                Return := 'GB-GU2 7YQ'; // Customer 5000 | Post Code xGuilford
            'GB-M22 5TG':
                Return := 'GB-M22 5TG'; // Vendor 4000 | Post Code | xManchester
            'US-GA 31772':
                Return := 'US-GA 31772'; // Vendor 5000 | Post Code | XAtlanta
            else
