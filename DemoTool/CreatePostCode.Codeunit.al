codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('ES-46007', XValencia, '', '46');
        InsertData('ES-46026', XValencia, '', '46');
        InsertData('ES-46022', XValencia, '', '46');
        InsertData('ES-46010', XValencia, '', '46');
        InsertData('ES-46018', XValencia, '', '46');
        InsertData('ES-46120', XAlboraya, '', '46');
        InsertData('ES-02005', XAlbacete, '', '02');
        InsertData('ES-08010', XBarcelona, '', '08');
        InsertData('ES-08036', XBarcelona, '', '08');
        InsertData('ES-28001', XMadrid, '', '28');
        InsertData('ES-28003', XMadrid, '', '28');
        InsertData('ES-28004', XMadrid, '', '28');
        InsertData('ES-28010', XMadrid, '', '28');
        InsertData('ES-28023', XMadrid, '', '28');
        InsertData('ES-28028', XMadrid, '', '28');
        InsertData('ES-28223', XPozueloAlarcon, '', '28');
        InsertData('ES-28240', XVillalba, '', '28');
        InsertData('ES-37001', XSalamanca, '', '37');
        InsertData('ES-01001', XGasteiz, '', '01');
        InsertData('ES-01012', XGasteiz, '', '01');
        InsertData('ES-07001', XPalmaMallorca, '', '07');
        InsertData('ES-03003', XAlicante, '', '03');
        InsertData('ES-36004', XPontevedra, '', '36');
        InsertData('ES-50001', XZaragoza, '', '50');
        InsertData('ES-41006', XSevilla, '', '41');
        InsertData('ES-41020', XSevilla, '', '');
        InsertData('ES-10003', XCaceres, '', '10');
        InsertData('ES-47002', XValladolid, '', '47');
        InsertData('ES-09003', XBurgos, '', '');
        InsertData('ES-11011', XCadiz, '', '');
        InsertData('ES-20001', XSanSebastian, '', '');
        InsertData('ES-26006', XLogrono, '', '');
        InsertData('ES-28660', XBoadilladelMonte, '', '');
        InsertData('ES-39004', XSantander, '', '');
    ...
    var
        ...
        XAlboraya: Label 'Alboraya';
        XAlbacete: Label 'Albacete';
        XPozueloAlarcon: Label 'Pozuelo de Alarcon';
        XVillalba: Label 'Villalba';
        XGasteiz: Label 'Gasteiz';
        XBurgos: Label 'Burgos';
        XCadiz: Label 'Cadiz';
        XSanSebastian: Label 'San Sebastian';
        XLogrono: Label 'Logrono';
        XBoadilladelMonte: Label 'Boadilla del Monte';
    ...
    procedure InsertData("Code": Code[20]; City: Text[30]; County: Text[30]; CountyCode: Code[10])
    begin
        "Post Code".Init();
        ...
        "Post Code".Validate("County Code", CountyCode);
        if County <> '' then
        ...
        case PostCode of
            ...
            'GB-B68 5TT':
                Return := 'GB-B68 5TT'; // Contact xCT200079
                                        // 'GB-BS3 6KL': Return := 'GB-BS3 6KL'; // Location xYellow
                                        // 'GB-CV6 1GY' : Return := 'GB-CV6 1GY'; // Customer 20000
                                        // 'GB-DY5 4DJ': Return := 'GB-DY5 4DJ'; // Ship-toAdress 10000/xDudley
                                        // 'GB-EH16 8JS': Return := 'GB-EH16 8JS'; // AltAddress xMH
                                        // 'GB-GL1 9HM': Return := 'GB-GL1 9HM'; // Customer 40000
                                        // 'GB-GU3 2SE': Return := 'GB-GU3 2SE'; // Vendor 20000 | OrderAddress 20000/xJAMES
                                        // 'GB-GU7 5GT': Return := 'GB-GU7 5GT'; // Customer 50000
                                        // 'GB-IB7 7VN': Return := 'GB-IB7 7VN'; // Vendor 40000
                                        // 'GB-L18 6SA': Return := 'GB-L18 6SA'; // Location xGreen
                                        // 'GB-M61 2YG': Return := 'GB-M61 2YG'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
                                        // 'GB-MO2 4RT': Return := 'GB-MO2 4RT'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            'GB-BS3 6KL':
                Return := 'ES-47002'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'ES-46010'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'ES-46026'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'ES-02005'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'ES-28004'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'ES-46022'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'ES-28660'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'ES-20001'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'ES-26006'; // Location xGreen
            'GB-M61 2YG':
                Return := 'ES-47002'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'ES-28028'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
                                      ...
                                      // 'GB-N12 5XY': Return := 'GB-N12 5XY';
                                      // 'GB-N16 34Z': Return := 'GB-N16 34Z'; // Resource xMary | Employee xMD/xLM
                                      // 'GB-NP5 6GH': Return :='GB-NP5 6GH'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
                                      // 'GB-OX16 0UA': Return := 'GB-OX16 0UA'; // Contact xCT100241|xCT100213|CT200035|xCT200130
                                      // 'GB-PE17 4RN': Return := 'GB-PE17 4RN'; // Employee xAH
                                      // 'GB-PO21 6HG': Return := 'GB-PO21 6HG'; // Contact xCT100242|xCT100134|xCT100142|CT200037
                                      // 'GB-PO7 2HI': Return := 'GB-PO7 2HI'; // Vendor 30000
                                      // 'GB-TN27 6YD': Return := 'GB-TN27 6YD'; // Location xRed | Ship-toAdress 20000/xEASTACTON
                                      // 'GB-TQ17 8HB': Return := 'GB-TQ17 8HB'; // Contact xCT100243|xCT100126|xCT100127
                                      // 'GB-W1 3AL': Return := 'GB-W1 3AL'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
                                      // 'GB-W2 8HG': Return := 'GB-W2 8HG'; // Company Information
                                      // 'GB-WC1 2GS': Return := 'GB-WC1 2GS'; // Location xWhite|xSilver
                                      // 'GB-WC1 3DG': Return := 'GB-WC1 3DG'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
                                      // 'GB-WD2 4RG': Return := 'GB-WD2 4RG'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-N12 5XY':
                Return := 'ES-28001';
            'GB-N16 34Z':
                Return := 'ES-28023'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'ES-46120'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'ES-01012'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'ES-36004'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'ES-10003'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'ES-41020'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'ES-28223'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'ES-41006'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'ES-37001'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'ES-28023'; // Company Information
            'GB-WC1 2GS':
                Return := 'ES-28240'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'ES-50001'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'ES-03003'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-GL50 1TY':
                Return := 'ES-28023'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'ES-28240'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'ES-50001'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'ES-03003'; // Ship-toAdress 20000
            'US-FL 37125':
    ...
    procedure FindCounty(PostCode: Code[20]) CountyName: Text[30]
    var
        County: Text[30];
        "Area": Record "Area";
    begin
        if PostCode <> '' then begin
            ...
            "Post Code".SetRange(Code, PostCode);
            "Post Code".Find('-');
            if Area.Get("Post Code"."County Code") then
                County := Area.Text;
        end;
        CountyName := County;
        "Post Code".Reset();
