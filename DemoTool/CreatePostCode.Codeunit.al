codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('DE-59591', XFrankfurtMain, '');
        InsertData('DE-94242', XRegensburg, '');
        InsertData('DE-48436', XDusseldorf, '');
        InsertData('DE-92929', XLuisenberg, '');
        InsertData('DE-29292', XBremen, '');
        InsertData('DE-20203', XHamburg, '');
        InsertData('DE-01238', XDresden, '');
        InsertData('DE-01310', XDresden, '');
        InsertData('DE-43383', XDortmund, '');
        InsertData('DE-99081', XErfurt, '');
        InsertData('DE-59393', XNeustadt, '');
        InsertData('DE-49293', XDiepholz, '');
        InsertData('DE-58585', XHagen, '');
    end;
    ...
    var
        ...
        XRegensburg: Label 'Regensburg';
        XLuisenberg: Label 'Luisenberg';
        XBremen: Label 'Bremen';
        XDresden: Label 'Dresden';
        XDortmund: Label 'Dortmund';
        XErfurt: Label 'Erfurt';
        XNeustadt: Label 'Neustadt';
        XDiepholz: Label 'Diepholz';
        XHagen: Label 'Hagen';
    ...
    begin
        ...
        if DemoDataSetup."Remove Country Prefix" then begin
            ...
            CountryCodeLength := StrPos(PostCode, ' ');
            if (CountryCodeLength = 0) or
               ((StrPos(PostCode, '-') < CountryCodeLength) and (StrPos(PostCode, '-') > 0)) then
                CountryCodeLength := StrPos(PostCode, '-');
            if CountryCodeLength > 0 then begin
                CountryPrefix := CopyStr(PostCode, 1, CountryCodeLength - 1);
                if "Country/Region".Get(CountryPrefix) then
                    PostCode := DelStr(PostCode, 1, CountryCodeLength);
            end;
        end;
    end;
    ...
    begin
        case PostCode of
            ...
            // 'GB-B31 2AL': Return := 'GB-B31 2AL'; // Contact xCT200080
            // 'GB-B68 5TT': Return := 'GB-B68 5TT'; // Contact xCT200079
            ...
            'GB-BS3 6KL':
                Return := 'DE-59591'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'DE-80997'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'DE-48436'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'DE-60320'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'DE-86899'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'DE-01310'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'DE-20097'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'DE-60320'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'DE-94242'; // Location xGreen
            'GB-M61 2YG':
                Return := 'DE-80997'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'DE-43383'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
                                      // Vendor 10000 | Resource xMark|xTIMOTHY | OrderAddress 10000/xHope | 10000/xTHEGROVE
                                      // Employee xMH|XTS | Union ALL | Resource | RespCenter xLondon
                                      // Contact xCT100128|xCT100229
            'GB-N12 5XY':
                Return := 'DE-49293';
            'GB-N16 34Z':
                Return := 'DE-20203'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'DE-99081'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'DE-20097'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'DE-29292'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'DE-40593'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'DE-99081'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'DE-92929'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'DE-59393'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'DE-58585'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'DE-20097'; // Company Information
            'GB-WC1 2GS':
                Return := 'DE-29292'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'GB-WC1 3DG'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'DE-01238'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'DE-22417':
                Return := 'DE-22417';  // Tax Office Post Code in Company Information
                                       // ship to address
            'GB-GL50 1TY':
                Return := 'DE-20097';
            'GB-W2 6BD':
