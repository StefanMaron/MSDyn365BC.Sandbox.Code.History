codeunit 101225 "Create Post Code"
{
    ...
    begin
        case PostCode of
            ...
            'GB-BS3 6KL':
                Return := 'SE-114 32'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'SE-114 32'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'SE-114 32'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'SE-114 32'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'SE-114 32'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'SE-114 32'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'SE-114 32'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'SE-114 32'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'SE-409 99'; // Location xGreen
            'GB-M61 2YG':
                Return := 'SE-114 32'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'SE-114 32'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'SE-114 32';
            'GB-N16 34Z':
                Return := 'SE-114 32'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'SE-114 35'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'SE-411 01'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'SE-114 32'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'SE-114 32'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'SE-114 32'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'SE-114 33'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'SE-114 32'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'SE-114 32'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'SE-415 06'; // Company Information
            'GB-WC1 2GS':
                Return := 'SE-212 16'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'SE-114 32'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'SE-114 32'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-RG6 1WG':
                Return := 'SE-114 32'; // Main location
            'GB-EC2A 3JL':
                Return := 'SE-114 32'; // East location
            'GB-NP10 8BE':
                Return := 'SE-114 32'; // West location
            'GB-GL50 1TY':
                Return := 'SE-415 06'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'SE-212 16'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'SE-114 32'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'SE-114 32'; // Ship-toAdress 20000
            'US-FL 37125':
