codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('US-IL 60611', XChicago, 'IL');
        InsertData('US-NY 11010', XNewYork, 'NY');
        InsertData('US-NY 10022', XNewYork, 'NY');
        InsertData('US-NY 10601', XNewYork, 'NY');
        InsertData('US-NY 11746', XNewYork, 'NY');
        InsertData('US-NY 10019', XNewYork, 'NY');
        InsertData('US-NY 13204', XNewYork, 'NY');
        InsertData('US-NJ 8807', XNewJersey, 'NJ');
        InsertData('US-NJ 7728', XNewJersey, 'NJ');
        InsertData('US-SC 27136', XColombia, 'SC');
        InsertData('US-OR 97223', XPortland, 'OR');
    ...
    begin
        case PostCode of
            ...
            'GB-CV6 1GY':
                Return := 'US-IL 61236'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'GB-DY5 4DJ'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'GB-EH16 8JS'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'US-GA 31772'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'US-IL 61236'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'US-GA 31772'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'US-GA 31772'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'GB-L18 6SA'; // Location xGreen
            'GB-M61 2YG':
                Return := 'GB-M61 2YG'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'US-FL 37125'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-PO7 2HI':
                Return := 'US-FL 37125'; // Vendor 30000
            'GB-TN27 6YD':
            ...
            'GB-W2 8HG':
                Return := 'US-GA 31772'; // Company Information
            'GB-WC1 2GS':
            ...
            'GB-WD2 4RG':
                Return := 'US-GA 31772'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-IL 60611':
                Return := 'US-IL 60611'; // Location xMain
            'US-GA 31772':
                Return := 'US-GA 31772'; // Location xEast
            'US-OR 97223':
                Return := 'US-OR 97223'; // Location xWest
            else
