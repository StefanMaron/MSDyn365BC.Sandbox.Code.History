codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        REPORT.Run(REPORT::"NZ Post Codes", false, false);
        InsertCounty(XNSW, XNewSouthWales);
        InsertCounty(XVIC, XVictoria);
        InsertCounty(XQLD, XQueensland);
        InsertCounty(XWA, XWesternAustralia);
        InsertCounty(XTAS, XTasmania);
        InsertCounty(XSelangor, XSelangor);
        InsertCounty(XKUALALUMPUR, XKUALALUMPUR);
        InsertCounty(XSabah, XSabah);
        InsertCounty(XSarawak, XSarawak);
        InsertCounty(XEdostate, XEdostate);
        InsertCounty(XPlateaustate, XPlateaustate);
        InsertCounty(XBangkok, XBangkok);
        InsertCounty(XChaiNat, XChaiNat);
        InsertCounty(XChiangMai, XChiangMai);
        InsertCounty(XBuriRam, XBuriRam);
        InsertCounty(XNuevoLeon, XNuevoLeon);
        InsertCounty(XGuanajuato, XGuanajuato);
        InsertCounty(XSanLuis, XSanLuis);
        InsertCounty(XSinaloa, XSinaloa);
        InsertData('NZ-9197', XArrowJunction, '');
        InsertData('NZ-3250', XLakeOkareka, '');
        InsertData('NZ-2001', XHamilton, '');
        InsertData('NZ-7953', XHarihari, '');
        InsertData('NZ-3201', XRotorua, '');
        InsertData('NZ-4001', XNapier, '');
        InsertData('NZ-3850', XHicksBay, '');
        InsertData('NZ-9681', XCentreHill, '');
        InsertData('NZ-6003', XBreakerBay, '');
        InsertData('NZ-1872', XKopukuLanding, '');
        InsertData('NZ-7001', XAnnesBrook, '');
        InsertData('NZ-6008', XAlicetown, '');
        InsertData('NZ-6009', XAvalon, '');
        InsertData('NZ-6004', XBroadmeadows, '');
        InsertData('NZ-4601', XBellBlock, '');
        InsertData('NZ-4700', XDouglas, '');
        InsertData('NZ-3001', XBellevue, '');
        InsertData('NZ-1030', XAucklandPostmaster, '');
        InsertData('NZ-6002', XAroValley, '');
        InsertData('NZ-5001', XAramoho, '');
        InsertData('NZ-4851', XManaia, '');
        InsertData('NZ-1015', XAuckland, '');
        ...
        InsertData('AU-2000', XSydney, XNSW);
        InsertData('AU-2500', XWollongong, XNSW);
        InsertData('AU-3000', XMelbourne, XVIC);
        InsertData('AU-4000', XBrisbane, XQLD);
        InsertData('AU-6800', XPerth, XWA);
        InsertData('AU-7178', XMurdunna, XTAS);
        ...
        InsertData('MY-42000', XPELABUHANKLANG, XSelangor);
        InsertData('MY-47400', XPETALINGJAYA, XSelangor);
        InsertData('MY-50450', XAMPANG, XKUALALUMPUR);
        InsertData('MY-57000', XKUALALUMPUR, '');
        InsertData('MY-88100', XKOTAKINABALU, XSabah);
        InsertData('MY-93450', XKUCHING, XSarawak);
        InsertData('MZ-00300', XMaputo, '');
        InsertData('NG-300001', XBENIN, XEdostate);
        InsertData('NG-900001', XABUJA, '');
        InsertData('NG-930283', XJOS, XPlateaustate);
        InsertData('NG-931104', XGHOH, XPlateaustate);
        ...
        InsertData('TH-10260', XBangNa, XBangkok);
        InsertData('TH-10500', XBangRak, XBangkok);
        InsertData('TH-10510', XKhlongSamwa, XBangkok);
        InsertData('TH-17120', XWatSing, XChaiNat);
        InsertData('TH-31260', XNonDindaeng, XBuriRam);
        InsertData('TH-50120', XSanPaTong, XChiangMai);
        ...
        InsertData('US-FL 37125', XMiami, '');
        InsertData('US-GA 31772', XAtlanta, '');
        ...
        InsertData('MX-37500', XLeon, XGuanajuato);
        InsertData('MX-64640', XMonterrey, XNuevoLeon);
        InsertData('MX-78030', XSanLuisPotosi, XSanLuis);
        InsertData('MX-82100', XMazatlan, XSinaloa);
    ...
    var
        ...
        XNSW: Label 'NSW';
        XNewSouthWales: Label 'New South Wales';
        XVIC: Label 'VIC';
        XVictoria: Label 'Victoria';
        XQLD: Label 'QLD';
        XQueensland: Label 'Queensland';
        XWA: Label 'WA';
        XWesternAustralia: Label 'Western Australia';
        XTAS: Label 'TAS';
        XTasmania: Label 'Tasmania';
        XSelangor: Label 'Selangor';
        XSabah: Label 'Sabah';
        XSarawak: Label 'Sarawak';
        XEdostate: Label 'Edo state';
        XPlateaustate: Label 'Plateau state';
        XBangkok: Label 'Bangkok';
        XChaiNat: Label 'Chai Nat';
        XChiangMai: Label 'Chiang Mai';
        XBuriRam: Label 'Buri Ram';
        XNuevoLeon: Label 'Nuevo Leon';
        XGuanajuato: Label 'Guanajuato';
        XSanLuis: Label 'San Luis';
        XSinaloa: Label 'Sinaloa';
        XSydney: Label 'Sydney';
        XWollongong: Label 'Wollongong';
        XMelbourne: Label 'Melbourne';
        XBrisbane: Label 'Brisbane';
        XPerth: Label 'Perth';
        XMurdunna: Label 'Murdunna';
        XPELABUHANKLANG: Label 'PELABUHAN KLANG';
        XPETALINGJAYA: Label 'PETALING JAYA';
        XAMPANG: Label 'AMPANG';
        XKOTAKINABALU: Label 'KOTAKINA BALU';
        XKUCHING: Label 'KUCHING';
        XBENIN: Label 'BENIN';
        XJOS: Label 'JOS';
        XGHOH: Label 'GHOH';
        XBangNa: Label 'Bang Na';
        XBangRak: Label 'Bang Rak';
        XKhlongSamwa: Label 'Khlong Samwa';
        XWatSing: Label 'Wat Sing';
        XNonDindaeng: Label 'Non Dindaeng';
        XSanPaTong: Label 'San Pa Tong';
        XLeon: Label 'Leon';
        XMonterrey: Label 'Monterrey';
        XSanLuisPotosi: Label 'San Luis Potosi';
        XMazatlan: Label 'Mazatlan';
        XArrowJunction: Label 'Arrow Junction';
        XLakeOkareka: Label 'Lake Okareka';
        XHamilton: Label 'Hamilton';
        XHarihari: Label 'Harihari';
        XRotorua: Label 'Rotorua';
        XNapier: Label 'Napier';
        XHicksBay: Label 'Hicks Bay';
        XCentreHill: Label 'Centre Hill';
        XBreakerBay: Label 'Breaker Bay';
        XKopukuLanding: Label 'Kopuku Landing';
        XAnnesBrook: Label 'Annes Brook';
        XAlicetown: Label 'Alicetown';
        XAvalon: Label 'Avalon';
        XBroadmeadows: Label 'Broadmeadows';
        XBellBlock: Label 'Bell Block';
        XDouglas: Label 'Douglas';
        XBellevue: Label 'Bellevue';
        XAucklandPostmaster: Label 'Auckland Postmaster';
        XAroValley: Label 'Aro Valley';
        XAramoho: Label 'Aramoho';
        XManaia: Label 'Manaia';
    ...
    begin
        case PostCode of
            ...
            'GB-B27 4KT':
                Return := 'NZ-9197';
            'GB-B31 2AL':
                Return := 'NZ-3250'; // Contact xCT200080
            'GB-B68 5TT':
                Return := 'NZ-3250'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'NZ-2001'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'NZ-8001'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'NZ-6003'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'NZ-1872'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'NZ-3850'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'NZ-7001'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'NZ-9681'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'NZ-6008'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'NZ-7953'; // Location xGreen
            'GB-M61 2YG':
                Return := 'NZ-6004'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'NZ-3250'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'NZ-1030';
            'GB-N16 34Z':
                Return := 'NZ-1001'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'NZ-4700'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'NZ-4601'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'NZ-6002'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'NZ-4601'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'NZ-6009'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'NZ-4001'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'NZ-3001'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'NZ-5001'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'NZ-1015'; // Company Information
            'GB-WC1 2GS':
                Return := 'NZ-3201'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'NZ-4851'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'NZ-7001'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
