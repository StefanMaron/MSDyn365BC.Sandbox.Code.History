codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('CA-MB R0M 0N0', XElkhorn, 'MB');
        InsertData('CA-ON L6J 3J3', XOakville, 'ON');
        InsertData('CA-ON M5E 1G5', XToronto, 'ON');
        InsertData('CA-ON N6B 1V7', XLondon, 'ON');
        InsertData('CA-ON P7A 4K8', XThunderBay, 'ON');
        InsertData('CA-ON P7B 5E2', XThunderBay, 'ON');
        InsertData('CA-MB R3C 3Z3', XWinnipeg, 'MB');
        InsertData('CA-ON L5N 8L9', XMissisauga, 'ON');
        InsertData('CA-ON K1P 1J9', XOttawa, 'ON');
        InsertData('CA-ON M5B 2H1', XOttawa, 'ON');
        InsertData('CA-ON L5B 2C9', XMissisauga, 'ON');
        InsertData('CA-BC V5H 4J2', XVancouver, 'BC');
        InsertData('CA-AB T2P 0T1', XCalgary, 'AB');
        InsertData('CA-AB T2H 0K8', XCalgary, 'AB');
        InsertData('CA-AB T5T 4J2', XCalgary, 'AB');
        InsertData('CA-BC V6B 1C1', XVancouver, 'BC');
        InsertData('CA-BC V6E 4M3', XVancouver, 'BC');
        InsertData('CA-BC V7Y 1L1', XVancouver, 'BC');
        InsertData('CA-BC V7Y 1GS', XVancouver, 'BC');
        InsertData('CA-BC V7Y 1G5', XVancouver, 'BC');
        InsertData('CA-ON M5K 1E7', XToronto, 'ON');
        InsertData('CA-ON M5N 2H1', XToronto, 'ON');
        InsertData('CA-ON M6A 3A1', XToronto, 'ON');
        InsertData('CA-AB T5J 4G8', XEdmonton, 'AB');
        InsertData('CA-QC H3A 3H3', XMontreal, 'QC');
        ...
        InsertData('US-AL 35242', XBirmingham, 'AL');
        InsertData('US-FL 37125', XMiami, 'FL');
        InsertData('US-GA 31772', XAtlanta, 'GA');
        InsertData('US-IL 61236', XChicago, 'IL');
        InsertData('US-NY 11010', XNewYork, 'NY');
        InsertData('US-SC 27136', XColombia, 'SC');
    ...
    var
        ...
        XWinnipeg: Label 'Winnipeg';
        XMissisauga: Label 'Missisauga';
        XOttawa: Label 'Ottawa';
        XCalgary: Label 'Calgary';
        XVancouver: Label 'Vancouver';
        XEdmonton: Label 'Edmonton';
        XMontreal: Label 'Montreal';
    ...
    begin
        case PostCode of
            ...
            'GB-CV6 1GY':
                Return := 'CA-ON L5N 8L9'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'GB-DY5 4DJ'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'GB-EH16 8JS'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'CA-AB T2P 0T1'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'CA-AB T5J 4G8'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'CA-BC V6B 1C1'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'CA-BC V7Y 1L1'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'GB-L18 6SA'; // Location xGreen
            'GB-M61 2YG':
                Return := 'GB-M61 2YG'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'CA-ON K1P 1J9'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-PO7 2HI':
                Return := 'CA-BC V6E 4M3'; // Vendor 30000
            'GB-TN27 6YD':
            ...
            'GB-W2 8HG':
                Return := 'CA-ON M5E 1G5'; // Company Information
            'GB-WC1 2GS':
            ...
            'GB-WD2 4RG':
                Return := 'CA-QC H3A 3H3'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'CA-ON M5N 2H1':
                Return := 'CA-ON M5N 2H1'; // Location xMain
            'CA-ON M6A 3A1':
                Return := 'CA-ON M6A 3A1'; // Location xEast
            'CA-BC V7Y 1G5':
                Return := 'CA-BC V7Y 1G5'; // Location xWest
            else
