codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('FI-40530', XHelsinki, '');
        InsertData('FI-83500', XHelsinki, '');
        InsertData('FI-33200', XHelsinki, '');
        InsertData('FI-67100', XHelsinki, '');
        InsertData('FI-50500', XHelsinki, '');
        InsertData('FI-10300', XHelsinki, '');
        InsertData('FI-45160', XHelsinki, '');
        InsertData('FI-02170', XHelsinki, '');
        InsertData('FI-60320', XHelsinki, '');
        InsertData('FI-02300', XHelsinki, '');
        InsertData('FI-20100', XHelsinki, '');
        InsertData('FI-00170', XHelsinki, '');
        InsertData('FI-23500', XHelsinki, '');
        InsertData('FI-94200', XHelsinki, '');
        InsertData('FI-66900', XHelsinki, '');
        InsertData('FI-37600', XHelsinki, '');
        InsertData('FI-33470', XHelsinki, '');
        InsertData('FI-95600', XHelsinki, '');
        InsertData('FI-01201', XHelsinki, '');
        InsertData('FI-90100', XHelsinki, '');
        InsertData('FI-80100', XHelsinki, '');
        InsertData('FI-57810', XHelsinki, '');
    ...
    begin
        case PostCode of
            ...
            'GB-BS3 6KL':
                Return := 'FI-83500'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'FI-33200'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'FI-67100'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'FI-50500'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'FI-10300'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'FI-45160'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'FI-02170'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'FI-60320'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'FI-02300'; // Location xGreen
            'GB-M61 2YG':
                Return := 'FI-33200'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'FI-20100'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'FI-00170';
            'GB-N16 34Z':
                Return := 'FI-00170'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'FI-23500'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'FI-94200'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'FI-00100'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'FI-66900'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'FI-37600'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'FI-33470'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'FI-95600'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'FI-00100'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'FI-01201'; // Company Information
            'GB-WC1 2GS':
                Return := 'FI-90100'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'FI-80100'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'FI-57810'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-RG6 1WG':
                Return := 'FI-33470'; // Main location
            'GB-EC2A 3JL':
                Return := 'FI-95600'; // East location
            'GB-NP10 8BE':
                Return := 'FI-00100'; // West location
            'GB-GL50 1TY':
                Return := 'FI-01201'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'FI-90100'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'FI-80100'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'FI-57810'; // Ship-toAdress 20000
            'US-FL 37125':
