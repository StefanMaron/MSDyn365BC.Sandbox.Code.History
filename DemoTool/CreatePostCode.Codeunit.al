codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        //BEGIN IT
        InsertData('IT-57100', XLivorno, '');
        InsertData('IT-16011', XArenzano, '');
        InsertData('IT-16100', XGenova, '');
        InsertData('IT-16143', XGenova, '');
        InsertData('IT-19100', XLaSpezia, '');
        InsertData('IT-20099', XSestoSanGiovanni, '');
        InsertData('IT-20147', XMilano, '');
        InsertData('IT-21047', XVarese, '');
        InsertData('IT-26100', XCremona, '');
        InsertData('IT-35100', XPadova, '');
        InsertData('IT-37100', XVerona, '');
        InsertData('IT-42100', XReggioEmilia, '');
        InsertData('IT-43100', XParma, '');
        InsertData('IT-62100', XMacerata, '');
        InsertData('IT-67100', XLAquila, '');
        InsertData('IT-80100', XNapoli, '');
        InsertData('IT-90100', XPalermo, '');
        //END IT
    end;
    ...
    var
        ...
        XROMARM: Label 'Roma';
        XTORINOTO: Label 'Torino';
        XMILANOMI: Label 'Milano';
        XBOLZANOBZ: Label 'Bolzano';
        XSANTAVENERANDAPS: Label 'Santa Veneranda';
        XPESCINAAQ: Label 'Pescina';
        ...
        XArenzano: Label 'Arenzano';
        XGenova: Label 'Genova';
        XLaSpezia: Label 'La Spezia';
        XSestoSanGiovanni: Label 'Sesto San Giovanni';
    ...
    begin
        case PostCode of
            ...
            'GB-B68 5TT':
                Return := 'IT-10100'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'IT-62100'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'IT-26100'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'IT-35100'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'IT-67100'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'IT-20147'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'IT-80100'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'IT-37100'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'IT-42100'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'IT-16143'; // Location xGreen
            'GB-M61 2YG':
                Return := 'IT-19100'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'IT-16100'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'IT-20100';
            'GB-N16 34Z':
                Return := 'IT-80100'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'IT-21047'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'IT-20099'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'IT-39100'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'GB-PO21 6HG'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'IT-00100'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'IT-10100'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'IT-43100'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'IT-20100'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'IT-20100'; // Company Information
            'GB-WC1 2GS':
                Return := 'IT-90100'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'IT-57100'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'IT-16011'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-GL50 1TY':
                Return := 'IT-20100'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'IT-90100'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'IT-57100'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'IT-16011'; // Ship-toAdress 20000
            'US-FL 37125':
    ...
    procedure GetCountryPrefix(PostCode: Code[20]): Code[10]
    begin
        // IT
        DemoDataSetup.Get();
        CountryCodeLength := StrLen(DemoDataSetup."Country/Region Code");
        if (StrPos(PostCode, ' ') <> 0) or (StrPos(PostCode, '-') <> 0) then
            exit(CopyStr(PostCode, 1, CountryCodeLength))
        else
            exit('');
    end;
}
