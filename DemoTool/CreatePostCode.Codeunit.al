codeunit 101225 "Create Post Code"
{
    ...
    begin
        case PostCode of
            ...
            'GB-BS3 6KL':
                Return := 'NO-5003'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'NO-1300'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'NO-2000'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'NO-5003'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'NO-3001'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'NO-0001'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'NO-6001'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'NO-8001'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'NO-5003'; // Location xGreen
            'GB-M61 2YG':
                Return := 'NO-1300'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'NO-9001'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'NO-5003';
            'GB-N16 34Z':
                Return := 'NO-5003'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'NO-1344'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'NO-1368'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'NO-6501'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'NO-1371'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'NO-2000'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'NO-9001'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'NO-1400'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'NO-6001'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'NO-0102'; // Company Information
            'GB-WC1 2GS':
                Return := 'NO-0001'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'NO-6100'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'NO-1001'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-RG6 1WG':
                Return := 'NO-9001'; // Main location
            'GB-EC2A 3JL':
                Return := 'NO-1400'; // East location
            'GB-NP10 8BE':
                Return := 'NO-6001'; // West location
            'GB-GL50 1TY':
                Return := 'NO-0102'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'NO-0001'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'NO-6100'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'NO-1001'; // Ship-toAdress 20000
            'US-FL 37125':
