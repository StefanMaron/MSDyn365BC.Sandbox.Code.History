codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertCounty(XSA, XSouthAustralia);
        InsertCounty(XWA, XWesternAustralia);
        InsertCounty(XNT, XNorthernTerritory);
        ...
        InsertData('AU-2600', XBARTON, XNSW);
        InsertData('AU-8507', XCARLTON, XVIC);
        InsertData('AU-4207', XALBERTON, XQLD);
        InsertData('AU-4151', XCOORPAROO, XQLD);
        InsertData('AU-4006', XNEWSTEAD, XNSW);
        InsertData('AU-2000', XDARLINGHARBOUR, XNSW);
        InsertData('AU-2600', XCANBERRA, XNSW);
        InsertData('AU-4163', XRABYBAY, XQLD);
        InsertData('AU-3003', XWESTMELBOURNE, XVIC);
        InsertData('AU-3002', XEASTMELBOURNE, XVIC);
        InsertData('AU-4163', XCLEVELAND, XQLD);
        InsertData('AU-2218', XCARLTON, XNSW);
        InsertData('AU-2360', XNEWSTEAD, XNSW);
        InsertData('AU-4006', XBOWENBRIDGE, XQLD);
    ...
    var
        ...
        XSA: Label 'SA';
        XSouthAustralia: Label 'South Australia';
        XWesternAustralia: Label 'Western Australia';
        XNT: Label 'NT';
        XNorthernTerritory: Label 'Northern Territory';
        XTasmania: Label 'Tasmania';
        XACT: Label 'ACT';
        XAustralianCapitolTerritory: Label 'Australian Capitol Territory';
        XADELAIDE: Label 'ADELAIDE';
        XSWANBOURNE: Label 'SWANBOURNE';
        XBARTON: Label 'XBARTON';
        XCARLTON: Label 'CARLTON';
        XALBERTON: Label 'ALBERTON';
        XCOORPAROO: Label 'COORPAROO';
        XNEWSTEAD: Label 'NEWSTEAD';
        XDARLINGHARBOUR: Label 'DARLING HARBOUR';
        XCANBERRA: Label 'CANBERRA';
        XRABYBAY: Label 'RABY BAY';
        XWESTMELBOURNE: Label 'WEST MELBOURNE';
        XEASTMELBOURNE: Label 'EAST MELBOURNE';
        XCLEVELAND: Label 'CLEVELAND';
        XBOWENBRIDGE: Label 'BOWEN BRIDGE';
    ...
    begin
        case PostCode of
            ...
            'GB-B27 4KT':
                Return := 'AU-5000';
            'GB-B31 2AL':
                Return := 'AU-2000'; // Contact xCT200080
            'GB-B68 5TT':
                Return := 'AU-2000'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'AU-4000'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'AU-6800'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'AU-6010'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'AU-2600'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'AU-8507'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'AU-4207'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'AU-7178'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'AU-4151'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'AU-4006'; // Location xGreen
            'GB-M61 2YG':
                Return := 'AU-6800'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'AU-2000'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'AU-2600';
            'GB-N16 34Z':
                Return := 'AU-2600'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'AU-4163'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'AU-3003'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'AU-2600'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'AU-3002'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'AU-4163'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'AU-2000'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'AU-2218'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'AU-2600'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'AU-2600'; // Company Information
            'GB-WC1 2GS':
                Return := 'AU-2360'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'AU-4006'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'AU-3002'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
