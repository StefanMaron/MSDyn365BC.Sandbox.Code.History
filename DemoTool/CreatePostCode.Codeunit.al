codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        UpdateDemoDataSetupCountryCode('IN');
        ...
        InsertData('IN-121006', XFaridabad, '');
        InsertData('IN-110075', XNewDelhi, '');
        InsertData('IN-201309', XNoida, '');
        InsertData('IN-122001', XGurugram, '');
        ...
        InsertData('IN-110001', XNewDelhi, '');
        InsertData('IN-110002', XNewDelhi, '');
        InsertData('IN-122002', XGurugram, '');
        InsertData('IN-110003', XNewDelhi, '');
        InsertData('IN-110004', XNewDelhi, '');
        InsertData('IN-110005', XNewDelhi, '');
    end;
    ...
    procedure UpdateDemoDataSetupCountryCode(CountryCode: Code[10])
    var
        DemoDataSetup: Record "Demo Data Setup";
    begin
        DemoDataSetup.Get();
        if DemoDataSetup."Country/Region Code" <> CountryCode then begin
            DemoDataSetup."Country/Region Code" := CountryCode;
