codeunit 101225 "Create Post Code"
{
    ...
    begin
        ...
        InsertData('FR-10000', 'Troyes', '');
        InsertData('FR-11000', 'Carcassonne', '');
        InsertData('FR-12000', 'Rodez', '');
        InsertData('FR-13000', 'Marseille', '');
        InsertData('FR-14000', 'Caen', '');
        InsertData('FR-15000', 'Aurillac', '');
        InsertData('FR-16000', 'Angoulème', '');
        InsertData('FR-17000', 'La Rochelle', '');
        InsertData('FR-18000', 'Bourges', '');
        InsertData('FR-19000', 'Tulle', '');
        InsertData('FR-21000', 'Dijon', '');
        InsertData('FR-22000', 'St.-Brieuc', '');
        InsertData('FR-23000', 'Guéret', '');
        InsertData('FR-24000', 'Périgueux', '');
        InsertData('FR-25000', 'Besançon', '');
        InsertData('FR-26000', 'Valence', '');
        InsertData('FR-27000', 'Evreux', '');
        InsertData('FR-28000', 'Chartres', '');
        InsertData('FR-28100', 'Chartres', '');
        InsertData('FR-28200', 'Chartres', '');
        InsertData('FR-28300', 'Chartres', '');
        InsertData('FR-29000', 'Quimper', '');
        InsertData('FR-30000', 'Nîmes', '');
        InsertData('FR-31000', 'Toulouse', '');
        InsertData('FR-32000', 'Auch', '');
        InsertData('FR-33000', 'Bordeaux', '');
        InsertData('FR-34000', 'Montpellier', '');
        InsertData('FR-35000', 'Rennes', '');
        InsertData('FR-36000', 'Châteauroux', '');
        InsertData('FR-37000', 'Tours', '');
        InsertData('FR-38000', 'Grenoble', '');
        InsertData('FR-39000', 'Lons-le-Saunier', '');
        InsertData('FR-40000', 'Mont-de-Marsan', '');
        InsertData('FR-41000', 'Blois', '');
        InsertData('FR-42000', 'St.-Etienne', '');
        InsertData('FR-43000', 'Le Puy', '');
        InsertData('FR-44000', 'Nantes', '');
        InsertData('FR-44450', 'La Chapelle basse Mer', '');
        InsertData('FR-45100', 'Olivet', '');
        InsertData('FR-46000', 'Cahors', '');
        InsertData('FR-47000', 'Agen', '');
        InsertData('FR-48000', 'Mende', '');
        InsertData('FR-49000', 'Angers', '');
        InsertData('FR-50000', 'St.-Lo', '');
        InsertData('FR-50670', 'Cassel', '');
        InsertData('FR-51000', 'Châlons-sur-Marne', '');
        InsertData('FR-52000', 'Chaumont', '');
        InsertData('FR-53000', 'Laval', '');
        InsertData('FR-53100', 'Laval', '');
        InsertData('FR-53200', 'Laval', '');
        InsertData('FR-53300', 'Laval', '');
        InsertData('FR-54000', 'Nancy', '');
        InsertData('FR-55000', 'Bar-le-Duc', '');
        InsertData('FR-56000', 'Vannes', '');
        InsertData('FR-57000', 'Metz', '');
        InsertData('FR-58000', 'Nevers', '');
        InsertData('FR-59000', 'Lille', '');
        InsertData('FR-60000', 'Beauvais', '');
        InsertData('FR-61000', 'Alençon', '');
        InsertData('FR-62000', 'Arras', '');
        InsertData('FR-63000', 'Clermont-Ferrand', '');
        InsertData('FR-64000', 'Pau', '');
        InsertData('FR-65000', 'Tarbes', '');
        InsertData('FR-66000', 'Perpignan', '');
        InsertData('FR-67000', 'Strasbourg', '');
        InsertData('FR-67200', 'Strasbourg', '');
        InsertData('FR-67550', 'Vendenheim', '');
        InsertData('FR-68000', 'Colmar', '');
        InsertData('FR-69000', 'Lyon', '');
        InsertData('FR-69002', 'Lyon', '');
        InsertData('FR-70000', 'Vesoul', '');
        InsertData('FR-71000', 'Mâcon', '');
        InsertData('FR-72000', 'Le Mans', '');
        InsertData('FR-73000', 'Chambéry', '');
        InsertData('FR-74000', 'Annecy', '');
        InsertData('FR-75000', 'Paris', '');
        InsertData('FR-75001', 'Paris', '');
        InsertData('FR-75002', 'Paris', '');
        InsertData('FR-75003', 'Paris', '');
        InsertData('FR-75004', 'Paris', '');
        InsertData('FR-75005', 'Paris', '');
        InsertData('FR-75006', 'Paris', '');
        InsertData('FR-75007', 'Paris', '');
        InsertData('FR-75008', 'Paris', '');
        InsertData('FR-75009', 'Paris', '');
        InsertData('FR-75010', 'Paris', '');
        InsertData('FR-75011', 'Paris', '');
        InsertData('FR-75012', 'Paris', '');
        InsertData('FR-75013', 'Paris', '');
        InsertData('FR-75014', 'Paris', '');
        InsertData('FR-75015', 'Paris', '');
        InsertData('FR-75016', 'Paris', '');
        InsertData('FR-75017', 'Paris', '');
        InsertData('FR-75018', 'Paris', '');
        InsertData('FR-75019', 'Paris', '');
        InsertData('FR-75020', 'Paris', '');
        InsertData('FR-76000', 'Rouen', '');
        InsertData('FR-77000', 'Melun', '');
        InsertData('FR-77450', 'Esbly', '');
        InsertData('FR-78000', 'Versailles', '');
        InsertData('FR-78370', 'Plaisir', '');
        InsertData('FR-79000', 'Niort', '');
        InsertData('FR-80000', 'Amiens', '');
        InsertData('FR-81000', 'Albi', '');
        InsertData('FR-82000', 'Montauban', '');
        InsertData('FR-83000', 'Toulon', '');
        InsertData('FR-83250', 'La Londe les Maures', '');
        InsertData('FR-84000', 'Avignon', '');
        InsertData('FR-85000', 'La Roche-sur-Yon', '');
        InsertData('FR-86000', 'Poitiers', '');
        InsertData('FR-87000', 'Limoges', '');
        InsertData('FR-88100', 'Epinal', '');
        InsertData('FR-89000', 'Auxerre', '');
        InsertData('FR-89100', 'Auxerre', '');
        InsertData('FR-89200', 'Auxerre', '');
        InsertData('FR-89300', 'Auxerre', '');
        InsertData('FR-90000', 'Belfort', '');
        InsertData('FR-02200', 'Venizel', '');
        InsertData('FR-29200', 'Brest', '');
        InsertData('FR-13200', 'Arles', '');
        InsertData('FR-69001', 'Lyon', '');
        InsertData('FR-69006', 'Lyon', '');
    end;
    ...
    begin
        case PostCode of
            ...
            'GB-B27 4KT':
                Return := 'FR-69001';
            'GB-B31 2AL':
                Return := 'FR-59000'; // Contact xCT200080
            'GB-B68 5TT':
                Return := 'FR-21000'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'FR-75008'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'FR-37000'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'FR-75008'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'FR-69006'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'FR-75008'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'FR-44000'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'FR-75008'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'FR-44000'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'FR-69002'; // Location xGreen
            'GB-M61 2YG':
                Return := 'FR-13200'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'FR-44000'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'FR-75000';
            'GB-N16 34Z':
                Return := 'FR-75008'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'FR-43000'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'FR-75005'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'FR-29200'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'FR-67000'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'FR-75008'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'FR-44000'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'FR-75012'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'FR-02200'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'FR-75008'; // Company Information
            'GB-WC1 2GS':
                Return := 'FR-44000'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'FR-75015'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'FR-33000'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'GB-RG6 1WG':
                Return := 'FR-75010'; // Main location
            'GB-EC2A 3JL':
                Return := 'FR-21000'; // East location
            'GB-NP10 8BE':
                Return := 'FR-33000'; // West location
            'GB-GL50 1TY':
                Return := 'FR-75008'; // Ship-toAdress 10000
            'GB-W2 6BD':
                Return := 'FR-75009'; // Ship-toAdress 10000
            'GB-GU52 8DY':
                Return := 'FR-44000'; // Ship-toAdress 20000
            'GB-CV9 3QN':
                Return := 'FR-54000'; // Ship-toAdress 20000
            'US-FL 37125':
