codeunit 101225 "Create Post Code"
{
    ...
    var
        ImportPostcode: Report "Import Post Codes";
        PostCodesDemoData: XMLport "Post Codes Demo Data";
        IStr: InStream;
        File: File;
        FileName: Text;
    begin
        ImportPostcode.ImportPostCodes('localfiles\Post_Adressdaten.csv');
    ...
    begin
        case PostCode of
            ...
            'GB-B68 5TT':
                Return := 'CH-6055'; // Contact xCT200079
            'GB-BS3 6KL':
                Return := 'CH-3098'; // Location xYellow
            'GB-CV6 1GY':
                Return := 'CH-6045'; // Customer 20000
            'GB-DY5 4DJ':
                Return := 'CH-4005'; // Ship-toAdress 10000/xDudley
            'GB-EH16 8JS':
                Return := 'GB-EH16 8JS'; // AltAddress xMH
            'GB-GL1 9HM':
                Return := 'CH-6002'; // Customer 40000
            'GB-GU3 2SE':
                Return := 'CH-6110'; // Vendor 20000 | OrderAddress 20000/xJAMES
            'GB-GU7 5GT':
                Return := 'CH-6060'; // Customer 50000
            'GB-IB7 7VN':
                Return := 'CH-6275'; // Vendor 40000
            'GB-L18 6SA':
                Return := 'CH-3600'; // Location xGreen
            'GB-M61 2YG':
                Return := 'CH-6330'; // Contact xCT100239|xCT100125|xCT100187|xCT100188
            'GB-MO2 4RT':
                Return := 'CH-6055'; // Customer 30000 | Ship-toAdress 20000/xMANCHESTER
            ...
            'GB-N12 5XY':
                Return := 'CH-3000';
            'GB-N16 34Z':
                Return := 'CH-6275'; // Resource xMary | Employee xMD/xLM
            'GB-NP5 6GH':
                Return := 'CH-6343'; // Contact xCT100240|xCT100124|xCT100147|xCT100176
            'GB-OX16 0UA':
                Return := 'CH-6405'; // Contact xCT100241|xCT100213|CT200035|xCT200130
            'GB-PE17 4RN':
                Return := 'CH-8400'; // Employee xAH
            'GB-PO21 6HG':
                Return := 'CH-6440'; // Contact xCT100242|xCT100134|xCT100142|CT200037
            'GB-PO7 2HI':
                Return := 'CH-6244'; // Vendor 30000
            'GB-TN27 6YD':
                Return := 'CH-4133'; // Location xRed | Ship-toAdress 20000/xEASTACTON
            'GB-TQ17 8HB':
                Return := 'CH-6900'; // Contact xCT100243|xCT100126|xCT100127
            'GB-W1 3AL':
                Return := 'CH-3000'; // BankAccount xNBL|XGIRO | Employee xPS/xJR/xRL / Contact xCT100237
            'GB-W2 8HG':
                Return := 'CH-6300'; // Company Information
            'GB-WC1 2GS':
                Return := 'CH-5600'; // Location xWhite|xSilver
            'GB-WC1 3DG':
                Return := 'CH-6300'; // BankAccount xWWBEUR|XWWBOPERATING|XWWBUSD | Contact xCT100159|xCT100170
            'GB-WD2 4RG':
                Return := 'CH-6033'; // Vendor 50000 | OrderAddress 20000/xWATFORD | Contact xCT100162|xCT200046|xCT200068
            'US-FL 37125':
