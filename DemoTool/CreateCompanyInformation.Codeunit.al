codeunit 101079 "Create Company Information"
{
    ...
    begin
        ...
        InsertSWIFTCode('DBASBANO00ABC', XWorldWideBank);
        CompanyInformation.Validate("SWIFT Code", 'DBASBANO00ABC');
        ...
        CompanyInformation."VAT Registration No." := 'NO 777 777 777';
    ...
    local procedure InsertSWIFTCode("Code": Code[20]; Name: Text[100])
    var
