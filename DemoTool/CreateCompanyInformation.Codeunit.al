codeunit 101079 "Create Company Information"
{
    ...
    var
        ...
        X53001003000: Label '53001003000';
    ...
    begin
        ...
        if PostCode.Get(CompanyInformation."Post Code", CompanyInformation.City) then
            CompanyInformation.County := PostCode.County;
        ...
        PostCode.Reset();
        if PostCode.Get(CompanyInformation."Ship-to Post Code", CompanyInformation."Ship-to City") then
            CompanyInformation."Ship-to County" := PostCode.County;
        CompanyInformation.Validate(ABN, X53001003000);
