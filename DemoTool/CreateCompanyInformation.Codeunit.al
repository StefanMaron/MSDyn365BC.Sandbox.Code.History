codeunit 101079 "Create Company Information"
{
    ...
    var
        ...
        XCRONUSInternationalLtd: Label 'CRONUS DK Ltd.';
        XCRONUSMiniInternationalLtdTxt: Label 'CRONUS Danmark', Comment = 'Should be localized. E.g. In DK should be CRONUS Danmark.';
    ...
    begin
        ...
        CompanyInformation."VAT Registration No." := 'DK77777777';
        CompanyInformation."Registration No." := '12345678';
