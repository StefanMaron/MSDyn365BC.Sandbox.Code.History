codeunit 101079 "Create Company Information"
{
    ...
    var
        ...
        X2041746010022: Label '2041746010022';
        XRCSParis: Label 'R.C.S. : Paris';
        X361C: Label '361C';
        XSA: Label 'SA';
        X115000Euros: Label '115.000 Euros';
    ...
    begin
        ...
        CompanyInformation."VAT Registration No." := 'FR77777777777';
        ...
        CompanyInformation.Validate("Registration No.", X2041746010022);
        CompanyInformation.Validate("Trade Register", XRCSParis);
        CompanyInformation.Validate("APE Code", X361C);
        CompanyInformation.Validate("Legal Form", XSA);
        CompanyInformation.Validate("Stock Capital", X115000Euros);
