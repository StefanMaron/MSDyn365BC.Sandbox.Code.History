codeunit 101079 "Create Company Information"
{
    ...
    var
        ...
        XCRONUSInternationalLtd: Label 'CRONUS UK, Ltd.';
        XCRONUSMiniInternationalLtdTxt: Label 'CRONUS Great Britain', Comment = 'Should be localized. E.g. In DK should be CRONUS Danmark.';
