codeunit 101079 "Create Company Information"
{
    ...
    begin
        ...
        CompanyInformation.Validate("Bank Account No.", '2229018-7205');
        ...
        CompanyInformation."Registered Home City" := CompanyInformation.City;
        CompanyInformation."Business Identity Code" := '1234567-8';
