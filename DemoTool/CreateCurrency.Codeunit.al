        ...
        if Currency.Find('-') then
            repeat
                if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                    ...
                    Currency.Validate("Unrealized Gains Acc.", GetGLAccNo.UnrealizedFXGains());
                    Currency.Validate("Unrealized Losses Acc.", GetGLAccNo.UnrealizedFXLosses());
                    Currency.Validate("Realized Gains Acc.", GetGLAccNo.RealizedFXGains());
                    Currency.Validate("Realized Losses Acc.", GetGLAccNo.RealizedFXLosses());
                end;
                Currency.Modify();
