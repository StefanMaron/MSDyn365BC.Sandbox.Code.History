        ...
        if Currency.Find('-') then
            repeat
                if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                    ...
                    Currency.Validate("Realized Gains Acc.", CA.Convert('07330'));
                    Currency.Validate("Realized Losses Acc.", CA.Convert('07740'));
                    Currency.Validate("Unrealized Gains Acc.", CA.Convert('07310'));
                    Currency.Validate("Unrealized Losses Acc.", CA.Convert('07720'));
                end;
                Currency.Modify();
