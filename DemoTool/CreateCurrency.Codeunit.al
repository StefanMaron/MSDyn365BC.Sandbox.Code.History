            ...
            repeat
                if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
                    ...
                    if DemoDataSetup."Additional Currency Code" = Currency.Code then begin
                        ...
                        "G/L Account".SetFilter("No.", '%1|%2', CA.Convert('1101'), CA.Convert('2001'));
                        "G/L Account".ModifyAll("Exchange Rate Adjustment", 2);
                    end;
                end else begin
                    Currency.Validate("Realized Gains Acc.", CA.Convert('999310'));
                    Currency.Validate("Realized Losses Acc.", CA.Convert('999320'));
                end;
                Currency.Modify();
