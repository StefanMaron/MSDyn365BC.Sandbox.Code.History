codeunit 101252 "Create General Posting Setup"
{
    ...
    begin
        with DemoDataSetup do begin
            ...
            InsertData2(DomesticCode, RetailCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
            InsertData2(EUCode, RetailCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
            InsertData2(ExportCode, RetailCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());

            InsertData2(DomesticCode, ServicesCode, CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());
            InsertData2(EUCode, ServicesCode, CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());
            InsertData2(ExportCode, ServicesCode, CreateGLAccount.SaleofResources(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.Miscexternalexpenses(), CreateGLAccount.CostofLabor(), CreateGLAccount.CostofLabor());

            InsertData2(DomesticCode, NoVATCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
            InsertData2(EUCode, NoVATCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
            InsertData2(ExportCode, NoVATCode, CreateGLAccount.SaleofFinishedGoods(), CreateGLAccount.SalesDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.PurchaseDiscounts(), CreateGLAccount.GoodsforResale(), CreateGLAccount.CostofMaterials(), CreateGLAccount.CostofMaterials());
    ...
    begin
        if GeneralPostingSetup."Gen. Bus. Posting Group" <> '' then
            if AdjustForPmtDisc then begin
                GeneralPostingSetup.Validate("Sales Pmt. Disc. Debit Acc.", CreateGLAccount.PettyCash());
                GeneralPostingSetup.Validate("Purch. Pmt. Disc. Credit Acc.", CreateGLAccount.CostofLabor());
                GeneralPostingSetup.Validate("Sales Pmt. Disc. Credit Acc.", CreateGLAccount.PettyCash());
                GeneralPostingSetup.Validate("Purch. Pmt. Disc. Debit Acc.", CreateGLAccount.CostofLabor());
            end;
    end;
