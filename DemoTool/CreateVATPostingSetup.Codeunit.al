    ...
    begin
        with DemoDataSetup do begin
            ...
            case "Company Type" of
                "Company Type"::VAT:
                    begin
                        if "Advanced Setup" then
                            TaxCategory := 'S'
                        else
                            TaxCategory := 'E';
                        InsertData('', ServicesVATCode, 0, 0, TaxCategory);
                        InsertData('', GoodsVATCode, 0, 0, TaxCategory);
                        ...
                        InsertData(ExportCode, ServicesVATCode, 0, 0, TaxCategory);
                        InsertData(ExportCode, GoodsVATCode, 0, 0, TaxCategory);
