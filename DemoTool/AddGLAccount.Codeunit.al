codeunit 117559 "Add G/L Account"
{
    ...
    begin
        with DemoDataSetup do begin
            Get();
            InsertData(
              '995796', XPrepaidHardwareContractslc, '0', '1', '1', '3', '', '2', DomesticCode, ServicesCode, DomesticCode, XVATHotel);
            InsertData(
              '995797', XPrepaidSoftwareContractslc, '0', '1', '1', '3', '', '2', DomesticCode, ServicesCode, DomesticCode, XVATHotel);
            InsertData(
              '996955', XServiceContractSalelc, '0', '0', '1', '2', '', '2', DomesticCode, ServicesCode, DomesticCode, XVATHotel);
        end;
