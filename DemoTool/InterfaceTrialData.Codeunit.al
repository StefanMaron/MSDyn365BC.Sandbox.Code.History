codeunit 122000 "Interface Trial Data"
{
    ...
    var
        ...
        CreateDepreciationBook: Codeunit "Create Depreciation Book";
        CreateTariffNumber: Codeunit "Create Tariff Number";
        Window: Dialog;
    ...
    begin
        ...
        CreateDepreciationBook.CreateMiniAppData(); // NAVCZ
...
#endif
        CreateTariffNumber.InsertMiniAppData(); // NAVCZ
