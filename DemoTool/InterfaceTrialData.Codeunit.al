codeunit 122000 "Interface Trial Data"
{
    ...
    begin
        ...
        RunCodeunit(Codeunit::"Create State");
        RunCodeunit(Codeunit::"Create No. Series IN");
        RunCodeunit(Codeunit::"Create GST Group");
        RunCodeunit(Codeunit::"Create HSN/SAC");
        RunCodeunit(Codeunit::"Create Tax Accounting Period");
        RunCodeunit(Codeunit::"Create GST Posting Setup");
        RunCodeunit(CODEUNIT::"Create TAN No");
        RunCodeunit(CODEUNIT::"Add Source Code Setup");
        RunCodeunit(Codeunit::"Create Nature Of Remittance");
        RunCodeunit(CODEUNIT::"Create TDS Section");
        RunCodeunit(CODEUNIT::"Create Act Applicable");
        RunCodeunit(CODEUNIT::"Create Assessee Code");
        RunCodeunit(CODEUNIT::"Create Concessional Code");
        RunCodeunit(CODEUNIT::"Create Deductor Category");
        RunCodeunit(CODEUNIT::"Create Minitries");

        if DemoDataSetup."Data Type" <> DemoDataSetup."Data Type"::Standard then begin
            RunCodeunit(CODEUNIT::"Create Voucher Posting Setup");
            RunCodeunit(CODEUNIT::"Create Voucher Posting Debit");
            RunCodeunit(CODEUNIT::"Create Voucher Posting Credit");
        end;

        RunCodeunit(CODEUNIT::"Create TCAN No");
        RunCodeunit(CODEUNIT::"Create TCS NOC");
        ...
        RunCodeunit(Codeunit::"Create FA Depr. Setups IN");
