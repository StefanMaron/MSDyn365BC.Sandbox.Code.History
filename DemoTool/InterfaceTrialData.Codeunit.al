codeunit 122000 "Interface Trial Data"
{
    ...
    var
        ...
        CreateItalianData: Codeunit "Create Italian Data";
    begin
        DemoDataSetup.Get();
        ...
        RunCodeunit(CODEUNIT::"Create Payment Terms Lines");
        ...
        RunCodeunit(CODEUNIT::"Create Bills");
        ...
        CreateItalianData.InsertMiniAppData;
