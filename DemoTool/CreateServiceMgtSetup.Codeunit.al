codeunit 117012 "Create Service Mgt. Setup"
{
    ...
    var
        ...
        XSMdashCONdashINV: Label 'SM-CON-INV';
        XSMdashCONdashCM: Label 'SM-CON-CM';
    ...
    begin
        ...
        ServiceMgtSetup.Validate("Serv. Inv. Template Name", Fld11300);
        ServiceMgtSetup.Validate("Serv. Contr. Inv. Templ. Name", Fld11301);
        ServiceMgtSetup.Validate("Serv. Contr. Cr.M. Templ. Name", Fld11302);
        ServiceMgtSetup.Validate("Serv. Cr. Memo Templ. Name", Fld11303);
        ServiceMgtSetup.Modify();
    end;
}
