codeunit 101413 "Create IC Partner"
{
    ...
    begin
        ...
        if not GLAccount.Get(Adjust.Convert('992325')) then
            CreateGLAccount.InsertData(Adjust.Convert('992325'), XCustomersIntercompany, 0, 1, 0, '', 0, '', '', '', '', false);
        if not GLAccount.Get(Adjust.Convert('995425')) then
        ...
        // IC Cutomer, Vendor
        CreateCustomer.InsertData(XIC1030, 'Cronus Cardoxy Procurement', 'Geradeausweg 77', XDE20097, '', '', 'EUR', 'DE', '',
          '111111111', '', '', '');
        CreateCustomer.InsertData(XIC1020, 'Cronus Cardoxy Sales', 'Ligeudvej 24', 'DK-2100', '', '', 'DKK', 'DK', '',
          '34192020', '', '', '');
        CreateVendor.InsertData(XIC1030, 'Cronus Cardoxy Procurement', 'Geradeausweg 77', XDE20097, '', '', 'EUR', 'DE',
          '111111111', '', '', '', '');
