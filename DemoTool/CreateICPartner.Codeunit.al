codeunit 101413 "Create IC Partner"
{
    ...
    begin
        ...
        // IC Cutomer, Vendor
        CreateCustomer.InsertData(XIC1030, XCronusCardoxyProcurement, XGeradeausweg77, XDE20097, '', '', XEUR, XDE, '',
          '111111111', '', '', '');
        CreateCustomer.InsertData(XIC1020, XCronusCardoxySales, XLigeudvej24, XDK2100, '', '', XDKK, XDK, '',
          '34192020', '', '', '');
        CreateVendor.InsertData(XIC1030, XCronusCardoxyProcurement, XGeradeausweg77, XDE20097, '', '', XEUR, XDE, '',
          '111111111', '', '', '');
        CreateVendor.InsertData(XIC1020, XCronusCardoxySales, XLigeudvej24, XDK2100, '', '', XDKK, XDK, '',
          '34192020', '', '', '');

        InsertData(XICP20, XCronusCardoxySales, XDKK, 0, '', '992325', '995425', false, XIC1020, XIC1020);
        InsertData(XICP30, XCronusCardoxyProcurement, '', 0, '', '992325', '995425', false, XIC1030, XIC1030);
    end;
    ...
    var
        ...
        XCronusCardoxyProcurement: Label 'Cronus Cardoxy Procurement';
        XCronusCardoxySales: Label 'Cronus Cardoxy Sales';
        XGeradeausweg77: Label 'Geradeausweg 77';
        XLigeudvej24: Label 'Ligeudvej 24';
        XDE20097: Label 'DE-20097';
        XDK2100: Label 'DK-2100';
        XDE: Label 'DE';
        XDK: Label 'DK';
        XDKK: Label 'DKK';
        XEUR: Label 'EUR';
