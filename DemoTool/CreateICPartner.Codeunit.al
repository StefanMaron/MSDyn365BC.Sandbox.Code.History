codeunit 101413 "Create IC Partner"
{
    ...
    begin
        ...
        CreateGenPostingSetup.InsertData(XINTERCOMP, DemoDataSetup.MiscCode, '996120', '997110');
        CreateGenPostingSetup.InsertData(XINTERCOMP, DemoDataSetup.NoVATCode, '996120', '997110');
        CreateGenPostingSetup.InsertData(XINTERCOMP, DemoDataSetup.RawMatCode, '996120', '997210');
        CreateGenPostingSetup.InsertData(XINTERCOMP, DemoDataSetup.RetailCode, '996120', '997110');
        ...
        // IC Cutomer, Vendor
        CreateCustomer.InsertData(XIC1030, 'Cronus Cardoxy Procurement', 'Geradeausweg 77', 'DE-20097', '', '', '', 'DE', '',
          '111111111', '', '', '');
        CreateCustomer.InsertData(XIC1020, 'Cronus Cardoxy Sales', 'Ligeudvej 24', 'DK-2100', '', '', 'DKK', 'DK', '',
          '34192020', '', '', '');
        CreateVendor.InsertData(XIC1030, 'Cronus Cardoxy Procurement', 'Geradeausweg 77', 'DE-20097', '', '', '', 'DE',
          '111111111', '', '', '', '');
        CreateVendor.InsertData(XIC1020, 'Cronus Cardoxy Sales', 'Ligeudvej 24', 'DK-2100', '', '', 'DKK', 'DK',
          '34192020', '', '', '', '');

        InsertData(XICP20, 'Cronus Cardoxy Sales', 'DKK', 0, '', '4330001', '4030001', false, XIC1020, XIC1020);
        InsertData(XICP30, 'Cronus Cardoxy Procurement', '', 0, '', '4330001', '4030001', false, XIC1030, XIC1030);
    end;
