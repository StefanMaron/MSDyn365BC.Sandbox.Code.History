codeunit 101413 "Create IC Partner"
{
    ...
    begin
        ...
        CreateGLAccount.InsertData('411200', XCustomersIntercompany, 0, 1, 0, '', 0, '', '', '', '', false);
        CreateGLAccount.InsertData('401200', XVendorsIntercompany, 0, 1, 0, '', 0, '', '', '', '', false);
        ...
        InsertData(XICP20, 'Cronus Cardoxy Sales', 'DKK', 0, '', '411200', '401200', false, XIC1020, XIC1020);
        InsertData(XICP30, 'Cronus Cardoxy Procurement', 'EUR', 0, '', '411200', '401200', false, XIC1030, XIC1030);
    end;
