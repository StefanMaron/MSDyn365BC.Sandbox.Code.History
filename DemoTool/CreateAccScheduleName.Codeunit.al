codeunit 101084 "Create Acc. Schedule Name"
{
    ...
    begin
        ...
        InsertData(Text000, Text001, XBALONLY, '');
        InsertData(Text002, Text003, XPTDTYTD, '');
        InsertData(Text004, Text003, XPTDYTDPCT, '');
    ...
    var
        ...
        Text000: Label 'BALANCE SH';
        Text001: Label 'Balance Sheet';
        Text002: Label 'CASH FLOW';
        Text003: Label 'Cash Flow Statement';
        Text004: Label 'INCOME';
        XPTDTYTD: Label 'PTD + YTD';
        XPTDYTDPCT: Label 'PTD+YTD+%';
