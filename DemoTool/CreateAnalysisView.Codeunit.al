codeunit 101345 "Create Analysis View"
{
    ...
    begin
        InsertAnalysisView(
          ...
          Adjust.Convert('996110') + '..' + Adjust.Convert('996910'),
        ...
        InsertAnalysisView(
          ...
          Adjust.Convert('997110') + '..' + Adjust.Convert('997620'),
        ...
        InsertAnalysisView(
          ...
          Adjust.Convert('997110') + '..' + Adjust.Convert('998750'),
    ...
    begin
        ...
        InsertAnalysisView(
          XREVENUE, XSalesRevenue, false,
          Adjust.Convert('996110') + '..' + Adjust.Convert('996910'),
          Adjust.AdjustDate(19020101D), 3, false, XAREA, XDEPARTMENT, '', '',
          AnalysisView."Account Source"::"G/L Account");
    end;
}
