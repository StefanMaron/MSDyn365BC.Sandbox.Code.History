    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            InsertData(
              ...
              XHollyDickson, '', XLCY, '290-0046141-87', '290', 'BE67 2900 0461 4187');
            InsertData(
              XWWBEUR, XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, XEUR, XLCY, '431-1830811-03', '431', XGB80RBOS16173241116737);
            SetSEPAExport();
            InsertData(
              XWWBOPERATING, XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, '', XOPERATING, '431-0065952-59', '431', '');
            InsertData(
              XWWBUSD, XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, XUSD, XCURRENCIES, '431-0161500-62', '431', '');
            InsertData(
            ...
            InsertData(
              ...
              XPaulaNartker, '', XLCY2, '320-0046141-39', '320', XGB80RBOS16173241116737);
        end else begin
            InsertData(
              XCHECKING, XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, '', XCHECKING, '431-0065952-59', '431', '');
            SetAsBalAccOnGenJnlBatch(XCHECKING);

            InsertData(
              XNBL, XNewBankofLondon, X4BakerStreet, CreatePostCode.Convert('GB-W1 3AL'),
              XHollyDickson, '', XCHECKING, '290-0046141-87', '290', 'BE67 2900 0461 4187');
        end;
    end;
