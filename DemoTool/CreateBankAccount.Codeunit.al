codeunit 101270 "Create Bank Account"
{
    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            InsertData(
              ...
              //XHollyDickson,'',XLCY,'78-66-345','NB54366','','GB');
              XTiinaNiemi, '', XLCY, '2229018-7205', 'NB54366', XFI9780RBOS16173241116737, 'FI');
            InsertData(
    ...
    procedure InsertData("No.": Code[20]; Name: Text[30]; Address: Text[30]; "Post Code": Text[30]; Contact: Text[30]; "Currency Code": Code[10]; "Posting Group": Code[20]; "Bank Account No.": Text[30]; "Bank Branch No.": Text[20]; IBAN: Code[50]; "Country Code": Code[10])
    var
    ...
    begin
        ...
        BankAcc."Country/Region Code" := "Country Code";
        //-JK MSFI NAVISION 4.0 FI
        ...
        case BankAcc."No." of
            ...
            XNBL:
                begin
                    ...
                    BankAcc."Phone No." := '+358 405550924';
                    BankAcc."SWIFT Code" := 'HUPFIHH';
                end;
        end;
