    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            ...
            InsertData(
              ...
              XGrantCulbertson, XUSD, XFOREIGNCUR, '99-44-567', 'BG99999', '');
            InsertData(
              XWWBTRANSFERSTxt, XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, XGBPTok, XLCY, '99-44-567', 'BG99999', '');
            InsertData(
              XGIRO, XGiroBank, X2BridgeStreet, CreatePostCode.Convert('GB-W1 3AL'),
              XPaulaNartker, '', XPOSTACC, '14-55-678', 'GO284033', XGB80RBOS16173241116737);
        end else begin
            InsertData(
