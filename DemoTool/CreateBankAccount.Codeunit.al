codeunit 101270 "Create Bank Account"
{
    ...
    begin
        ...
        if BankAcc."No." = XNBL then begin
            AddressID."Table No." := DATABASE::"Bank Account";
            AddressID."Table Key" := BankAcc.GetPosition();
            AddressID."Address Type" := AddressID."Address Type"::Main;
            AddressID.Validate("Address ID", X24610620);
        ...
        case BankAcc."No." of
            ...
            XCHECKING:
                begin
                    ...
                    "Create No. Series".InitBaseSeries(BankAcc."Pmt. Rec. No. Series", PmtRecNoSeriesTok, PmtRecNoSeriesDescriptionTxt, PmtRecNoSeriesStartNoTok, BankAcc."No." + PmtRecNoSeriesEndNoTok, PmtRecNoSeriesStartNoTok, '', 1, Enum::"No. Series Implementation"::Sequence);
