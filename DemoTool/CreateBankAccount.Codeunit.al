        ...
        case BankAcc."No." of
            ...
            XCHECKING:
                begin
                    ...
                    "Create No. Series".InitBaseSeries(BankAcc."Pmt. Rec. No. Series", PmtRecNoSeriesTok, PmtRecNoSeriesDescriptionTxt, PmtRecNoSeriesStartNoTok, BankAcc."No." + PmtRecNoSeriesEndNoTok, PmtRecNoSeriesStartNoTok, '', 1, true);
