    ...
    begin
        ...
        if DemoDataSetup."Data Type" = DemoDataSetup."Data Type"::Extended then begin
            ...
            InsertData(
              ...
              XPaulaNartker, '', XLCY2, '14-55-678', '4033', XGB80RBOS16173241116737);
        end else begin
            InsertData(
              'CHECKING', XWorldWideBank, X1HighHolborn, CreatePostCode.Convert('GB-WC1 3DG'),
              XGrantCulbertson, '', CreateBankAccPostingGroup.GetCheckingCode(), '99-99-888', '9999', '');
            SetAsBalAccOnGenJnlBatch('CHECKING');
            InsertData(
              XNBL, XNewBankofLondon, X4BakerStreet, CreatePostCode.Convert('GB-W1 3AL'),
              XHollyDickson, '', CreateBankAccPostingGroup.GetCheckingCode(), '78-66-345', '4366', '');
        end;
    end;
