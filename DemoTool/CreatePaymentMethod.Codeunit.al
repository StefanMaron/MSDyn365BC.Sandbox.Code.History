codeunit 101289 "Create Payment Method"
{
    ...
    begin
        with "Payment Method" do begin
            InsertData(XxWWBUSD, XGirotransfer, "Bal. Account Type"::"Bank Account", XxWWBUSD, '', '');
            ...
            //BEGIN IT
            InsertData(XxBANKTRANSF, XBanktransfer, "Bal. Account Type"::"G/L Account", '', XxBB, '');
            InsertData(XxRIBA, XBankReceipt, "Bal. Account Type"::"G/L Account", '', XxRB, '');
            //END IT
    ...
    procedure InsertData("Code": Code[10]; Description: Text[50]; "Bal. Account Type": Integer; "Bal. Account No.": Code[20]; "Bill Code": Code[20]; PmtExportLineDefn: Code[20])
    begin
        "Payment Method".Init();
