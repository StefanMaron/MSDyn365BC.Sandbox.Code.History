...
table 6809 "WHT Purch. Tax Cr. Memo Hdr."
{
    Caption = 'Purch. Tax Cr. Memo Hdr.';
    DataCaptionFields = "No.", "Buy-from Vendor Name";
    LookupPageID = "WHT Pstd. Purch. Tax Cr. Memos";
    ...
    fields
    {
        ...
        field(60; Amount; Decimal)
        {
            ...
            AutoFormatType = 1;
            CalcFormula = sum("WHT Purch. Tax Cr. Memo Line".Amount where("Document No." = field("No.")));
            Caption = 'Amount';
            Editable = false;
            FieldClass = FlowField;
        }
        field(61; "Amount Including VAT"; Decimal)
        {
            AutoFormatExpression = Rec."Currency Code";
            AutoFormatType = 1;
            CalcFormula = sum("WHT Purch. Tax Cr. Memo Line"."Amount Including VAT" where("Document No." = field("No.")));
    ...
    begin
        ...
        if "No." = '' then begin
            if TaxInvoiceManagement.CheckTaxableNoSeries("Buy-from Vendor No.", 0) then begin
                PurchSetup.TestField("WHT Pstd. Non Tax Cr. Memo Nos");
                "No. Series" := PurchSetup."WHT Pstd. Non Tax Cr. Memo Nos";
    ...
    begin
        PurchSetup.TestField("WHT Posted Tax Credit Memo Nos");
    end;

    local procedure GetNoSeriesCode(): Code[20]
    begin
        exit(PurchSetup."WHT Posted Tax Credit Memo Nos");
    end;
