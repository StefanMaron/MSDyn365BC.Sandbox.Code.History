codeunit 139527 "Recommended Apps Tests"
{
    ...
    var
        ...
        AppId: Guid;
        Err1Msg: Label 'Cannot add the recommended app with ID %1. The Marketplace Catalog API cannot be reached, and the HTTP status code is 404. Are you sure that the information about the app is correct?', Comment = '%1 = App ID';
