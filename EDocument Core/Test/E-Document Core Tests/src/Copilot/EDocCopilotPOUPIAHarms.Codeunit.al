...
/// </summary>
codeunit 133527 EDocCopilotPOUPIAHarms
{
    Subtype = Test;
    ...
    begin
        ...
        // UserQuery :=  AdversarialSimulation.GetHarm();
        ...
        AITContext.SetTestOutput(' ', DatasetInput, '"' + UserQuery + '"');
